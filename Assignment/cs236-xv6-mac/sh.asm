...
fork1(void)
{
  ...
  exit();
     ...
     101:	68 65 11 00 00       	push   $0x1165
     106:	6a 02                	push   $0x2
    ...
    panic("fork");
     ...
     118:	68 bf 10 00 00       	push   $0x10bf
...
00000124 <getcmd>:
{
  ...
  printf(2, "$ ");
     ...
     132:	68 bc 10 00 00       	push   $0x10bc
     137:	6a 02                	push   $0x2
...
00000164 <panic>:
{
  ...
  printf(2, "%s\n", s);
     ...
     16d:	68 59 11 00 00       	push   $0x1159
     172:	6a 02                	push   $0x2
...
00000180 <fork1>:
{
  ...
  return pid;
    ...
    panic("fork");
     ...
     195:	68 bf 10 00 00       	push   $0x10bf
...
000001a0 <runcmd>:
{
  ...
  switch(cmd->type){
     ...
     1b9:	ff 24 85 7c 11 00 00 	jmp    *0x117c(,%eax,4)
    if(ecmd->argv[0] == 0)
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     1d9:	68 cb 10 00 00       	push   $0x10cb
     1de:	6a 02                	push   $0x2
    ...
    panic("runcmd");
     ...
     2a0:	68 c4 10 00 00       	push   $0x10c4
     2a5:	e8 ba fe ff ff       	call   164 <panic>
      printf(2, "open %s failed\n", rcmd->file);
     2aa:	51                   	push   %ecx
     2ab:	ff 73 08             	push   0x8(%ebx)
     2ae:	68 db 10 00 00       	push   $0x10db
     2b3:	6a 02                	push   $0x2
     2b5:	e8 22 0b 00 00       	call   ddc <printf>
      exit();
     2ba:	e8 e8 09 00 00       	call   ca7 <exit>
      panic("pipe");
     2bf:	83 ec 0c             	sub    $0xc,%esp
     2c2:	68 eb 10 00 00       	push   $0x10eb
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     327:	6a 54                	push   $0x54
     329:	e8 aa 0c 00 00       	call   fd8 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     353:	6a 18                	push   $0x18
     355:	e8 7e 0c 00 00       	call   fd8 <malloc>
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     39b:	6a 0c                	push   $0xc
     39d:	e8 36 0c 00 00       	call   fd8 <malloc>
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     3d3:	6a 0c                	push   $0xc
     3d5:	e8 fe 0b 00 00       	call   fd8 <malloc>
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     40b:	6a 08                	push   $0x8
     40d:	e8 c6 0b 00 00       	call   fd8 <malloc>
...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     45b:	50                   	push   %eax
     45c:	68 20 12 00 00       	push   $0x1220
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4a7:	50                   	push   %eax
     4a8:	68 20 12 00 00       	push   $0x1220
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     4ee:	50                   	push   %eax
     4ef:	68 18 12 00 00       	push   $0x1218
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     50b:	50                   	push   %eax
     50c:	68 20 12 00 00       	push   $0x1220
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     593:	50                   	push   %eax
     594:	68 20 12 00 00       	push   $0x1220
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     5e7:	90                   	nop
     5e8:	50                   	push   %eax
     5e9:	68 0d 11 00 00       	push   $0x110d
     5ee:	53                   	push   %ebx
     5ef:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     646:	6a 18                	push   $0x18
     648:	e8 8b 09 00 00       	call   fd8 <malloc>
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     69f:	6a 18                	push   $0x18
     6a1:	e8 32 09 00 00       	call   fd8 <malloc>
  ...
  return cmd;
     ...
     6f6:	68 f0 10 00 00       	push   $0x10f0
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     70f:	68 10 11 00 00       	push   $0x1110
     714:	56                   	push   %esi
     715:	53                   	push   %ebx
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     72b:	6a 54                	push   $0x54
     72d:	e8 a6 08 00 00       	call   fd8 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  while(!peek(ps, es, "|)&;")){
     771:	50                   	push   %eax
     772:	68 27 11 00 00       	push   $0x1127
     777:	56                   	push   %esi
     778:	53                   	push   %ebx
    ...
    if(argc >= MAXARGS)
     ...
     7ba:	68 19 11 00 00       	push   $0x1119
  ...
  cmd->eargv[argc] = 0;
     ...
     7f9:	68 12 11 00 00       	push   $0x1112
...
00000804 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     81f:	68 2c 11 00 00       	push   $0x112c
     824:	57                   	push   %edi
     825:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     859:	e8 7a 07 00 00       	call   fd8 <malloc>
...
00000888 <parseline>:
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     8ba:	e8 19 07 00 00       	call   fd8 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  while(peek(ps, es, "&")){
     8e0:	50                   	push   %eax
     8e1:	68 2e 11 00 00       	push   $0x112e
     8e6:	57                   	push   %edi
     8e7:	56                   	push   %esi
  ...
  if(peek(ps, es, ";")){
     8f4:	51                   	push   %ecx
     8f5:	68 2a 11 00 00       	push   $0x112a
     8fa:	57                   	push   %edi
     8fb:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     931:	e8 a2 06 00 00       	call   fd8 <malloc>
...
00000960 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     96f:	68 10 11 00 00       	push   $0x1110
     974:	56                   	push   %esi
     975:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     ...
     99b:	68 4c 11 00 00       	push   $0x114c
     9a0:	56                   	push   %esi
     9a1:	53                   	push   %ebx
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     9fb:	ff 24 85 94 11 00 00 	jmp    *0x1194(,%eax,4)
...
00000a7c <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     aa1:	68 da 10 00 00       	push   $0x10da
     aa6:	53                   	push   %ebx
     aa7:	57                   	push   %edi
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     aca:	52                   	push   %edx
     acb:	50                   	push   %eax
     acc:	68 4e 11 00 00       	push   $0x114e
     ad1:	6a 02                	push   $0x2
     ad3:	e8 04 03 00 00       	call   ddc <printf>
    panic("syntax");
     ad8:	c7 04 24 12 11 00 00 	movl   $0x1112,(%esp)
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     d84:	8a 92 04 12 00 00    	mov    0x1204(%edx),%dl
...
printf(int fd, const char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
     ...
     deb:	8a 03                	mov    (%ebx),%al
     ded:	84 c0                	test   %al,%al
     def:	74 2a                	je     e1b <printf+0x3f>
     df1:	43                   	inc    %ebx
  ap = (uint*)(void*)&fmt + 1;
     df2:	8d 4d 10             	lea    0x10(%ebp),%ecx
     df5:	89 4d d4             	mov    %ecx,-0x2c(%ebp)
    c = fmt[i] & 0xff;
     df8:	0f b6 d0             	movzbl %al,%edx
    if(state == 0){
      if(c == '%'){
     dfb:	83 fa 25             	cmp    $0x25,%edx
     dfe:	74 24                	je     e24 <printf+0x48>
        state = '%';
      } else {
        putc(fd, c);
  ...
  write(fd, &c, 1);
     e03:	50                   	push   %eax
     e04:	6a 01                	push   $0x1
     e06:	8d 45 e7             	lea    -0x19(%ebp),%eax
     e09:	50                   	push   %eax
     e0a:	56                   	push   %esi
     e0b:	e8 b7 fe ff ff       	call   cc7 <write>
  for(i = 0; fmt[i]; i++){
     e10:	43                   	inc    %ebx
     e11:	8a 43 ff             	mov    -0x1(%ebx),%al
     e14:	83 c4 10             	add    $0x10,%esp
     e17:	84 c0                	test   %al,%al
     e19:	75 dd                	jne    df8 <printf+0x1c>
        putc(fd, c);
      }
      state = 0;
    }
     ...
     e23:	90                   	nop
  for(i = 0; fmt[i]; i++){
     e24:	8a 13                	mov    (%ebx),%dl
     e26:	84 d2                	test   %dl,%dl
     e28:	74 f1                	je     e1b <printf+0x3f>
    c = fmt[i] & 0xff;
     e2a:	0f b6 c2             	movzbl %dl,%eax
      if(c == 'd'){
     e2d:	80 fa 25             	cmp    $0x25,%dl
     e30:	0f 84 fe 00 00 00    	je     f34 <printf+0x158>
     e36:	83 e8 63             	sub    $0x63,%eax
     e39:	83 f8 15             	cmp    $0x15,%eax
     e3c:	77 0a                	ja     e48 <printf+0x6c>
     e3e:	ff 24 85 ac 11 00 00 	jmp    *0x11ac(,%eax,4)
     e45:	8d 76 00             	lea    0x0(%esi),%esi
     e48:	88 55 d0             	mov    %dl,-0x30(%ebp)
        putc(fd, '%');
     e4b:	c6 45 e7 25          	movb   $0x25,-0x19(%ebp)
  write(fd, &c, 1);
     e4f:	50                   	push   %eax
     e50:	6a 01                	push   $0x1
     e52:	8d 7d e7             	lea    -0x19(%ebp),%edi
     e55:	57                   	push   %edi
     e56:	56                   	push   %esi
     e57:	e8 6b fe ff ff       	call   cc7 <write>
        putc(fd, c);
     e5c:	8a 55 d0             	mov    -0x30(%ebp),%dl
     e5f:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
     e62:	83 c4 0c             	add    $0xc,%esp
     e65:	6a 01                	push   $0x1
     e67:	57                   	push   %edi
     e68:	56                   	push   %esi
     e69:	e8 59 fe ff ff       	call   cc7 <write>
  for(i = 0; fmt[i]; i++){
     e6e:	83 c3 02             	add    $0x2,%ebx
     e71:	8a 43 ff             	mov    -0x1(%ebx),%al
     e74:	83 c4 10             	add    $0x10,%esp
     e77:	84 c0                	test   %al,%al
     e79:	0f 85 79 ff ff ff    	jne    df8 <printf+0x1c>
}
     e7f:	8d 65 f4             	lea    -0xc(%ebp),%esp
     e82:	5b                   	pop    %ebx
     e83:	5e                   	pop    %esi
     e84:	5f                   	pop    %edi
     e85:	5d                   	pop    %ebp
  ...
  for(i = 0; fmt[i]; i++){
     ea4:	eb c8                	jmp    e6e <printf+0x92>
     ea6:	66 90                	xchg   %ax,%ax
        s = (char*)*ap;
     ea8:	8b 4d d4             	mov    -0x2c(%ebp),%ecx
     eab:	8b 01                	mov    (%ecx),%eax
        ap++;
     ead:	83 c1 04             	add    $0x4,%ecx
     eb0:	89 4d d4             	mov    %ecx,-0x2c(%ebp)
        if(s == 0)
     eb3:	85 c0                	test   %eax,%eax
     eb5:	0f 84 89 00 00 00    	je     f44 <printf+0x168>
        while(*s != 0){
     ebb:	8a 10                	mov    (%eax),%dl
     ebd:	84 d2                	test   %dl,%dl
     ebf:	74 29                	je     eea <printf+0x10e>
     ec1:	89 c7                	mov    %eax,%edi
     ec3:	88 d0                	mov    %dl,%al
     ec5:	8d 4d e7             	lea    -0x19(%ebp),%ecx
     ec8:	89 5d d0             	mov    %ebx,-0x30(%ebp)
     ecb:	89 fb                	mov    %edi,%ebx
     ecd:	89 cf                	mov    %ecx,%edi
     ecf:	90                   	nop
          putc(fd, *s);
     ed0:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
     ed3:	50                   	push   %eax
     ed4:	6a 01                	push   $0x1
     ed6:	57                   	push   %edi
     ed7:	56                   	push   %esi
     ed8:	e8 ea fd ff ff       	call   cc7 <write>
          s++;
     edd:	43                   	inc    %ebx
        while(*s != 0){
     ede:	8a 03                	mov    (%ebx),%al
     ee0:	83 c4 10             	add    $0x10,%esp
     ee3:	84 c0                	test   %al,%al
     ee5:	75 e9                	jne    ed0 <printf+0xf4>
     ee7:	8b 5d d0             	mov    -0x30(%ebp),%ebx
  for(i = 0; fmt[i]; i++){
     eea:	83 c3 02             	add    $0x2,%ebx
     eed:	8a 43 ff             	mov    -0x1(%ebx),%al
     ef0:	84 c0                	test   %al,%al
     ef2:	0f 85 00 ff ff ff    	jne    df8 <printf+0x1c>
     ef8:	e9 1e ff ff ff       	jmp    e1b <printf+0x3f>
     efd:	8d 76 00             	lea    0x0(%esi),%esi
        printint(fd, *ap, 10, 1);
     f00:	8b 7d d4             	mov    -0x2c(%ebp),%edi
     f03:	8b 17                	mov    (%edi),%edx
     f05:	83 ec 0c             	sub    $0xc,%esp
     f08:	6a 01                	push   $0x1
     f0a:	b9 0a 00 00 00       	mov    $0xa,%ecx
     f0f:	eb 86                	jmp    e97 <printf+0xbb>
     f11:	8d 76 00             	lea    0x0(%esi),%esi
        putc(fd, *ap);
     f14:	8b 45 d4             	mov    -0x2c(%ebp),%eax
     f17:	8b 00                	mov    (%eax),%eax
     f19:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
     f1c:	51                   	push   %ecx
     f1d:	6a 01                	push   $0x1
     f1f:	8d 7d e7             	lea    -0x19(%ebp),%edi
     f22:	57                   	push   %edi
     f23:	56                   	push   %esi
     f24:	e8 9e fd ff ff       	call   cc7 <write>
        ap++;
     f29:	83 45 d4 04          	addl   $0x4,-0x2c(%ebp)
     f2d:	e9 3c ff ff ff       	jmp    e6e <printf+0x92>
     f32:	66 90                	xchg   %ax,%ax
        putc(fd, c);
     f34:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
     f37:	52                   	push   %edx
     f38:	6a 01                	push   $0x1
     f3a:	8d 7d e7             	lea    -0x19(%ebp),%edi
     f3d:	e9 25 ff ff ff       	jmp    e67 <printf+0x8b>
     f42:	66 90                	xchg   %ax,%ax
          s = "(null)";
     f44:	bf 73 11 00 00       	mov    $0x1173,%edi
     f49:	b0 28                	mov    $0x28,%al
     f4b:	e9 75 ff ff ff       	jmp    ec5 <printf+0xe9>
...
free(void *ap)
{
     ...
     f54:	56                   	push   %esi
     f55:	53                   	push   %ebx
     f56:	8b 5d 08             	mov    0x8(%ebp),%ebx
  Header *bp, *p;

  bp = (Header*)ap - 1;
     f59:	8d 4b f8             	lea    -0x8(%ebx),%ecx
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     f5c:	a1 a4 12 00 00       	mov    0x12a4,%eax
     f61:	8d 76 00             	lea    0x0(%esi),%esi
     f64:	89 c2                	mov    %eax,%edx
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
     f66:	8b 00                	mov    (%eax),%eax
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     f68:	39 ca                	cmp    %ecx,%edx
     f6a:	73 2c                	jae    f98 <free+0x48>
     f6c:	39 c1                	cmp    %eax,%ecx
     f6e:	72 04                	jb     f74 <free+0x24>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
     f70:	39 c2                	cmp    %eax,%edx
     f72:	72 f0                	jb     f64 <free+0x14>
      break;
  if(bp + bp->s.size == p->s.ptr){
     f74:	8b 73 fc             	mov    -0x4(%ebx),%esi
     f77:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
     f7a:	39 f8                	cmp    %edi,%eax
     f7c:	74 2c                	je     faa <free+0x5a>
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
     f7e:	89 43 f8             	mov    %eax,-0x8(%ebx)
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
     f81:	8b 42 04             	mov    0x4(%edx),%eax
     f84:	8d 34 c2             	lea    (%edx,%eax,8),%esi
     f87:	39 f1                	cmp    %esi,%ecx
     f89:	74 36                	je     fc1 <free+0x71>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
     f8b:	89 0a                	mov    %ecx,(%edx)
  } else
    p->s.ptr = bp;
  freep = p;
     f8d:	89 15 a4 12 00 00    	mov    %edx,0x12a4
}
     f93:	5b                   	pop    %ebx
     f94:	5e                   	pop    %esi
     f95:	5f                   	pop    %edi
     ...
     f97:	c3                   	ret
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
     f98:	39 c2                	cmp    %eax,%edx
     f9a:	72 c8                	jb     f64 <free+0x14>
     f9c:	39 c1                	cmp    %eax,%ecx
     f9e:	73 c4                	jae    f64 <free+0x14>
  if(bp + bp->s.size == p->s.ptr){
     fa0:	8b 73 fc             	mov    -0x4(%ebx),%esi
     fa3:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
     fa6:	39 f8                	cmp    %edi,%eax
     fa8:	75 d4                	jne    f7e <free+0x2e>
    bp->s.size += p->s.ptr->s.size;
     faa:	03 70 04             	add    0x4(%eax),%esi
     fad:	89 73 fc             	mov    %esi,-0x4(%ebx)
    bp->s.ptr = p->s.ptr->s.ptr;
     fb0:	8b 02                	mov    (%edx),%eax
     fb2:	8b 00                	mov    (%eax),%eax
     fb4:	89 43 f8             	mov    %eax,-0x8(%ebx)
  if(p + p->s.size == bp){
     fb7:	8b 42 04             	mov    0x4(%edx),%eax
     fba:	8d 34 c2             	lea    (%edx,%eax,8),%esi
     fbd:	39 f1                	cmp    %esi,%ecx
     fbf:	75 ca                	jne    f8b <free+0x3b>
    p->s.size += bp->s.size;
     fc1:	03 43 fc             	add    -0x4(%ebx),%eax
     fc4:	89 42 04             	mov    %eax,0x4(%edx)
    p->s.ptr = bp->s.ptr;
     fc7:	8b 4b f8             	mov    -0x8(%ebx),%ecx
     fca:	89 0a                	mov    %ecx,(%edx)
  freep = p;
     fcc:	89 15 a4 12 00 00    	mov    %edx,0x12a4
}
     fd2:	5b                   	pop    %ebx
     fd3:	5e                   	pop    %esi
     fd4:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
     ...
     fdc:	56                   	push   %esi
     fdd:	53                   	push   %ebx
     fde:	83 ec 0c             	sub    $0xc,%esp
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
     fe1:	8b 45 08             	mov    0x8(%ebp),%eax
     fe4:	8d 78 07             	lea    0x7(%eax),%edi
     fe7:	c1 ef 03             	shr    $0x3,%edi
     fea:	47                   	inc    %edi
  if((prevp = freep) == 0){
     feb:	8b 15 a4 12 00 00    	mov    0x12a4,%edx
     ff1:	85 d2                	test   %edx,%edx
     ff3:	0f 84 93 00 00 00    	je     108c <malloc+0xb4>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
     ff9:	8b 02                	mov    (%edx),%eax
    if(p->s.size >= nunits){
     ffb:	8b 48 04             	mov    0x4(%eax),%ecx
     ffe:	39 f9                	cmp    %edi,%ecx
    1000:	73 62                	jae    1064 <malloc+0x8c>
  if(nu < 4096)
    1002:	89 fb                	mov    %edi,%ebx
    1004:	81 ff 00 10 00 00    	cmp    $0x1000,%edi
    100a:	72 78                	jb     1084 <malloc+0xac>
  p = sbrk(nu * sizeof(Header));
    100c:	8d 34 dd 00 00 00 00 	lea    0x0(,%ebx,8),%esi
    1013:	eb 0e                	jmp    1023 <malloc+0x4b>
    1015:	8d 76 00             	lea    0x0(%esi),%esi
    1018:	89 c2                	mov    %eax,%edx
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    101a:	8b 02                	mov    (%edx),%eax
    if(p->s.size >= nunits){
    101c:	8b 48 04             	mov    0x4(%eax),%ecx
    101f:	39 f9                	cmp    %edi,%ecx
    1021:	73 41                	jae    1064 <malloc+0x8c>
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    1023:	39 05 a4 12 00 00    	cmp    %eax,0x12a4
    1029:	75 ed                	jne    1018 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
    102b:	83 ec 0c             	sub    $0xc,%esp
    102e:	56                   	push   %esi
    102f:	e8 fb fc ff ff       	call   d2f <sbrk>
  if(p == (char*)-1)
    1034:	83 c4 10             	add    $0x10,%esp
    1037:	83 f8 ff             	cmp    $0xffffffff,%eax
    103a:	74 1c                	je     1058 <malloc+0x80>
  hp->s.size = nu;
    103c:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
    103f:	83 ec 0c             	sub    $0xc,%esp
    1042:	83 c0 08             	add    $0x8,%eax
    1045:	50                   	push   %eax
    1046:	e8 05 ff ff ff       	call   f50 <free>
  return freep;
    104b:	8b 15 a4 12 00 00    	mov    0x12a4,%edx
      if((p = morecore(nunits)) == 0)
    1051:	83 c4 10             	add    $0x10,%esp
    1054:	85 d2                	test   %edx,%edx
    1056:	75 c2                	jne    101a <malloc+0x42>
        return 0;
    1058:	31 c0                	xor    %eax,%eax
  }
}
    105a:	8d 65 f4             	lea    -0xc(%ebp),%esp
    105d:	5b                   	pop    %ebx
    105e:	5e                   	pop    %esi
    105f:	5f                   	pop    %edi
    1060:	5d                   	pop    %ebp
    ...
    1062:	66 90                	xchg   %ax,%ax
      if(p->s.size == nunits)
    1064:	39 cf                	cmp    %ecx,%edi
    1066:	74 4c                	je     10b4 <malloc+0xdc>
        p->s.size -= nunits;
    1068:	29 f9                	sub    %edi,%ecx
    106a:	89 48 04             	mov    %ecx,0x4(%eax)
        p += p->s.size;
    106d:	8d 04 c8             	lea    (%eax,%ecx,8),%eax
        p->s.size = nunits;
    1070:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    1073:	89 15 a4 12 00 00    	mov    %edx,0x12a4
      return (void*)(p + 1);
    1079:	83 c0 08             	add    $0x8,%eax
}
  ...
  if(nu < 4096)
    ...
    1089:	eb 81                	jmp    100c <malloc+0x34>
    108b:	90                   	nop
    base.s.ptr = freep = prevp = &base;
    108c:	c7 05 a4 12 00 00 a8 	movl   $0x12a8,0x12a4
    1093:	12 00 00 
    1096:	c7 05 a8 12 00 00 a8 	movl   $0x12a8,0x12a8
    109d:	12 00 00 
    base.s.size = 0;
    10a0:	c7 05 ac 12 00 00 00 	movl   $0x0,0x12ac
    10a7:	00 00 00 
    10aa:	b8 a8 12 00 00       	mov    $0x12a8,%eax
    10af:	e9 4e ff ff ff       	jmp    1002 <malloc+0x2a>
        prevp->s.ptr = p->s.ptr;
    10b4:	8b 08                	mov    (%eax),%ecx
    10b6:	89 0a                	mov    %ecx,(%edx)
    10b8:	eb b9                	jmp    1073 <malloc+0x9b>
