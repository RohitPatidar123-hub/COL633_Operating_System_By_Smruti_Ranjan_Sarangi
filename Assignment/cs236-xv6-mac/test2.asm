...
int main()
{
  ...
  24:	6a 01                	push   $0x1
  26:	e8 fd 04 00 00       	call   528 <printf>
  ...
  33:	68 25 08 00 00       	push   $0x825
  38:	6a 01                	push   $0x1
  3a:	e8 e9 04 00 00       	call   528 <printf>
  ...
  60:	52                   	push   %edx
  61:	50                   	push   %eax
  62:	68 3a 08 00 00       	push   $0x83a
  67:	6a 01                	push   $0x1
  69:	e8 ba 04 00 00       	call   528 <printf>
  6e:	83 c4 10             	add    $0x10,%esp
  71:	8d 76 00             	lea    0x0(%esi),%esi
        while (1) {
       printf(1, "Hi there , I am child\n");
  74:	83 ec 08             	sub    $0x8,%esp
  77:	68 56 08 00 00       	push   $0x856
  7c:	6a 01                	push   $0x1
  7e:	e8 a5 04 00 00       	call   528 <printf>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4a0:	56                   	push   %esi
 4a1:	53                   	push   %ebx
 4a2:	83 ec 3c             	sub    $0x3c,%esp
 4a5:	89 45 c0             	mov    %eax,-0x40(%ebp)
 4a8:	89 cb                	mov    %ecx,%ebx
  char buf[16];
  int i, neg;
  uint x;
 ...
 4af:	74 04                	je     4b5 <printint+0x19>
 4b1:	85 d2                	test   %edx,%edx
 4b3:	78 6b                	js     520 <printint+0x84>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
 4b5:	89 55 c4             	mov    %edx,-0x3c(%ebp)
  neg = 0;
 4b8:	c7 45 08 00 00 00 00 	movl   $0x0,0x8(%ebp)
  }

  i = 0;
 4bf:	31 c9                	xor    %ecx,%ecx
 4c1:	8d 75 d7             	lea    -0x29(%ebp),%esi
  do{
    buf[i++] = digits[x % base];
 4c4:	8b 45 c4             	mov    -0x3c(%ebp),%eax
 4c7:	31 d2                	xor    %edx,%edx
 4c9:	f7 f3                	div    %ebx
 4cb:	89 cf                	mov    %ecx,%edi
 4cd:	8d 49 01             	lea    0x1(%ecx),%ecx
 4d0:	8a 92 cc 08 00 00    	mov    0x8cc(%edx),%dl
 4d6:	88 54 3e 01          	mov    %dl,0x1(%esi,%edi,1)
  }while((x /= base) != 0);
 4da:	8b 55 c4             	mov    -0x3c(%ebp),%edx
 4dd:	89 45 c4             	mov    %eax,-0x3c(%ebp)
 4e0:	39 da                	cmp    %ebx,%edx
 4e2:	73 e0                	jae    4c4 <printint+0x28>
  if(neg)
 4e4:	8b 55 08             	mov    0x8(%ebp),%edx
 4e7:	85 d2                	test   %edx,%edx
 4e9:	74 07                	je     4f2 <printint+0x56>
    buf[i++] = '-';
 4eb:	c6 44 0d d8 2d       	movb   $0x2d,-0x28(%ebp,%ecx,1)
 4f0:	89 cf                	mov    %ecx,%edi

  while(--i >= 0)
 4f2:	8d 5d d8             	lea    -0x28(%ebp),%ebx
 4f5:	8d 7c 3d d8          	lea    -0x28(%ebp,%edi,1),%edi
 4f9:	8d 76 00             	lea    0x0(%esi),%esi
    putc(fd, buf[i]);
 4fc:	8a 07                	mov    (%edi),%al
 4fe:	88 45 d7             	mov    %al,-0x29(%ebp)
  write(fd, &c, 1);
 501:	50                   	push   %eax
 502:	6a 01                	push   $0x1
 504:	56                   	push   %esi
 505:	ff 75 c0             	push   -0x40(%ebp)
 508:	e8 06 ff ff ff       	call   413 <write>
  while(--i >= 0)
 50d:	89 f8                	mov    %edi,%eax
 50f:	4f                   	dec    %edi
 510:	83 c4 10             	add    $0x10,%esp
 513:	39 d8                	cmp    %ebx,%eax
 515:	75 e5                	jne    4fc <printint+0x60>
}
 ...
 51f:	90                   	nop
    x = -xx;
 520:	f7 da                	neg    %edx
 522:	89 55 c4             	mov    %edx,-0x3c(%ebp)
 525:	eb 98                	jmp    4bf <printint+0x23>
 527:	90                   	nop
...
printf(int fd, const char *fmt, ...)
{
 ...
 531:	8b 75 08             	mov    0x8(%ebp),%esi
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
 534:	8b 5d 0c             	mov    0xc(%ebp),%ebx
 537:	8a 03                	mov    (%ebx),%al
 539:	84 c0                	test   %al,%al
 53b:	74 2a                	je     567 <printf+0x3f>
 53d:	43                   	inc    %ebx
  ap = (uint*)(void*)&fmt + 1;
 53e:	8d 4d 10             	lea    0x10(%ebp),%ecx
 541:	89 4d d4             	mov    %ecx,-0x2c(%ebp)
    c = fmt[i] & 0xff;
 544:	0f b6 d0             	movzbl %al,%edx
    if(state == 0){
      if(c == '%'){
 547:	83 fa 25             	cmp    $0x25,%edx
 54a:	74 24                	je     570 <printf+0x48>
        state = '%';
      } else {
        putc(fd, c);
 ...
 555:	50                   	push   %eax
 556:	56                   	push   %esi
 557:	e8 b7 fe ff ff       	call   413 <write>
  for(i = 0; fmt[i]; i++){
 55c:	43                   	inc    %ebx
 55d:	8a 43 ff             	mov    -0x1(%ebx),%al
 560:	83 c4 10             	add    $0x10,%esp
 563:	84 c0                	test   %al,%al
 565:	75 dd                	jne    544 <printf+0x1c>
        putc(fd, c);
      }
      state = 0;
    }
 ...
 574:	74 f1                	je     567 <printf+0x3f>
    c = fmt[i] & 0xff;
 576:	0f b6 c2             	movzbl %dl,%eax
      if(c == 'd'){
 579:	80 fa 25             	cmp    $0x25,%dl
 57c:	0f 84 fe 00 00 00    	je     680 <printf+0x158>
 582:	83 e8 63             	sub    $0x63,%eax
 585:	83 f8 15             	cmp    $0x15,%eax
 588:	77 0a                	ja     594 <printf+0x6c>
 58a:	ff 24 85 74 08 00 00 	jmp    *0x874(,%eax,4)
 591:	8d 76 00             	lea    0x0(%esi),%esi
 594:	88 55 d0             	mov    %dl,-0x30(%ebp)
        putc(fd, '%');
 ...
 5a1:	57                   	push   %edi
 5a2:	56                   	push   %esi
 5a3:	e8 6b fe ff ff       	call   413 <write>
        putc(fd, c);
 5a8:	8a 55 d0             	mov    -0x30(%ebp),%dl
 ...
 5b3:	57                   	push   %edi
 5b4:	56                   	push   %esi
 5b5:	e8 59 fe ff ff       	call   413 <write>
  for(i = 0; fmt[i]; i++){
 5ba:	83 c3 02             	add    $0x2,%ebx
 5bd:	8a 43 ff             	mov    -0x1(%ebx),%al
 5c0:	83 c4 10             	add    $0x10,%esp
 5c3:	84 c0                	test   %al,%al
 5c5:	0f 85 79 ff ff ff    	jne    544 <printf+0x1c>
}
 ...
 5e5:	e8 b2 fe ff ff       	call   49c <printint>
        ap++;
 5ea:	83 c7 04             	add    $0x4,%edi
 5ed:	89 7d d4             	mov    %edi,-0x2c(%ebp)
  for(i = 0; fmt[i]; i++){
 5f0:	eb c8                	jmp    5ba <printf+0x92>
 5f2:	66 90                	xchg   %ax,%ax
        s = (char*)*ap;
 5f4:	8b 4d d4             	mov    -0x2c(%ebp),%ecx
 5f7:	8b 01                	mov    (%ecx),%eax
        ap++;
 5f9:	83 c1 04             	add    $0x4,%ecx
 5fc:	89 4d d4             	mov    %ecx,-0x2c(%ebp)
        if(s == 0)
 5ff:	85 c0                	test   %eax,%eax
 601:	0f 84 89 00 00 00    	je     690 <printf+0x168>
        while(*s != 0){
 607:	8a 10                	mov    (%eax),%dl
 609:	84 d2                	test   %dl,%dl
 60b:	74 29                	je     636 <printf+0x10e>
 60d:	89 c7                	mov    %eax,%edi
 60f:	88 d0                	mov    %dl,%al
 611:	8d 4d e7             	lea    -0x19(%ebp),%ecx
 614:	89 5d d0             	mov    %ebx,-0x30(%ebp)
 617:	89 fb                	mov    %edi,%ebx
 619:	89 cf                	mov    %ecx,%edi
 61b:	90                   	nop
          putc(fd, *s);
 ...
 622:	57                   	push   %edi
 623:	56                   	push   %esi
 624:	e8 ea fd ff ff       	call   413 <write>
          s++;
 629:	43                   	inc    %ebx
        while(*s != 0){
 ...
 631:	75 e9                	jne    61c <printf+0xf4>
 633:	8b 5d d0             	mov    -0x30(%ebp),%ebx
  for(i = 0; fmt[i]; i++){
 636:	83 c3 02             	add    $0x2,%ebx
 639:	8a 43 ff             	mov    -0x1(%ebx),%al
 63c:	84 c0                	test   %al,%al
 63e:	0f 85 00 ff ff ff    	jne    544 <printf+0x1c>
 644:	e9 1e ff ff ff       	jmp    567 <printf+0x3f>
 649:	8d 76 00             	lea    0x0(%esi),%esi
        printint(fd, *ap, 10, 1);
 64c:	8b 7d d4             	mov    -0x2c(%ebp),%edi
 64f:	8b 17                	mov    (%edi),%edx
 651:	83 ec 0c             	sub    $0xc,%esp
 654:	6a 01                	push   $0x1
 656:	b9 0a 00 00 00       	mov    $0xa,%ecx
 65b:	eb 86                	jmp    5e3 <printf+0xbb>
 ...
 668:	51                   	push   %ecx
 669:	6a 01                	push   $0x1
 66b:	8d 7d e7             	lea    -0x19(%ebp),%edi
 66e:	57                   	push   %edi
 66f:	56                   	push   %esi
 670:	e8 9e fd ff ff       	call   413 <write>
        ap++;
 675:	83 45 d4 04          	addl   $0x4,-0x2c(%ebp)
 679:	e9 3c ff ff ff       	jmp    5ba <printf+0x92>
 ...
 683:	52                   	push   %edx
 684:	6a 01                	push   $0x1
 686:	8d 7d e7             	lea    -0x19(%ebp),%edi
 689:	e9 25 ff ff ff       	jmp    5b3 <printf+0x8b>
 68e:	66 90                	xchg   %ax,%ax
          s = "(null)";
 690:	bf 6d 08 00 00       	mov    $0x86d,%edi
 695:	b0 28                	mov    $0x28,%al
 697:	e9 75 ff ff ff       	jmp    611 <printf+0xe9>
...
free(void *ap)
{
 ...
 6a2:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  bp = (Header*)ap - 1;
 6a5:	8d 4b f8             	lea    -0x8(%ebx),%ecx
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
 6a8:	a1 e0 08 00 00       	mov    0x8e0,%eax
 ...
 6d7:	89 0a                	mov    %ecx,(%edx)
    ...
    p->s.ptr = bp;
  freep = p;
 6d9:	89 15 e0 08 00 00    	mov    %edx,0x8e0
}
 6df:	5b                   	pop    %ebx
 6e0:	5e                   	pop    %esi
 6e1:	5f                   	pop    %edi
 ...
 6e6:	72 c8                	jb     6b0 <free+0x14>
 6e8:	39 c1                	cmp    %eax,%ecx
 6ea:	73 c4                	jae    6b0 <free+0x14>
  if(bp + bp->s.size == p->s.ptr){
 6ec:	8b 73 fc             	mov    -0x4(%ebx),%esi
 6ef:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
 6f2:	39 f8                	cmp    %edi,%eax
 6f4:	75 d4                	jne    6ca <free+0x2e>
    bp->s.size += p->s.ptr->s.size;
 6f6:	03 70 04             	add    0x4(%eax),%esi
 6f9:	89 73 fc             	mov    %esi,-0x4(%ebx)
    bp->s.ptr = p->s.ptr->s.ptr;
 6fc:	8b 02                	mov    (%edx),%eax
 6fe:	8b 00                	mov    (%eax),%eax
 700:	89 43 f8             	mov    %eax,-0x8(%ebx)
  if(p + p->s.size == bp){
 703:	8b 42 04             	mov    0x4(%edx),%eax
 706:	8d 34 c2             	lea    (%edx,%eax,8),%esi
 709:	39 f1                	cmp    %esi,%ecx
 70b:	75 ca                	jne    6d7 <free+0x3b>
    p->s.size += bp->s.size;
 70d:	03 43 fc             	add    -0x4(%ebx),%eax
 710:	89 42 04             	mov    %eax,0x4(%edx)
    p->s.ptr = bp->s.ptr;
 713:	8b 4b f8             	mov    -0x8(%ebx),%ecx
 716:	89 0a                	mov    %ecx,(%edx)
  freep = p;
 718:	89 15 e0 08 00 00    	mov    %edx,0x8e0
}
 71e:	5b                   	pop    %ebx
 71f:	5e                   	pop    %esi
 720:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 730:	8d 78 07             	lea    0x7(%eax),%edi
 733:	c1 ef 03             	shr    $0x3,%edi
 736:	47                   	inc    %edi
  if((prevp = freep) == 0){
 737:	8b 15 e0 08 00 00    	mov    0x8e0,%edx
 73d:	85 d2                	test   %edx,%edx
 73f:	0f 84 93 00 00 00    	je     7d8 <malloc+0xb4>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 745:	8b 02                	mov    (%edx),%eax
    if(p->s.size >= nunits){
 747:	8b 48 04             	mov    0x4(%eax),%ecx
 74a:	39 f9                	cmp    %edi,%ecx
 74c:	73 62                	jae    7b0 <malloc+0x8c>
  if(nu < 4096)
 74e:	89 fb                	mov    %edi,%ebx
 750:	81 ff 00 10 00 00    	cmp    $0x1000,%edi
 756:	72 78                	jb     7d0 <malloc+0xac>
  p = sbrk(nu * sizeof(Header));
 758:	8d 34 dd 00 00 00 00 	lea    0x0(,%ebx,8),%esi
 75f:	eb 0e                	jmp    76f <malloc+0x4b>
 761:	8d 76 00             	lea    0x0(%esi),%esi
 764:	89 c2                	mov    %eax,%edx
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 766:	8b 02                	mov    (%edx),%eax
    if(p->s.size >= nunits){
 768:	8b 48 04             	mov    0x4(%eax),%ecx
 76b:	39 f9                	cmp    %edi,%ecx
 76d:	73 41                	jae    7b0 <malloc+0x8c>
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
 76f:	39 05 e0 08 00 00    	cmp    %eax,0x8e0
 775:	75 ed                	jne    764 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
 777:	83 ec 0c             	sub    $0xc,%esp
 77a:	56                   	push   %esi
 77b:	e8 fb fc ff ff       	call   47b <sbrk>
  if(p == (char*)-1)
 780:	83 c4 10             	add    $0x10,%esp
 783:	83 f8 ff             	cmp    $0xffffffff,%eax
 786:	74 1c                	je     7a4 <malloc+0x80>
  hp->s.size = nu;
 ...
 791:	50                   	push   %eax
 792:	e8 05 ff ff ff       	call   69c <free>
  return freep;
 797:	8b 15 e0 08 00 00    	mov    0x8e0,%edx
      if((p = morecore(nunits)) == 0)
 79d:	83 c4 10             	add    $0x10,%esp
 7a0:	85 d2                	test   %edx,%edx
 7a2:	75 c2                	jne    766 <malloc+0x42>
        return 0;
 ...
 7bc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7bf:	89 15 e0 08 00 00    	mov    %edx,0x8e0
      return (void*)(p + 1);
 ...
 7d5:	eb 81                	jmp    758 <malloc+0x34>
 7d7:	90                   	nop
    base.s.ptr = freep = prevp = &base;
 7d8:	c7 05 e0 08 00 00 e4 	movl   $0x8e4,0x8e0
 7df:	08 00 00 
 7e2:	c7 05 e4 08 00 00 e4 	movl   $0x8e4,0x8e4
 7e9:	08 00 00 
    base.s.size = 0;
 7ec:	c7 05 e8 08 00 00 00 	movl   $0x0,0x8e8
 7f3:	00 00 00 
 7f6:	b8 e4 08 00 00       	mov    $0x8e4,%eax
 7fb:	e9 4e ff ff ff       	jmp    74e <malloc+0x2a>
        prevp->s.ptr = p->s.ptr;
 800:	8b 08                	mov    (%eax),%ecx
 802:	89 0a                	mov    %ecx,(%edx)
 804:	eb b9                	jmp    7bf <malloc+0x9b>
