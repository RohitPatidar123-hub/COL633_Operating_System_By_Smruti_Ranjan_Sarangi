...
main(int argc, char *argv[])
{
  ...
  5d:	52                   	push   %edx
  5e:	50                   	push   %eax
  5f:	68 3f 07 00 00       	push   $0x73f
  64:	6a 01                	push   $0x1
  66:	e8 d1 03 00 00       	call   43c <printf>
      exit();
  6b:	e8 97 02 00 00       	call   307 <exit>
    wc(0, "");
  70:	51                   	push   %ecx
  71:	51                   	push   %ecx
  72:	68 31 07 00 00       	push   $0x731
  77:	6a 00                	push   $0x0
...
00000084 <wc>:
{
 ...
 11a:	68 32 07 00 00       	push   $0x732
 11f:	6a 01                	push   $0x1
 121:	e8 16 03 00 00       	call   43c <printf>
}
 ...
 131:	50                   	push   %eax
 132:	50                   	push   %eax
 133:	68 22 07 00 00       	push   $0x722
 138:	6a 01                	push   $0x1
 13a:	e8 fd 02 00 00       	call   43c <printf>
    exit();
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3e4:	8a 92 b4 07 00 00    	mov    0x7b4(%edx),%dl
 ...
 41c:	e8 06 ff ff ff       	call   327 <write>
  while(--i >= 0)
...
printf(int fd, const char *fmt, ...)
{
 ...
 469:	50                   	push   %eax
 46a:	56                   	push   %esi
 46b:	e8 b7 fe ff ff       	call   327 <write>
  for(i = 0; fmt[i]; i++){
 470:	43                   	inc    %ebx
 ...
 49e:	ff 24 85 5c 07 00 00 	jmp    *0x75c(,%eax,4)
 ...
 4b5:	57                   	push   %edi
 4b6:	56                   	push   %esi
 4b7:	e8 6b fe ff ff       	call   327 <write>
        putc(fd, c);
 ...
 4c7:	57                   	push   %edi
 4c8:	56                   	push   %esi
 4c9:	e8 59 fe ff ff       	call   327 <write>
  for(i = 0; fmt[i]; i++){
 ...
 536:	57                   	push   %edi
 537:	56                   	push   %esi
 538:	e8 ea fd ff ff       	call   327 <write>
          s++;
 53d:	43                   	inc    %ebx
        while(*s != 0){
 ...
 582:	57                   	push   %edi
 583:	56                   	push   %esi
 584:	e8 9e fd ff ff       	call   327 <write>
        ap++;
 ...
 5a2:	66 90                	xchg   %ax,%ax
          s = "(null)";
 5a4:	bf 53 07 00 00       	mov    $0x753,%edi
...
free(void *ap)
{
 ...
 5bc:	a1 e0 09 00 00       	mov    0x9e0,%eax
 ...
 5eb:	89 0a                	mov    %ecx,(%edx)
    ...
    p->s.ptr = bp;
  freep = p;
 5ed:	89 15 e0 09 00 00    	mov    %edx,0x9e0
}
 5f3:	5b                   	pop    %ebx
 5f4:	5e                   	pop    %esi
 5f5:	5f                   	pop    %edi
 ...
 62a:	89 0a                	mov    %ecx,(%edx)
  freep = p;
 62c:	89 15 e0 09 00 00    	mov    %edx,0x9e0
}
 632:	5b                   	pop    %ebx
 633:	5e                   	pop    %esi
 634:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 681:	73 41                	jae    6c4 <malloc+0x8c>
    ...
    if(p == freep)
 683:	39 05 e0 09 00 00    	cmp    %eax,0x9e0
 689:	75 ed                	jne    678 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
 68b:	83 ec 0c             	sub    $0xc,%esp
 68e:	56                   	push   %esi
 68f:	e8 fb fc ff ff       	call   38f <sbrk>
  if(p == (char*)-1)
 ...
 6d0:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6d3:	89 15 e0 09 00 00    	mov    %edx,0x9e0
      return (void*)(p + 1);
 ...
 6eb:	90                   	nop
    base.s.ptr = freep = prevp = &base;
 6ec:	c7 05 e0 09 00 00 e4 	movl   $0x9e4,0x9e0
 6f3:	09 00 00 
 6f6:	c7 05 e4 09 00 00 e4 	movl   $0x9e4,0x9e4
 6fd:	09 00 00 
    base.s.size = 0;
 700:	c7 05 e8 09 00 00 00 	movl   $0x0,0x9e8
 707:	00 00 00 
