...
main(int argc, char *argv[])
{
  ...
  6c:	50                   	push   %eax
  6d:	ff 33                	push   (%ebx)
  6f:	68 ec 08 00 00       	push   $0x8ec
  74:	6a 01                	push   $0x1
  76:	e8 71 05 00 00       	call   5ec <printf>
      exit();
  7b:	e8 37 04 00 00       	call   4b7 <exit>
    printf(2, "usage: grep pattern [file ...]\n");
  80:	51                   	push   %ecx
  81:	51                   	push   %ecx
  82:	68 cc 08 00 00       	push   $0x8cc
  87:	6a 02                	push   $0x2
  89:	e8 5e 05 00 00       	call   5ec <printf>
    exit();
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 594:	8a 92 64 09 00 00    	mov    0x964(%edx),%dl
...
printf(int fd, const char *fmt, ...)
{
 ...
 5fb:	8a 03                	mov    (%ebx),%al
 5fd:	84 c0                	test   %al,%al
 5ff:	74 2a                	je     62b <printf+0x3f>
 601:	43                   	inc    %ebx
  ap = (uint*)(void*)&fmt + 1;
 602:	8d 4d 10             	lea    0x10(%ebp),%ecx
 605:	89 4d d4             	mov    %ecx,-0x2c(%ebp)
    c = fmt[i] & 0xff;
 608:	0f b6 d0             	movzbl %al,%edx
    if(state == 0){
      if(c == '%'){
 60b:	83 fa 25             	cmp    $0x25,%edx
 60e:	74 24                	je     634 <printf+0x48>
        state = '%';
      } else {
        putc(fd, c);
 ...
 619:	50                   	push   %eax
 61a:	56                   	push   %esi
 61b:	e8 b7 fe ff ff       	call   4d7 <write>
  for(i = 0; fmt[i]; i++){
 620:	43                   	inc    %ebx
 621:	8a 43 ff             	mov    -0x1(%ebx),%al
 624:	83 c4 10             	add    $0x10,%esp
 627:	84 c0                	test   %al,%al
 629:	75 dd                	jne    608 <printf+0x1c>
        putc(fd, c);
      }
      state = 0;
    }
 ...
 633:	90                   	nop
  for(i = 0; fmt[i]; i++){
 634:	8a 13                	mov    (%ebx),%dl
 636:	84 d2                	test   %dl,%dl
 638:	74 f1                	je     62b <printf+0x3f>
    c = fmt[i] & 0xff;
 63a:	0f b6 c2             	movzbl %dl,%eax
      if(c == 'd'){
 63d:	80 fa 25             	cmp    $0x25,%dl
 640:	0f 84 fe 00 00 00    	je     744 <printf+0x158>
 646:	83 e8 63             	sub    $0x63,%eax
 649:	83 f8 15             	cmp    $0x15,%eax
 64c:	77 0a                	ja     658 <printf+0x6c>
 64e:	ff 24 85 0c 09 00 00 	jmp    *0x90c(,%eax,4)
 655:	8d 76 00             	lea    0x0(%esi),%esi
 658:	88 55 d0             	mov    %dl,-0x30(%ebp)
        putc(fd, '%');
 65b:	c6 45 e7 25          	movb   $0x25,-0x19(%ebp)
  write(fd, &c, 1);
 65f:	50                   	push   %eax
 660:	6a 01                	push   $0x1
 662:	8d 7d e7             	lea    -0x19(%ebp),%edi
 665:	57                   	push   %edi
 666:	56                   	push   %esi
 667:	e8 6b fe ff ff       	call   4d7 <write>
        putc(fd, c);
 66c:	8a 55 d0             	mov    -0x30(%ebp),%dl
 66f:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
 672:	83 c4 0c             	add    $0xc,%esp
 675:	6a 01                	push   $0x1
 677:	57                   	push   %edi
 678:	56                   	push   %esi
 679:	e8 59 fe ff ff       	call   4d7 <write>
  for(i = 0; fmt[i]; i++){
 67e:	83 c3 02             	add    $0x2,%ebx
 681:	8a 43 ff             	mov    -0x1(%ebx),%al
 684:	83 c4 10             	add    $0x10,%esp
 687:	84 c0                	test   %al,%al
 689:	0f 85 79 ff ff ff    	jne    608 <printf+0x1c>
}
 ...
 6b1:	89 7d d4             	mov    %edi,-0x2c(%ebp)
  for(i = 0; fmt[i]; i++){
 6b4:	eb c8                	jmp    67e <printf+0x92>
 6b6:	66 90                	xchg   %ax,%ax
        s = (char*)*ap;
 6b8:	8b 4d d4             	mov    -0x2c(%ebp),%ecx
 6bb:	8b 01                	mov    (%ecx),%eax
        ap++;
 6bd:	83 c1 04             	add    $0x4,%ecx
 6c0:	89 4d d4             	mov    %ecx,-0x2c(%ebp)
        if(s == 0)
 6c3:	85 c0                	test   %eax,%eax
 6c5:	0f 84 89 00 00 00    	je     754 <printf+0x168>
        while(*s != 0){
 6cb:	8a 10                	mov    (%eax),%dl
 6cd:	84 d2                	test   %dl,%dl
 6cf:	74 29                	je     6fa <printf+0x10e>
 6d1:	89 c7                	mov    %eax,%edi
 6d3:	88 d0                	mov    %dl,%al
 6d5:	8d 4d e7             	lea    -0x19(%ebp),%ecx
 6d8:	89 5d d0             	mov    %ebx,-0x30(%ebp)
 6db:	89 fb                	mov    %edi,%ebx
 6dd:	89 cf                	mov    %ecx,%edi
 6df:	90                   	nop
          putc(fd, *s);
 ...
 6e6:	57                   	push   %edi
 6e7:	56                   	push   %esi
 6e8:	e8 ea fd ff ff       	call   4d7 <write>
          s++;
 6ed:	43                   	inc    %ebx
        while(*s != 0){
 ...
 6f5:	75 e9                	jne    6e0 <printf+0xf4>
 6f7:	8b 5d d0             	mov    -0x30(%ebp),%ebx
  for(i = 0; fmt[i]; i++){
 6fa:	83 c3 02             	add    $0x2,%ebx
 6fd:	8a 43 ff             	mov    -0x1(%ebx),%al
 700:	84 c0                	test   %al,%al
 702:	0f 85 00 ff ff ff    	jne    608 <printf+0x1c>
 708:	e9 1e ff ff ff       	jmp    62b <printf+0x3f>
 ...
 72c:	51                   	push   %ecx
 72d:	6a 01                	push   $0x1
 72f:	8d 7d e7             	lea    -0x19(%ebp),%edi
 732:	57                   	push   %edi
 733:	56                   	push   %esi
 734:	e8 9e fd ff ff       	call   4d7 <write>
        ap++;
 739:	83 45 d4 04          	addl   $0x4,-0x2c(%ebp)
 73d:	e9 3c ff ff ff       	jmp    67e <printf+0x92>
 ...
 74d:	e9 25 ff ff ff       	jmp    677 <printf+0x8b>
 752:	66 90                	xchg   %ax,%ax
          s = "(null)";
 754:	bf 02 09 00 00       	mov    $0x902,%edi
 759:	b0 28                	mov    $0x28,%al
 75b:	e9 75 ff ff ff       	jmp    6d5 <printf+0xe9>
...
free(void *ap)
{
 ...
 76c:	a1 80 0d 00 00       	mov    0xd80,%eax
 ...
 79b:	89 0a                	mov    %ecx,(%edx)
    ...
    p->s.ptr = bp;
  freep = p;
 79d:	89 15 80 0d 00 00    	mov    %edx,0xd80
}
 7a3:	5b                   	pop    %ebx
 7a4:	5e                   	pop    %esi
 7a5:	5f                   	pop    %edi
 ...
 7da:	89 0a                	mov    %ecx,(%edx)
  freep = p;
 7dc:	89 15 80 0d 00 00    	mov    %edx,0xd80
}
 7e2:	5b                   	pop    %ebx
 7e3:	5e                   	pop    %esi
 7e4:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 7f4:	8d 78 07             	lea    0x7(%eax),%edi
 7f7:	c1 ef 03             	shr    $0x3,%edi
 7fa:	47                   	inc    %edi
  if((prevp = freep) == 0){
 7fb:	8b 15 80 0d 00 00    	mov    0xd80,%edx
 801:	85 d2                	test   %edx,%edx
 803:	0f 84 93 00 00 00    	je     89c <malloc+0xb4>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 809:	8b 02                	mov    (%edx),%eax
    if(p->s.size >= nunits){
 80b:	8b 48 04             	mov    0x4(%eax),%ecx
 80e:	39 f9                	cmp    %edi,%ecx
 810:	73 62                	jae    874 <malloc+0x8c>
  if(nu < 4096)
 812:	89 fb                	mov    %edi,%ebx
 814:	81 ff 00 10 00 00    	cmp    $0x1000,%edi
 81a:	72 78                	jb     894 <malloc+0xac>
  p = sbrk(nu * sizeof(Header));
 81c:	8d 34 dd 00 00 00 00 	lea    0x0(,%ebx,8),%esi
 823:	eb 0e                	jmp    833 <malloc+0x4b>
 ...
 82f:	39 f9                	cmp    %edi,%ecx
 831:	73 41                	jae    874 <malloc+0x8c>
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
 833:	39 05 80 0d 00 00    	cmp    %eax,0xd80
 839:	75 ed                	jne    828 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
 83b:	83 ec 0c             	sub    $0xc,%esp
 83e:	56                   	push   %esi
 83f:	e8 fb fc ff ff       	call   53f <sbrk>
  if(p == (char*)-1)
 844:	83 c4 10             	add    $0x10,%esp
 847:	83 f8 ff             	cmp    $0xffffffff,%eax
 84a:	74 1c                	je     868 <malloc+0x80>
  hp->s.size = nu;
 ...
 855:	50                   	push   %eax
 856:	e8 05 ff ff ff       	call   760 <free>
  return freep;
 85b:	8b 15 80 0d 00 00    	mov    0xd80,%edx
      if((p = morecore(nunits)) == 0)
 861:	83 c4 10             	add    $0x10,%esp
 864:	85 d2                	test   %edx,%edx
 866:	75 c2                	jne    82a <malloc+0x42>
        return 0;
 ...
 872:	66 90                	xchg   %ax,%ax
      if(p->s.size == nunits)
 874:	39 cf                	cmp    %ecx,%edi
 876:	74 4c                	je     8c4 <malloc+0xdc>
        p->s.size -= nunits;
 878:	29 f9                	sub    %edi,%ecx
 87a:	89 48 04             	mov    %ecx,0x4(%eax)
        p += p->s.size;
 87d:	8d 04 c8             	lea    (%eax,%ecx,8),%eax
        p->s.size = nunits;
 880:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 883:	89 15 80 0d 00 00    	mov    %edx,0xd80
      return (void*)(p + 1);
 ...
 893:	c3                   	ret
  if(nu < 4096)
 894:	bb 00 10 00 00       	mov    $0x1000,%ebx
 899:	eb 81                	jmp    81c <malloc+0x34>
 89b:	90                   	nop
    base.s.ptr = freep = prevp = &base;
 89c:	c7 05 80 0d 00 00 84 	movl   $0xd84,0xd80
 8a3:	0d 00 00 
 8a6:	c7 05 84 0d 00 00 84 	movl   $0xd84,0xd84
 8ad:	0d 00 00 
    base.s.size = 0;
 8b0:	c7 05 88 0d 00 00 00 	movl   $0x0,0xd88
 8b7:	00 00 00 
 8ba:	b8 84 0d 00 00       	mov    $0xd84,%eax
 8bf:	e9 4e ff ff ff       	jmp    812 <malloc+0x2a>
        prevp->s.ptr = p->s.ptr;
 8c4:	8b 08                	mov    (%eax),%ecx
 8c6:	89 0a                	mov    %ecx,(%edx)
 8c8:	eb b9                	jmp    883 <malloc+0x9b>
