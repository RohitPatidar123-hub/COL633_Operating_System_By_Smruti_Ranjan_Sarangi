...
main(int argc, char *argv[])
{
  ...
  printf(1, "usertests starting\n");
      ...
      16:	6a 01                	push   $0x1
      18:	e8 93 36 00 00       	call   36b0 <printf>
  ...
  if(open("usertests.ran", 0) >= 0){
    ...
    printf(1, "already ran user tests -- rebuild fs.img\n");
      ...
      39:	6a 01                	push   $0x1
      3b:	e8 70 36 00 00       	call   36b0 <printf>
    exit();
...
00000114 <iputtest>:
{
  ...
  printf(stdout, "iput test\n");
     ...
     125:	e8 86 35 00 00       	call   36b0 <printf>
  if(mkdir("iputdir") < 0){
  ...
  if(chdir("/") < 0){
    ...
    printf(stdout, "chdir / failed\n");
     178:	a1 b0 51 00 00       	mov    0x51b0,%eax
  if(chdir("/") < 0){
  ...
  printf(stdout, "iput test ok\n");
     ...
     187:	68 5c 3a 00 00       	push   $0x3a5c
     18c:	50                   	push   %eax
     18d:	e8 1e 35 00 00       	call   36b0 <printf>
}
    ...
    printf(stdout, "mkdir failed\n");
     197:	50                   	push   %eax
     198:	50                   	push   %eax
     199:	68 90 39 00 00       	push   $0x3990
     19e:	ff 35 b0 51 00 00    	push   0x51b0
     1a4:	e8 07 35 00 00       	call   36b0 <printf>
    exit();
     1a9:	e8 cd 33 00 00       	call   357b <exit>
    printf(stdout, "chdir / failed\n");
     1ae:	52                   	push   %edx
     1af:	52                   	push   %edx
     1b0:	68 db 39 00 00       	push   $0x39db
     1b5:	50                   	push   %eax
     1b6:	e8 f5 34 00 00       	call   36b0 <printf>
    exit();
     1bb:	e8 bb 33 00 00       	call   357b <exit>
    printf(stdout, "unlink ../iputdir failed\n");
     1c0:	51                   	push   %ecx
     1c1:	51                   	push   %ecx
     1c2:	68 bf 39 00 00       	push   $0x39bf
     1c7:	ff 35 b0 51 00 00    	push   0x51b0
     1cd:	e8 de 34 00 00       	call   36b0 <printf>
    exit();
     1d2:	e8 a4 33 00 00       	call   357b <exit>
    printf(stdout, "chdir iputdir failed\n");
     1d7:	50                   	push   %eax
     1d8:	50                   	push   %eax
     1d9:	68 9e 39 00 00       	push   $0x399e
     1de:	ff 35 b0 51 00 00    	push   0x51b0
     1e4:	e8 c7 34 00 00       	call   36b0 <printf>
    exit();
...
000001f0 <exitiputtest>:
{
  ...
  printf(stdout, "exitiput test\n");
     1f6:	68 eb 39 00 00       	push   $0x39eb
     1fb:	ff 35 b0 51 00 00    	push   0x51b0
     201:	e8 aa 34 00 00       	call   36b0 <printf>
  pid = fork();
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     21b:	68 b7 39 00 00       	push   $0x39b7
    ...
    if(chdir("iputdir") < 0){
     ...
     233:	68 b7 39 00 00       	push   $0x39b7
    ...
    if(unlink("../iputdir") < 0){
     ...
     24b:	68 b4 39 00 00       	push   $0x39b4
  ...
  printf(stdout, "exitiput test ok\n");
     ...
     26c:	68 0e 3a 00 00       	push   $0x3a0e
     271:	ff 35 b0 51 00 00    	push   0x51b0
     277:	e8 34 34 00 00       	call   36b0 <printf>
}
     ...
     287:	68 bf 39 00 00       	push   $0x39bf
     28c:	ff 35 b0 51 00 00    	push   0x51b0
     292:	e8 19 34 00 00       	call   36b0 <printf>
      exit();
     297:	e8 df 32 00 00       	call   357b <exit>
    printf(stdout, "fork failed\n");
     29c:	51                   	push   %ecx
     29d:	51                   	push   %ecx
     29e:	68 d1 48 00 00       	push   $0x48d1
     2a3:	ff 35 b0 51 00 00    	push   0x51b0
     2a9:	e8 02 34 00 00       	call   36b0 <printf>
    exit();
     2ae:	e8 c8 32 00 00       	call   357b <exit>
      printf(stdout, "mkdir failed\n");
     2b3:	52                   	push   %edx
     2b4:	52                   	push   %edx
     2b5:	68 90 39 00 00       	push   $0x3990
     2ba:	ff 35 b0 51 00 00    	push   0x51b0
     2c0:	e8 eb 33 00 00       	call   36b0 <printf>
      exit();
     2c5:	e8 b1 32 00 00       	call   357b <exit>
      printf(stdout, "child chdir failed\n");
     2ca:	50                   	push   %eax
     2cb:	50                   	push   %eax
     2cc:	68 fa 39 00 00       	push   $0x39fa
     2d1:	ff 35 b0 51 00 00    	push   0x51b0
     2d7:	e8 d4 33 00 00       	call   36b0 <printf>
      exit();
...
000002e4 <openiputtest>:
{
  ...
  printf(stdout, "openiput test\n");
     2ea:	68 20 3a 00 00       	push   $0x3a20
     2ef:	ff 35 b0 51 00 00    	push   0x51b0
     2f5:	e8 b6 33 00 00       	call   36b0 <printf>
  if(mkdir("oidir") < 0){
     2fa:	c7 04 24 2f 3a 00 00 	movl   $0x3a2f,(%esp)
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     31f:	6a 02                	push   $0x2
     321:	68 2f 3a 00 00       	push   $0x3a2f
    ...
    if(fd >= 0){
     ...
     335:	68 b8 49 00 00       	push   $0x49b8
     33a:	ff 35 b0 51 00 00    	push   0x51b0
     340:	e8 6b 33 00 00       	call   36b0 <printf>
      exit();
  ...
  if(unlink("oidir") != 0){
     356:	c7 04 24 2f 3a 00 00 	movl   $0x3a2f,(%esp)
  ...
  printf(stdout, "openiput test ok\n");
     ...
     371:	68 58 3a 00 00       	push   $0x3a58
     376:	ff 35 b0 51 00 00    	push   0x51b0
     37c:	e8 2f 33 00 00       	call   36b0 <printf>
}
    ...
    printf(stdout, "fork failed\n");
     38d:	52                   	push   %edx
     38e:	52                   	push   %edx
     38f:	68 d1 48 00 00       	push   $0x48d1
     394:	ff 35 b0 51 00 00    	push   0x51b0
     39a:	e8 11 33 00 00       	call   36b0 <printf>
    exit();
     39f:	e8 d7 31 00 00       	call   357b <exit>
    printf(stdout, "mkdir oidir failed\n");
     3a4:	51                   	push   %ecx
     3a5:	51                   	push   %ecx
     3a6:	68 35 3a 00 00       	push   $0x3a35
     3ab:	ff 35 b0 51 00 00    	push   0x51b0
     3b1:	e8 fa 32 00 00       	call   36b0 <printf>
    exit();
     3b6:	e8 c0 31 00 00       	call   357b <exit>
    printf(stdout, "unlink failed\n");
     3bb:	50                   	push   %eax
     3bc:	50                   	push   %eax
     3bd:	68 49 3a 00 00       	push   $0x3a49
     3c2:	ff 35 b0 51 00 00    	push   0x51b0
     3c8:	e8 e3 32 00 00       	call   36b0 <printf>
    exit();
...
000003d4 <opentest>:
{
  ...
  printf(stdout, "open test\n");
     3da:	68 6a 3a 00 00       	push   $0x3a6a
     3df:	ff 35 b0 51 00 00    	push   0x51b0
     3e5:	e8 c6 32 00 00       	call   36b0 <printf>
  fd = open("echo", 0);
     3ea:	58                   	pop    %eax
     3eb:	5a                   	pop    %edx
     3ec:	6a 00                	push   $0x0
     3ee:	68 75 3a 00 00       	push   $0x3a75
  ...
  fd = open("doesnotexist", 0);
     ...
     409:	58                   	pop    %eax
     40a:	6a 00                	push   $0x0
     40c:	68 8d 3a 00 00       	push   $0x3a8d
     411:	e8 a5 31 00 00       	call   35bb <open>
     416:	89 c2                	mov    %eax,%edx
    printf(stdout, "open doesnotexist succeeded!\n");
     418:	a1 b0 51 00 00       	mov    0x51b0,%eax
  if(fd >= 0){
  ...
  printf(stdout, "open test ok\n");
     ...
     427:	68 b8 3a 00 00       	push   $0x3ab8
     42c:	50                   	push   %eax
     42d:	e8 7e 32 00 00       	call   36b0 <printf>
}
    ...
    printf(stdout, "open echo failed!\n");
     437:	50                   	push   %eax
     438:	50                   	push   %eax
     439:	68 7a 3a 00 00       	push   $0x3a7a
     43e:	ff 35 b0 51 00 00    	push   0x51b0
     444:	e8 67 32 00 00       	call   36b0 <printf>
    exit();
     449:	e8 2d 31 00 00       	call   357b <exit>
    printf(stdout, "open doesnotexist succeeded!\n");
     44e:	52                   	push   %edx
     44f:	52                   	push   %edx
     450:	68 9a 3a 00 00       	push   $0x3a9a
     455:	50                   	push   %eax
     456:	e8 55 32 00 00       	call   36b0 <printf>
    exit();
...
00000460 <writetest>:
{
  ...
  printf(stdout, "small file test\n");
     ...
     468:	68 c6 3a 00 00       	push   $0x3ac6
     46d:	ff 35 b0 51 00 00    	push   0x51b0
     473:	e8 38 32 00 00       	call   36b0 <printf>
  fd = open("small", O_CREATE|O_RDWR);
     478:	59                   	pop    %ecx
     479:	5b                   	pop    %ebx
     47a:	68 02 02 00 00       	push   $0x202
     47f:	68 d7 3a 00 00       	push   $0x3ad7
     484:	e8 32 31 00 00       	call   35bb <open>
     489:	89 c6                	mov    %eax,%esi
    printf(stdout, "creat small succeeded; ok\n");
     48b:	a1 b0 51 00 00       	mov    0x51b0,%eax
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     49e:	68 dd 3a 00 00       	push   $0x3add
     4a3:	50                   	push   %eax
     4a4:	e8 07 32 00 00       	call   36b0 <printf>
  ...
  for(i = 0; i < 100; i++){
    ...
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     4b0:	50                   	push   %eax
     4b1:	6a 0a                	push   $0xa
     4b3:	68 14 3b 00 00       	push   $0x3b14
     4b8:	56                   	push   %esi
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     4ca:	50                   	push   %eax
     4cb:	6a 0a                	push   $0xa
     4cd:	68 1f 3b 00 00       	push   $0x3b1f
     4d2:	56                   	push   %esi
  ...
  printf(stdout, "writes ok\n");
     ...
     4ed:	68 2a 3b 00 00       	push   $0x3b2a
     4f2:	ff 35 b0 51 00 00    	push   0x51b0
     4f8:	e8 b3 31 00 00       	call   36b0 <printf>
  close(fd);
  ...
  fd = open("small", O_RDONLY);
     ...
     506:	58                   	pop    %eax
     507:	6a 00                	push   $0x0
     509:	68 d7 3a 00 00       	push   $0x3ad7
     50e:	e8 a8 30 00 00       	call   35bb <open>
     513:	89 c3                	mov    %eax,%ebx
    printf(stdout, "open small succeeded ok\n");
     515:	a1 b0 51 00 00       	mov    0x51b0,%eax
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     528:	68 35 3b 00 00       	push   $0x3b35
     52d:	50                   	push   %eax
     52e:	e8 7d 31 00 00       	call   36b0 <printf>
  i = read(fd, buf, 2000);
    ...
    printf(stdout, "read succeeded ok\n");
     548:	a1 b0 51 00 00       	mov    0x51b0,%eax
  if(i == 2000){
  ...
  printf(stdout, "small file test ok\n");
     ...
     58f:	68 91 3b 00 00       	push   $0x3b91
     594:	50                   	push   %eax
     595:	e8 16 31 00 00       	call   36b0 <printf>
}
     ...
     5a4:	50                   	push   %eax
     5a5:	53                   	push   %ebx
     5a6:	68 dc 49 00 00       	push   $0x49dc
     5ab:	ff 35 b0 51 00 00    	push   0x51b0
     5b1:	e8 fa 30 00 00       	call   36b0 <printf>
      exit();
     5b6:	e8 c0 2f 00 00       	call   357b <exit>
      printf(stdout, "error: write bb %d new file failed\n", i);
     5bb:	50                   	push   %eax
     5bc:	53                   	push   %ebx
     5bd:	68 00 4a 00 00       	push   $0x4a00
     5c2:	ff 35 b0 51 00 00    	push   0x51b0
     5c8:	e8 e3 30 00 00       	call   36b0 <printf>
      exit();
     5cd:	e8 a9 2f 00 00       	call   357b <exit>
    printf(stdout, "error: open small failed!\n");
     5d2:	53                   	push   %ebx
     5d3:	53                   	push   %ebx
     5d4:	68 4e 3b 00 00       	push   $0x3b4e
     5d9:	50                   	push   %eax
     5da:	e8 d1 30 00 00       	call   36b0 <printf>
    exit();
     5df:	e8 97 2f 00 00       	call   357b <exit>
    printf(stdout, "read failed\n");
     5e4:	51                   	push   %ecx
     5e5:	51                   	push   %ecx
     5e6:	68 95 3e 00 00       	push   $0x3e95
     5eb:	50                   	push   %eax
     5ec:	e8 bf 30 00 00       	call   36b0 <printf>
    exit();
     5f1:	e8 85 2f 00 00       	call   357b <exit>
    printf(stdout, "unlink small failed\n");
     5f6:	52                   	push   %edx
     5f7:	52                   	push   %edx
     5f8:	68 7c 3b 00 00       	push   $0x3b7c
     5fd:	50                   	push   %eax
     5fe:	e8 ad 30 00 00       	call   36b0 <printf>
    exit();
     603:	e8 73 2f 00 00       	call   357b <exit>
    printf(stdout, "error: creat small failed!\n");
     608:	52                   	push   %edx
     609:	52                   	push   %edx
     60a:	68 f8 3a 00 00       	push   $0x3af8
     60f:	50                   	push   %eax
     610:	e8 9b 30 00 00       	call   36b0 <printf>
    exit();
...
0000061c <writetest1>:
{
  ...
  printf(stdout, "big files test\n");
     ...
     624:	68 a5 3b 00 00       	push   $0x3ba5
     629:	ff 35 b0 51 00 00    	push   0x51b0
     62f:	e8 7c 30 00 00       	call   36b0 <printf>
  fd = open("big", O_CREATE|O_RDWR);
     634:	58                   	pop    %eax
     635:	5a                   	pop    %edx
     636:	68 02 02 00 00       	push   $0x202
     63b:	68 1f 3c 00 00       	push   $0x3c1f
  ...
  fd = open("big", O_RDONLY);
     ...
     68c:	5a                   	pop    %edx
     68d:	6a 00                	push   $0x0
     68f:	68 1f 3c 00 00       	push   $0x3c1f
  ...
  if(unlink("big") < 0){
     6ee:	c7 04 24 1f 3c 00 00 	movl   $0x3c1f,(%esp)
     6f5:	e8 d1 2e 00 00       	call   35cb <unlink>
     6fa:	89 c2                	mov    %eax,%edx
    printf(stdout, "unlink big failed\n");
     6fc:	a1 b0 51 00 00       	mov    0x51b0,%eax
  if(unlink("big") < 0){
  ...
  printf(stdout, "big files ok\n");
     ...
     70f:	68 46 3c 00 00       	push   $0x3c46
     714:	50                   	push   %eax
     715:	e8 96 2f 00 00       	call   36b0 <printf>
}
     ...
     724:	51                   	push   %ecx
     725:	53                   	push   %ebx
     726:	68 cf 3b 00 00       	push   $0x3bcf
     72b:	ff 35 b0 51 00 00    	push   0x51b0
     731:	e8 7a 2f 00 00       	call   36b0 <printf>
      exit();
     736:	e8 40 2e 00 00       	call   357b <exit>
      printf(stdout, "read content of block %d is %d\n",
     73b:	50                   	push   %eax
     73c:	53                   	push   %ebx
     73d:	68 24 4a 00 00       	push   $0x4a24
     742:	ff 35 b0 51 00 00    	push   0x51b0
     748:	e8 63 2f 00 00       	call   36b0 <printf>
      exit();
     74d:	e8 29 2e 00 00       	call   357b <exit>
      printf(stdout, "read failed %d\n", i);
     752:	51                   	push   %ecx
     753:	50                   	push   %eax
     754:	68 23 3c 00 00       	push   $0x3c23
     759:	ff 35 b0 51 00 00    	push   0x51b0
     75f:	e8 4c 2f 00 00       	call   36b0 <printf>
      exit();
     764:	e8 12 2e 00 00       	call   357b <exit>
        printf(stdout, "read only %d blocks from big", n);
     769:	53                   	push   %ebx
     76a:	68 8b 00 00 00       	push   $0x8b
     76f:	68 06 3c 00 00       	push   $0x3c06
     774:	ff 35 b0 51 00 00    	push   0x51b0
     77a:	e8 31 2f 00 00       	call   36b0 <printf>
        exit();
     77f:	e8 f7 2d 00 00       	call   357b <exit>
    printf(stdout, "error: open big failed!\n");
     784:	50                   	push   %eax
     785:	50                   	push   %eax
     786:	68 ed 3b 00 00       	push   $0x3bed
     78b:	ff 35 b0 51 00 00    	push   0x51b0
     791:	e8 1a 2f 00 00       	call   36b0 <printf>
    exit();
     796:	e8 e0 2d 00 00       	call   357b <exit>
    printf(stdout, "error: creat big failed!\n");
     79b:	50                   	push   %eax
     79c:	50                   	push   %eax
     79d:	68 b5 3b 00 00       	push   $0x3bb5
     7a2:	ff 35 b0 51 00 00    	push   0x51b0
     7a8:	e8 03 2f 00 00       	call   36b0 <printf>
    exit();
     7ad:	e8 c9 2d 00 00       	call   357b <exit>
    printf(stdout, "unlink big failed\n");
     7b2:	52                   	push   %edx
     7b3:	52                   	push   %edx
     7b4:	68 33 3c 00 00       	push   $0x3c33
     7b9:	50                   	push   %eax
     7ba:	e8 f1 2e 00 00       	call   36b0 <printf>
    exit();
...
000007c4 <createtest>:
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     7cb:	68 44 4a 00 00       	push   $0x4a44
     7d0:	ff 35 b0 51 00 00    	push   0x51b0
     7d6:	e8 d5 2e 00 00       	call   36b0 <printf>
  name[0] = 'a';
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     84b:	68 70 4a 00 00       	push   $0x4a70
     850:	ff 35 b0 51 00 00    	push   0x51b0
     856:	e8 55 2e 00 00       	call   36b0 <printf>
}
...
00000864 <dirtest>:
{
  ...
  printf(stdout, "mkdir test\n");
     86a:	68 54 3c 00 00       	push   $0x3c54
     86f:	ff 35 b0 51 00 00    	push   0x51b0
     875:	e8 36 2e 00 00       	call   36b0 <printf>
  if(mkdir("dir0") < 0){
     87a:	c7 04 24 60 3c 00 00 	movl   $0x3c60,(%esp)
  ...
  if(chdir("dir0") < 0){
     ...
     890:	68 60 3c 00 00       	push   $0x3c60
  ...
  if(chdir("..") < 0){
     ...
     8a8:	68 05 42 00 00       	push   $0x4205
  ...
  if(unlink("dir0") < 0){
     ...
     8bc:	68 60 3c 00 00       	push   $0x3c60
     8c1:	e8 05 2d 00 00       	call   35cb <unlink>
     8c6:	89 c2                	mov    %eax,%edx
    printf(stdout, "unlink dir0 failed\n");
     8c8:	a1 b0 51 00 00       	mov    0x51b0,%eax
  if(unlink("dir0") < 0){
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     8d7:	68 9d 3c 00 00       	push   $0x3c9d
     8dc:	50                   	push   %eax
     8dd:	e8 ce 2d 00 00       	call   36b0 <printf>
}
    ...
    printf(stdout, "mkdir failed\n");
     8e7:	50                   	push   %eax
     8e8:	50                   	push   %eax
     8e9:	68 90 39 00 00       	push   $0x3990
     8ee:	ff 35 b0 51 00 00    	push   0x51b0
     8f4:	e8 b7 2d 00 00       	call   36b0 <printf>
    exit();
     8f9:	e8 7d 2c 00 00       	call   357b <exit>
    printf(stdout, "unlink dir0 failed\n");
     8fe:	52                   	push   %edx
     8ff:	52                   	push   %edx
     900:	68 89 3c 00 00       	push   $0x3c89
     905:	50                   	push   %eax
     906:	e8 a5 2d 00 00       	call   36b0 <printf>
    exit();
     90b:	e8 6b 2c 00 00       	call   357b <exit>
    printf(stdout, "chdir .. failed\n");
     910:	51                   	push   %ecx
     911:	51                   	push   %ecx
     912:	68 78 3c 00 00       	push   $0x3c78
     917:	ff 35 b0 51 00 00    	push   0x51b0
     91d:	e8 8e 2d 00 00       	call   36b0 <printf>
    exit();
     922:	e8 54 2c 00 00       	call   357b <exit>
    printf(stdout, "chdir dir0 failed\n");
     927:	50                   	push   %eax
     928:	50                   	push   %eax
     929:	68 65 3c 00 00       	push   $0x3c65
     92e:	ff 35 b0 51 00 00    	push   0x51b0
     934:	e8 77 2d 00 00       	call   36b0 <printf>
    exit();
...
00000940 <exectest>:
{
  ...
  printf(stdout, "exec test\n");
     946:	68 ac 3c 00 00       	push   $0x3cac
     94b:	ff 35 b0 51 00 00    	push   0x51b0
     951:	e8 5a 2d 00 00       	call   36b0 <printf>
  if(exec("echo", echoargv) < 0){
     956:	5a                   	pop    %edx
     957:	59                   	pop    %ecx
     958:	68 b4 51 00 00       	push   $0x51b4
     95d:	68 75 3a 00 00       	push   $0x3a75
    ...
    printf(stdout, "exec echo failed\n");
     970:	50                   	push   %eax
     971:	50                   	push   %eax
     972:	68 b7 3c 00 00       	push   $0x3cb7
     977:	ff 35 b0 51 00 00    	push   0x51b0
     97d:	e8 2e 2d 00 00       	call   36b0 <printf>
    exit();
...
00000988 <pipe1>:
{
  ...
  seq = 0;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a1b:	68 e6 3c 00 00       	push   $0x3ce6
     a20:	6a 01                	push   $0x1
     a22:	e8 89 2c 00 00       	call   36b0 <printf>
  ...
  printf(1, "pipe1 ok\n");
     a9e:	5a                   	pop    %edx
     a9f:	59                   	pop    %ecx
     aa0:	68 0b 3d 00 00       	push   $0x3d0b
     aa5:	6a 01                	push   $0x1
     aa7:	e8 04 2c 00 00       	call   36b0 <printf>
     aac:	83 c4 10             	add    $0x10,%esp
     aaf:	e9 76 ff ff ff       	jmp    a2a <pipe1+0xa2>
      printf(1, "pipe1 oops 3 total %d\n", total);
     ab4:	53                   	push   %ebx
     ab5:	ff 75 d4             	push   -0x2c(%ebp)
     ab8:	68 f4 3c 00 00       	push   $0x3cf4
     abd:	6a 01                	push   $0x1
     abf:	e8 ec 2b 00 00       	call   36b0 <printf>
      exit();
     ac4:	e8 b2 2a 00 00       	call   357b <exit>
    printf(1, "pipe() failed\n");
     ac9:	50                   	push   %eax
     aca:	50                   	push   %eax
     acb:	68 c9 3c 00 00       	push   $0x3cc9
     ad0:	6a 01                	push   $0x1
     ad2:	e8 d9 2b 00 00       	call   36b0 <printf>
    exit();
     ad7:	e8 9f 2a 00 00       	call   357b <exit>
    printf(1, "fork() failed\n");
     adc:	50                   	push   %eax
     add:	50                   	push   %eax
     ade:	68 15 3d 00 00       	push   $0x3d15
     ae3:	6a 01                	push   $0x1
     ae5:	e8 c6 2b 00 00       	call   36b0 <printf>
    exit();
     aea:	e8 8c 2a 00 00       	call   357b <exit>
        printf(1, "pipe1 oops 1\n");
     aef:	50                   	push   %eax
     af0:	50                   	push   %eax
     af1:	68 d8 3c 00 00       	push   $0x3cd8
     af6:	6a 01                	push   $0x1
     af8:	e8 b3 2b 00 00       	call   36b0 <printf>
        exit();
...
00000b04 <preempt>:
{
  ...
  printf(1, "preempt: ");
     b0d:	68 24 3d 00 00       	push   $0x3d24
     b12:	6a 01                	push   $0x1
     b14:	e8 97 2b 00 00       	call   36b0 <printf>
  pid1 = fork();
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     b60:	6a 01                	push   $0x1
     b62:	68 e9 42 00 00       	push   $0x42e9
  ...
  printf(1, "kill... ");
     bbd:	58                   	pop    %eax
     bbe:	5a                   	pop    %edx
     bbf:	68 55 3d 00 00       	push   $0x3d55
     bc4:	6a 01                	push   $0x1
     bc6:	e8 e5 2a 00 00       	call   36b0 <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
     be3:	59                   	pop    %ecx
     be4:	5b                   	pop    %ebx
     be5:	68 5e 3d 00 00       	push   $0x3d5e
     bea:	6a 01                	push   $0x1
     bec:	e8 bf 2a 00 00       	call   36b0 <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
     c00:	5e                   	pop    %esi
     c01:	5f                   	pop    %edi
     c02:	68 67 3d 00 00       	push   $0x3d67
     c07:	6a 01                	push   $0x1
     c09:	e8 a2 2a 00 00       	call   36b0 <printf>
    ...
    printf(1, "preempt read error");
     ...
     c1c:	68 42 3d 00 00       	push   $0x3d42
     c21:	6a 01                	push   $0x1
     c23:	e8 88 2a 00 00       	call   36b0 <printf>
     c28:	83 c4 10             	add    $0x10,%esp
     c2b:	eb e4                	jmp    c11 <preempt+0x10d>
      printf(1, "preempt write error");
     c2d:	83 ec 08             	sub    $0x8,%esp
     c30:	68 2e 3d 00 00       	push   $0x3d2e
     c35:	6a 01                	push   $0x1
     c37:	e8 74 2a 00 00       	call   36b0 <printf>
...
00000c44 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     c6c:	68 d1 48 00 00       	push   $0x48d1
     c71:	6a 01                	push   $0x1
     c73:	e8 38 2a 00 00       	call   36b0 <printf>
      return;
     ...
     c87:	68 73 3d 00 00       	push   $0x3d73
     c8c:	6a 01                	push   $0x1
     c8e:	e8 1d 2a 00 00       	call   36b0 <printf>
        return;
  ...
  printf(1, "exitwait ok\n");
     ...
     ca0:	68 83 3d 00 00       	push   $0x3d83
     ca5:	6a 01                	push   $0x1
     ca7:	e8 04 2a 00 00       	call   36b0 <printf>
...
00000cbc <mem>:
{
  ...
  printf(1, "mem test\n");
     ...
     cc4:	68 90 3d 00 00       	push   $0x3d90
     cc9:	6a 01                	push   $0x1
     ccb:	e8 e0 29 00 00       	call   36b0 <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     cf8:	e8 af 2b 00 00       	call   38ac <malloc>
    ...
    while(m1){
     ...
     d0f:	50                   	push   %eax
     d10:	e8 0f 2b 00 00       	call   3824 <free>
    while(m1){
    ...
    m1 = malloc(1024*20);
     ...
     d24:	e8 83 2b 00 00       	call   38ac <malloc>
    if(m1 == 0){
    ...
    free(m1);
     ...
     d33:	50                   	push   %eax
     d34:	e8 eb 2a 00 00       	call   3824 <free>
    printf(1, "mem ok\n");
     d39:	58                   	pop    %eax
     d3a:	5a                   	pop    %edx
     d3b:	68 b4 3d 00 00       	push   $0x3db4
     d40:	6a 01                	push   $0x1
     d42:	e8 69 29 00 00       	call   36b0 <printf>
    exit();
     d47:	e8 2f 28 00 00       	call   357b <exit>
      printf(1, "couldn't allocate mem?!!\n");
     d4c:	83 ec 08             	sub    $0x8,%esp
     d4f:	68 9a 3d 00 00       	push   $0x3d9a
     d54:	6a 01                	push   $0x1
     d56:	e8 55 29 00 00       	call   36b0 <printf>
      kill(ppid);
...
00000d74 <sharedfd>:
{
  ...
  printf(1, "sharedfd test\n");
     d7d:	68 bc 3d 00 00       	push   $0x3dbc
     d82:	6a 01                	push   $0x1
     d84:	e8 27 29 00 00       	call   36b0 <printf>
  unlink("sharedfd");
     d89:	c7 04 24 cb 3d 00 00 	movl   $0x3dcb,(%esp)
     d90:	e8 36 28 00 00       	call   35cb <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     d95:	59                   	pop    %ecx
     d96:	5b                   	pop    %ebx
     d97:	68 02 02 00 00       	push   $0x202
     d9c:	68 cb 3d 00 00       	push   $0x3dcb
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     df8:	68 c4 4a 00 00       	push   $0x4ac4
     dfd:	6a 01                	push   $0x1
     dff:	e8 ac 28 00 00       	call   36b0 <printf>
      break;
  ...
  fd = open("sharedfd", 0);
     ...
     e21:	59                   	pop    %ecx
     e22:	6a 00                	push   $0x0
     e24:	68 cb 3d 00 00       	push   $0x3dcb
  ...
  unlink("sharedfd");
     e8f:	c7 04 24 cb 3d 00 00 	movl   $0x3dcb,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     ...
     eb4:	68 d4 3d 00 00       	push   $0x3dd4
     eb9:	6a 01                	push   $0x1
     ebb:	e8 f0 27 00 00       	call   36b0 <printf>
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     ...
     ece:	68 98 4a 00 00       	push   $0x4a98
     ed3:	6a 01                	push   $0x1
     ed5:	e8 d6 27 00 00       	call   36b0 <printf>
    return;
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     ...
     ee8:	68 e4 4a 00 00       	push   $0x4ae4
     eed:	6a 01                	push   $0x1
     eef:	e8 bc 27 00 00       	call   36b0 <printf>
    return;
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     f04:	52                   	push   %edx
     f05:	57                   	push   %edi
     f06:	68 e1 3d 00 00       	push   $0x3de1
     f0b:	6a 01                	push   $0x1
     f0d:	e8 9e 27 00 00       	call   36b0 <printf>
    exit();
...
00000f18 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
     f21:	be 30 51 00 00       	mov    $0x5130,%esi
     f26:	b9 04 00 00 00       	mov    $0x4,%ecx
     f2b:	8d 7d d8             	lea    -0x28(%ebp),%edi
     f2e:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  printf(1, "fourfiles test\n");
     f30:	68 f6 3d 00 00       	push   $0x3df6
     f35:	6a 01                	push   $0x1
     f37:	e8 74 27 00 00       	call   36b0 <printf>
  ...
  printf(1, "fourfiles ok\n");
    ...
    1011:	68 34 3e 00 00       	push   $0x3e34
    1016:	6a 01                	push   $0x1
    1018:	e8 93 26 00 00       	call   36b0 <printf>
}
    ...
    102b:	68 17 3e 00 00       	push   $0x3e17
    1030:	6a 01                	push   $0x1
    1032:	e8 79 26 00 00       	call   36b0 <printf>
          exit();
    ...
    1092:	50                   	push   %eax
    1093:	50                   	push   %eax
    1094:	68 97 40 00 00       	push   $0x4097
    1099:	6a 01                	push   $0x1
    109b:	e8 10 26 00 00       	call   36b0 <printf>
        exit();
    10a0:	e8 d6 24 00 00       	call   357b <exit>
    10a5:	8d 76 00             	lea    0x0(%esi),%esi
      printf(1, "fork failed\n");
    10a8:	83 ec 08             	sub    $0x8,%esp
    10ab:	68 d1 48 00 00       	push   $0x48d1
    10b0:	6a 01                	push   $0x1
    10b2:	e8 f9 25 00 00       	call   36b0 <printf>
      exit();
    10b7:	e8 bf 24 00 00       	call   357b <exit>
      printf(1, "wrong length %d\n", total);
    10bc:	50                   	push   %eax
    10bd:	53                   	push   %ebx
    10be:	68 23 3e 00 00       	push   $0x3e23
    10c3:	6a 01                	push   $0x1
    10c5:	e8 e6 25 00 00       	call   36b0 <printf>
      exit();
    10ca:	e8 ac 24 00 00       	call   357b <exit>
          printf(1, "write failed %d\n", n);
    10cf:	51                   	push   %ecx
    10d0:	50                   	push   %eax
    10d1:	68 06 3e 00 00       	push   $0x3e06
    10d6:	6a 01                	push   $0x1
    10d8:	e8 d3 25 00 00       	call   36b0 <printf>
          exit();
...
000010e4 <createdelete>:
{
  ...
  printf(1, "createdelete test\n");
    10ed:	68 48 3e 00 00       	push   $0x3e48
    10f2:	6a 01                	push   $0x1
    10f4:	e8 b7 25 00 00       	call   36b0 <printf>
  ...
  printf(1, "createdelete ok\n");
    ...
    11b0:	68 5b 3e 00 00       	push   $0x3e5b
    11b5:	6a 01                	push   $0x1
    11b7:	e8 f4 24 00 00       	call   36b0 <printf>
}
    ...
    11c8:	50                   	push   %eax
    11c9:	57                   	push   %edi
    11ca:	68 34 4b 00 00       	push   $0x4b34
    11cf:	6a 01                	push   $0x1
    11d1:	e8 da 24 00 00       	call   36b0 <printf>
        exit();
    ...
    124c:	52                   	push   %edx
    124d:	57                   	push   %edi
    124e:	68 10 4b 00 00       	push   $0x4b10
    1253:	6a 01                	push   $0x1
    1255:	e8 56 24 00 00       	call   36b0 <printf>
        exit();
    125a:	e8 1c 23 00 00       	call   357b <exit>
      printf(1, "fork failed\n");
    125f:	83 ec 08             	sub    $0x8,%esp
    1262:	68 d1 48 00 00       	push   $0x48d1
    1267:	6a 01                	push   $0x1
    1269:	e8 42 24 00 00       	call   36b0 <printf>
      exit();
    126e:	e8 08 23 00 00       	call   357b <exit>
            printf(1, "unlink failed\n");
    1273:	51                   	push   %ecx
    1274:	51                   	push   %ecx
    1275:	68 49 3a 00 00       	push   $0x3a49
    127a:	6a 01                	push   $0x1
    127c:	e8 2f 24 00 00       	call   36b0 <printf>
            exit();
    1281:	e8 f5 22 00 00       	call   357b <exit>
          printf(1, "create failed\n");
    1286:	83 ec 08             	sub    $0x8,%esp
    1289:	68 97 40 00 00       	push   $0x4097
    128e:	6a 01                	push   $0x1
    1290:	e8 1b 24 00 00       	call   36b0 <printf>
          exit();
...
0000129c <unlinkread>:
{
  ...
  printf(1, "unlinkread test\n");
    ...
    12a4:	68 6c 3e 00 00       	push   $0x3e6c
    12a9:	6a 01                	push   $0x1
    12ab:	e8 00 24 00 00       	call   36b0 <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    12b0:	5e                   	pop    %esi
    12b1:	58                   	pop    %eax
    12b2:	68 02 02 00 00       	push   $0x202
    12b7:	68 7d 3e 00 00       	push   $0x3e7d
  ...
  write(fd, "hello", 5);
    12ce:	50                   	push   %eax
    12cf:	6a 05                	push   $0x5
    12d1:	68 a2 3e 00 00       	push   $0x3ea2
    12d6:	53                   	push   %ebx
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    12e5:	59                   	pop    %ecx
    12e6:	6a 02                	push   $0x2
    12e8:	68 7d 3e 00 00       	push   $0x3e7d
  ...
  if(unlink("unlinkread") != 0){
    ...
    1302:	68 7d 3e 00 00       	push   $0x3e7d
  ...
  unlink("unlinkread");
    138a:	c7 04 24 7d 3e 00 00 	movl   $0x3e7d,(%esp)
    1391:	e8 35 22 00 00       	call   35cb <unlink>
  printf(1, "unlinkread ok\n");
    1396:	58                   	pop    %eax
    1397:	5a                   	pop    %edx
    1398:	68 25 3f 00 00       	push   $0x3f25
    139d:	6a 01                	push   $0x1
    139f:	e8 0c 23 00 00       	call   36b0 <printf>
}
    ...
    13ae:	53                   	push   %ebx
    13af:	53                   	push   %ebx
    13b0:	68 88 3e 00 00       	push   $0x3e88
    13b5:	6a 01                	push   $0x1
    13b7:	e8 f4 22 00 00       	call   36b0 <printf>
    exit();
    13bc:	e8 ba 21 00 00       	call   357b <exit>
    printf(1, "unlinkread write failed\n");
    13c1:	51                   	push   %ecx
    13c2:	51                   	push   %ecx
    13c3:	68 0c 3f 00 00       	push   $0x3f0c
    13c8:	6a 01                	push   $0x1
    13ca:	e8 e1 22 00 00       	call   36b0 <printf>
    exit();
    13cf:	e8 a7 21 00 00       	call   357b <exit>
    printf(1, "unlinkread wrong data\n");
    13d4:	50                   	push   %eax
    13d5:	50                   	push   %eax
    13d6:	68 f5 3e 00 00       	push   $0x3ef5
    13db:	6a 01                	push   $0x1
    13dd:	e8 ce 22 00 00       	call   36b0 <printf>
    exit();
    13e2:	e8 94 21 00 00       	call   357b <exit>
    printf(1, "unlinkread read failed");
    13e7:	50                   	push   %eax
    13e8:	50                   	push   %eax
    13e9:	68 de 3e 00 00       	push   $0x3ede
    13ee:	6a 01                	push   $0x1
    13f0:	e8 bb 22 00 00       	call   36b0 <printf>
    exit();
    13f5:	e8 81 21 00 00       	call   357b <exit>
    printf(1, "unlink unlinkread failed\n");
    13fa:	50                   	push   %eax
    13fb:	50                   	push   %eax
    13fc:	68 c0 3e 00 00       	push   $0x3ec0
    1401:	6a 01                	push   $0x1
    1403:	e8 a8 22 00 00       	call   36b0 <printf>
    exit();
    1408:	e8 6e 21 00 00       	call   357b <exit>
    printf(1, "open unlinkread failed\n");
    140d:	50                   	push   %eax
    140e:	50                   	push   %eax
    140f:	68 a8 3e 00 00       	push   $0x3ea8
    1414:	6a 01                	push   $0x1
    1416:	e8 95 22 00 00       	call   36b0 <printf>
    exit();
...
00001420 <linktest>:
{
  ...
  printf(1, "linktest\n");
    1427:	68 34 3f 00 00       	push   $0x3f34
    142c:	6a 01                	push   $0x1
    142e:	e8 7d 22 00 00       	call   36b0 <printf>
  unlink("lf1");
    1433:	c7 04 24 3e 3f 00 00 	movl   $0x3f3e,(%esp)
    143a:	e8 8c 21 00 00       	call   35cb <unlink>
  unlink("lf2");
    143f:	c7 04 24 42 3f 00 00 	movl   $0x3f42,(%esp)
    1446:	e8 80 21 00 00       	call   35cb <unlink>
  fd = open("lf1", O_CREATE|O_RDWR);
    144b:	58                   	pop    %eax
    144c:	5a                   	pop    %edx
    144d:	68 02 02 00 00       	push   $0x202
    1452:	68 3e 3f 00 00       	push   $0x3f3e
  ...
  if(write(fd, "hello", 5) != 5){
    1469:	50                   	push   %eax
    146a:	6a 05                	push   $0x5
    146c:	68 a2 3e 00 00       	push   $0x3ea2
    1471:	53                   	push   %ebx
  ...
  if(link("lf1", "lf2") < 0){
    148c:	5b                   	pop    %ebx
    148d:	58                   	pop    %eax
    148e:	68 42 3f 00 00       	push   $0x3f42
    1493:	68 3e 3f 00 00       	push   $0x3f3e
  ...
  unlink("lf1");
    ...
    14ab:	68 3e 3f 00 00       	push   $0x3f3e
    14b0:	e8 16 21 00 00       	call   35cb <unlink>
  if(open("lf1", 0) >= 0){
    14b5:	58                   	pop    %eax
    14b6:	5a                   	pop    %edx
    14b7:	6a 00                	push   $0x0
    14b9:	68 3e 3f 00 00       	push   $0x3f3e
  ...
  fd = open("lf2", 0);
    ...
    14d1:	6a 00                	push   $0x0
    14d3:	68 42 3f 00 00       	push   $0x3f42
  ...
  if(link("lf2", "lf2") >= 0){
    1510:	58                   	pop    %eax
    1511:	5a                   	pop    %edx
    1512:	68 42 3f 00 00       	push   $0x3f42
    1517:	68 42 3f 00 00       	push   $0x3f42
  ...
  unlink("lf2");
    ...
    152f:	68 42 3f 00 00       	push   $0x3f42
    1534:	e8 92 20 00 00       	call   35cb <unlink>
  if(link("lf2", "lf1") >= 0){
    1539:	59                   	pop    %ecx
    153a:	5b                   	pop    %ebx
    153b:	68 3e 3f 00 00       	push   $0x3f3e
    1540:	68 42 3f 00 00       	push   $0x3f42
  ...
  if(link(".", "lf1") >= 0){
    ...
    1554:	68 3e 3f 00 00       	push   $0x3f3e
    1559:	68 06 42 00 00       	push   $0x4206
  ...
  printf(1, "linktest ok\n");
    ...
    156d:	68 dc 3f 00 00       	push   $0x3fdc
    1572:	6a 01                	push   $0x1
    1574:	e8 37 21 00 00       	call   36b0 <printf>
}
    ...
    1581:	50                   	push   %eax
    1582:	50                   	push   %eax
    1583:	68 46 3f 00 00       	push   $0x3f46
    1588:	6a 01                	push   $0x1
    158a:	e8 21 21 00 00       	call   36b0 <printf>
    exit();
    158f:	e8 e7 1f 00 00       	call   357b <exit>
    printf(1, "link . lf1 succeeded! oops\n");
    1594:	50                   	push   %eax
    1595:	50                   	push   %eax
    1596:	68 c0 3f 00 00       	push   $0x3fc0
    159b:	6a 01                	push   $0x1
    159d:	e8 0e 21 00 00       	call   36b0 <printf>
    exit();
    15a2:	e8 d4 1f 00 00       	call   357b <exit>
    printf(1, "link non-existant succeeded! oops\n");
    15a7:	52                   	push   %edx
    15a8:	52                   	push   %edx
    15a9:	68 7c 4b 00 00       	push   $0x4b7c
    15ae:	6a 01                	push   $0x1
    15b0:	e8 fb 20 00 00       	call   36b0 <printf>
    exit();
    15b5:	e8 c1 1f 00 00       	call   357b <exit>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    15ba:	50                   	push   %eax
    15bb:	50                   	push   %eax
    15bc:	68 a2 3f 00 00       	push   $0x3fa2
    15c1:	6a 01                	push   $0x1
    15c3:	e8 e8 20 00 00       	call   36b0 <printf>
    exit();
    15c8:	e8 ae 1f 00 00       	call   357b <exit>
    printf(1, "read lf2 failed\n");
    15cd:	51                   	push   %ecx
    15ce:	51                   	push   %ecx
    15cf:	68 91 3f 00 00       	push   $0x3f91
    15d4:	6a 01                	push   $0x1
    15d6:	e8 d5 20 00 00       	call   36b0 <printf>
    exit();
    15db:	e8 9b 1f 00 00       	call   357b <exit>
    printf(1, "open lf2 failed\n");
    15e0:	50                   	push   %eax
    15e1:	50                   	push   %eax
    15e2:	68 80 3f 00 00       	push   $0x3f80
    15e7:	6a 01                	push   $0x1
    15e9:	e8 c2 20 00 00       	call   36b0 <printf>
    exit();
    15ee:	e8 88 1f 00 00       	call   357b <exit>
    printf(1, "unlinked lf1 but it is still there!\n");
    15f3:	50                   	push   %eax
    15f4:	50                   	push   %eax
    15f5:	68 54 4b 00 00       	push   $0x4b54
    15fa:	6a 01                	push   $0x1
    15fc:	e8 af 20 00 00       	call   36b0 <printf>
    exit();
    1601:	e8 75 1f 00 00       	call   357b <exit>
    printf(1, "link lf1 lf2 failed\n");
    1606:	51                   	push   %ecx
    1607:	51                   	push   %ecx
    1608:	68 6b 3f 00 00       	push   $0x3f6b
    160d:	6a 01                	push   $0x1
    160f:	e8 9c 20 00 00       	call   36b0 <printf>
    exit();
    1614:	e8 62 1f 00 00       	call   357b <exit>
    printf(1, "write lf1 failed\n");
    1619:	50                   	push   %eax
    161a:	50                   	push   %eax
    161b:	68 59 3f 00 00       	push   $0x3f59
    1620:	6a 01                	push   $0x1
    1622:	e8 89 20 00 00       	call   36b0 <printf>
    exit();
...
0000162c <concreate>:
{
  ...
  printf(1, "concreate test\n");
    1635:	68 e9 3f 00 00       	push   $0x3fe9
    163a:	6a 01                	push   $0x1
    163c:	e8 6f 20 00 00       	call   36b0 <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    16d5:	51                   	push   %ecx
    16d6:	53                   	push   %ebx
    16d7:	68 fc 3f 00 00       	push   $0x3ffc
    16dc:	6a 01                	push   $0x1
    16de:	e8 cd 1f 00 00       	call   36b0 <printf>
        exit();
    16e3:	e8 93 1e 00 00       	call   357b <exit>
      link("C0", file);
    16e8:	83 ec 08             	sub    $0x8,%esp
    16eb:	53                   	push   %ebx
    16ec:	68 f9 3f 00 00       	push   $0x3ff9
  ...
  fd = open(".", 0);
    ...
    1713:	5a                   	pop    %edx
    1714:	6a 00                	push   $0x0
    1716:	68 06 42 00 00       	push   $0x4206
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    177f:	53                   	push   %ebx
    1780:	68 f9 3f 00 00       	push   $0x3ff9
  ...
  printf(1, "concreate ok\n");
    ...
    186b:	68 4e 40 00 00       	push   $0x404e
    1870:	6a 01                	push   $0x1
    1872:	e8 39 1e 00 00       	call   36b0 <printf>
}
    ...
    1882:	68 d1 48 00 00       	push   $0x48d1
    1887:	6a 01                	push   $0x1
    1889:	e8 22 1e 00 00       	call   36b0 <printf>
      exit();
    ...
    18a8:	50                   	push   %eax
    18a9:	68 18 40 00 00       	push   $0x4018
    18ae:	6a 01                	push   $0x1
    18b0:	e8 fb 1d 00 00       	call   36b0 <printf>
        exit();
    18b5:	e8 c1 1c 00 00       	call   357b <exit>
    printf(1, "concreate not enough files in directory listing\n");
    18ba:	51                   	push   %ecx
    18bb:	51                   	push   %ecx
    18bc:	68 a0 4b 00 00       	push   $0x4ba0
    18c1:	6a 01                	push   $0x1
    18c3:	e8 e8 1d 00 00       	call   36b0 <printf>
    exit();
    ...
    18d1:	50                   	push   %eax
    18d2:	68 31 40 00 00       	push   $0x4031
    18d7:	6a 01                	push   $0x1
    18d9:	e8 d2 1d 00 00       	call   36b0 <printf>
        exit();
...
000018e4 <linkunlink>:
{
  ...
  printf(1, "linkunlink test\n");
    18ed:	68 5c 40 00 00       	push   $0x405c
    18f2:	6a 01                	push   $0x1
    18f4:	e8 b7 1d 00 00       	call   36b0 <printf>
  unlink("x");
    18f9:	c7 04 24 e9 42 00 00 	movl   $0x42e9,(%esp)
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    193a:	68 e9 42 00 00       	push   $0x42e9
  ...
  for(i = 0; i < 100; i++){
    ...
    1984:	68 e9 42 00 00       	push   $0x42e9
  ...
  printf(1, "linkunlink ok\n");
    ...
    19ab:	68 71 40 00 00       	push   $0x4071
    19b0:	6a 01                	push   $0x1
    19b2:	e8 f9 1c 00 00       	call   36b0 <printf>
}
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    19cf:	68 e9 42 00 00       	push   $0x42e9
    19d4:	68 6d 40 00 00       	push   $0x406d
    ...
    19eb:	52                   	push   %edx
    19ec:	52                   	push   %edx
    19ed:	68 d1 48 00 00       	push   $0x48d1
    19f2:	6a 01                	push   $0x1
    19f4:	e8 b7 1c 00 00       	call   36b0 <printf>
    exit();
...
00001a00 <bigdir>:
{
  ...
  printf(1, "bigdir test\n");
    1a09:	68 80 40 00 00       	push   $0x4080
    1a0e:	6a 01                	push   $0x1
    1a10:	e8 9b 1c 00 00       	call   36b0 <printf>
  unlink("bd");
    1a15:	c7 04 24 8d 40 00 00 	movl   $0x408d,(%esp)
    1a1c:	e8 aa 1b 00 00       	call   35cb <unlink>
  fd = open("bd", O_CREATE);
    1a21:	5a                   	pop    %edx
    1a22:	59                   	pop    %ecx
    1a23:	68 00 02 00 00       	push   $0x200
    1a28:	68 8d 40 00 00       	push   $0x408d
  ...
  for(i = 0; i < 500; i++){
    ...
    1a71:	57                   	push   %edi
    1a72:	68 8d 40 00 00       	push   $0x408d
  ...
  unlink("bd");
    ...
    1a91:	68 8d 40 00 00       	push   $0x408d
  ...
  printf(1, "bigdir ok\n");
    ...
    1ada:	68 cf 40 00 00       	push   $0x40cf
    1adf:	6a 01                	push   $0x1
    1ae1:	e8 ca 1b 00 00       	call   36b0 <printf>
    ...
    1af4:	68 a6 40 00 00       	push   $0x40a6
    1af9:	6a 01                	push   $0x1
    1afb:	e8 b0 1b 00 00       	call   36b0 <printf>
      exit();
    1b00:	e8 76 1a 00 00       	call   357b <exit>
      printf(1, "bigdir unlink failed");
    1b05:	83 ec 08             	sub    $0x8,%esp
    1b08:	68 ba 40 00 00       	push   $0x40ba
    1b0d:	6a 01                	push   $0x1
    1b0f:	e8 9c 1b 00 00       	call   36b0 <printf>
      exit();
    1b14:	e8 62 1a 00 00       	call   357b <exit>
    printf(1, "bigdir create failed\n");
    1b19:	50                   	push   %eax
    1b1a:	50                   	push   %eax
    1b1b:	68 90 40 00 00       	push   $0x4090
    1b20:	6a 01                	push   $0x1
    1b22:	e8 89 1b 00 00       	call   36b0 <printf>
    exit();
...
00001b2c <subdir>:
{
  ...
  printf(1, "subdir test\n");
    1b33:	68 da 40 00 00       	push   $0x40da
    1b38:	6a 01                	push   $0x1
    1b3a:	e8 71 1b 00 00       	call   36b0 <printf>
  unlink("ff");
    1b3f:	c7 04 24 63 41 00 00 	movl   $0x4163,(%esp)
    1b46:	e8 80 1a 00 00       	call   35cb <unlink>
  if(mkdir("dd") != 0){
    1b4b:	c7 04 24 00 42 00 00 	movl   $0x4200,(%esp)
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1b6a:	68 39 41 00 00       	push   $0x4139
  ...
  write(fd, "ff", 2);
    1b81:	50                   	push   %eax
    1b82:	6a 02                	push   $0x2
    1b84:	68 63 41 00 00       	push   $0x4163
    1b89:	53                   	push   %ebx
  ...
  if(unlink("dd") >= 0){
    1b97:	c7 04 24 00 42 00 00 	movl   $0x4200,(%esp)
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1bb1:	68 14 41 00 00       	push   $0x4114
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1bce:	68 36 41 00 00       	push   $0x4136
  ...
  write(fd, "FF", 2);
    1be5:	50                   	push   %eax
    1be6:	6a 02                	push   $0x2
    1be8:	68 57 41 00 00       	push   $0x4157
    1bed:	53                   	push   %ebx
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    1bfc:	5a                   	pop    %edx
    1bfd:	6a 00                	push   $0x0
    1bff:	68 5a 41 00 00       	push   $0x415a
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1c49:	58                   	pop    %eax
    1c4a:	5a                   	pop    %edx
    1c4b:	68 9a 41 00 00       	push   $0x419a
    1c50:	68 36 41 00 00       	push   $0x4136
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1c68:	68 36 41 00 00       	push   $0x4136
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1c80:	6a 00                	push   $0x0
    1c82:	68 36 41 00 00       	push   $0x4136
  ...
  if(chdir("dd") != 0){
    ...
    1c9a:	68 00 42 00 00       	push   $0x4200
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    1cb2:	68 ce 41 00 00       	push   $0x41ce
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    1cca:	68 f4 41 00 00       	push   $0x41f4
  ...
  if(chdir("./..") != 0){
    ...
    1ce2:	68 03 42 00 00       	push   $0x4203
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1cfa:	6a 00                	push   $0x0
    1cfc:	68 9a 41 00 00       	push   $0x419a
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1d3a:	5a                   	pop    %edx
    1d3b:	6a 00                	push   $0x0
    1d3d:	68 36 41 00 00       	push   $0x4136
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1d5a:	68 4e 42 00 00       	push   $0x424e
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1d77:	68 73 42 00 00       	push   $0x4273
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    1d94:	68 00 42 00 00       	push   $0x4200
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    1dac:	6a 02                	push   $0x2
    1dae:	68 00 42 00 00       	push   $0x4200
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    1dc6:	6a 01                	push   $0x1
    1dc8:	68 00 42 00 00       	push   $0x4200
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    1de0:	68 e2 42 00 00       	push   $0x42e2
    1de5:	68 4e 42 00 00       	push   $0x424e
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    1dfd:	68 e2 42 00 00       	push   $0x42e2
    1e02:	68 73 42 00 00       	push   $0x4273
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    1e1a:	68 9a 41 00 00       	push   $0x419a
    1e1f:	68 39 41 00 00       	push   $0x4139
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    1e37:	68 4e 42 00 00       	push   $0x424e
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    1e4f:	68 73 42 00 00       	push   $0x4273
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    1e67:	68 9a 41 00 00       	push   $0x419a
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    1e7f:	68 73 42 00 00       	push   $0x4273
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    1e97:	68 4e 42 00 00       	push   $0x424e
  ...
  if(chdir("dd/ff") == 0){
    ...
    1eaf:	68 39 41 00 00       	push   $0x4139
  ...
  if(chdir("dd/xx") == 0){
    ...
    1ec7:	68 e5 42 00 00       	push   $0x42e5
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    1edf:	68 9a 41 00 00       	push   $0x419a
  ...
  if(unlink("dd/ff") != 0){
    ...
    1ef7:	68 39 41 00 00       	push   $0x4139
  ...
  if(unlink("dd") == 0){
    ...
    1f0f:	68 00 42 00 00       	push   $0x4200
  ...
  if(unlink("dd/dd") < 0){
    ...
    1f27:	68 15 41 00 00       	push   $0x4115
  ...
  if(unlink("dd") < 0){
    ...
    1f3f:	68 00 42 00 00       	push   $0x4200
  ...
  printf(1, "subdir ok\n");
    ...
    1f57:	68 e2 43 00 00       	push   $0x43e2
    1f5c:	6a 01                	push   $0x1
    1f5e:	e8 4d 17 00 00       	call   36b0 <printf>
}
    ...
    1f6b:	51                   	push   %ecx
    1f6c:	51                   	push   %ecx
    1f6d:	68 7f 41 00 00       	push   $0x417f
    1f72:	6a 01                	push   $0x1
    1f74:	e8 37 17 00 00       	call   36b0 <printf>
    exit();
    1f79:	e8 fd 15 00 00       	call   357b <exit>
    printf(1, "chdir dd/../../dd failed\n");
    1f7e:	50                   	push   %eax
    1f7f:	50                   	push   %eax
    1f80:	68 da 41 00 00       	push   $0x41da
    1f85:	6a 01                	push   $0x1
    1f87:	e8 24 17 00 00       	call   36b0 <printf>
    exit();
    1f8c:	e8 ea 15 00 00       	call   357b <exit>
    printf(1, "unlink dd/dd/ff failed\n");
    1f91:	51                   	push   %ecx
    1f92:	51                   	push   %ecx
    1f93:	68 a5 41 00 00       	push   $0x41a5
    1f98:	6a 01                	push   $0x1
    1f9a:	e8 11 17 00 00       	call   36b0 <printf>
    exit();
    1f9f:	e8 d7 15 00 00       	call   357b <exit>
    printf(1, "create dd/ff/ff succeeded!\n");
    1fa4:	51                   	push   %ecx
    1fa5:	51                   	push   %ecx
    1fa6:	68 57 42 00 00       	push   $0x4257
    1fab:	6a 01                	push   $0x1
    1fad:	e8 fe 16 00 00       	call   36b0 <printf>
    exit();
    1fb2:	e8 c4 15 00 00       	call   357b <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded!\n");
    1fb7:	53                   	push   %ebx
    1fb8:	53                   	push   %ebx
    1fb9:	68 44 4c 00 00       	push   $0x4c44
    1fbe:	6a 01                	push   $0x1
    1fc0:	e8 eb 16 00 00       	call   36b0 <printf>
    exit();
    1fc5:	e8 b1 15 00 00       	call   357b <exit>
    printf(1, "mkdir dd/ff/ff succeeded!\n");
    1fca:	51                   	push   %ecx
    1fcb:	51                   	push   %ecx
    1fcc:	68 eb 42 00 00       	push   $0x42eb
    1fd1:	6a 01                	push   $0x1
    1fd3:	e8 d8 16 00 00       	call   36b0 <printf>
    exit();
    1fd8:	e8 9e 15 00 00       	call   357b <exit>
    printf(1, "link dd/ff dd/dd/ffff succeeded!\n");
    1fdd:	53                   	push   %ebx
    1fde:	53                   	push   %ebx
    1fdf:	68 b4 4c 00 00       	push   $0x4cb4
    1fe4:	6a 01                	push   $0x1
    1fe6:	e8 c5 16 00 00       	call   36b0 <printf>
    exit();
    1feb:	e8 8b 15 00 00       	call   357b <exit>
    printf(1, "open dd/dd/../ff failed\n");
    1ff0:	50                   	push   %eax
    1ff1:	50                   	push   %eax
    1ff2:	68 66 41 00 00       	push   $0x4166
    1ff7:	6a 01                	push   $0x1
    1ff9:	e8 b2 16 00 00       	call   36b0 <printf>
    exit();
    1ffe:	e8 78 15 00 00       	call   357b <exit>
    printf(1, "create dd/dd/ff failed\n");
    2003:	51                   	push   %ecx
    2004:	51                   	push   %ecx
    2005:	68 3f 41 00 00       	push   $0x413f
    200a:	6a 01                	push   $0x1
    200c:	e8 9f 16 00 00       	call   36b0 <printf>
    exit();
    2011:	e8 65 15 00 00       	call   357b <exit>
    printf(1, "chdir ./.. failed\n");
    2016:	50                   	push   %eax
    2017:	50                   	push   %eax
    2018:	68 08 42 00 00       	push   $0x4208
    201d:	6a 01                	push   $0x1
    201f:	e8 8c 16 00 00       	call   36b0 <printf>
    exit();
    2024:	e8 52 15 00 00       	call   357b <exit>
    printf(1, "link dd/dd/ff dd/dd/ffff failed\n");
    2029:	53                   	push   %ebx
    202a:	53                   	push   %ebx
    202b:	68 fc 4b 00 00       	push   $0x4bfc
    2030:	6a 01                	push   $0x1
    2032:	e8 79 16 00 00       	call   36b0 <printf>
    exit();
    2037:	e8 3f 15 00 00       	call   357b <exit>
    printf(1, "link dd/xx/ff dd/dd/xx succeeded!\n");
    203c:	50                   	push   %eax
    203d:	50                   	push   %eax
    203e:	68 90 4c 00 00       	push   $0x4c90
    2043:	6a 01                	push   $0x1
    2045:	e8 66 16 00 00       	call   36b0 <printf>
    exit();
    204a:	e8 2c 15 00 00       	call   357b <exit>
    printf(1, "link dd/ff/ff dd/dd/xx succeeded!\n");
    204f:	50                   	push   %eax
    2050:	50                   	push   %eax
    2051:	68 6c 4c 00 00       	push   $0x4c6c
    2056:	6a 01                	push   $0x1
    2058:	e8 53 16 00 00       	call   36b0 <printf>
    exit();
    205d:	e8 19 15 00 00       	call   357b <exit>
    printf(1, "open dd wronly succeeded!\n");
    2062:	50                   	push   %eax
    2063:	50                   	push   %eax
    2064:	68 c7 42 00 00       	push   $0x42c7
    2069:	6a 01                	push   $0x1
    206b:	e8 40 16 00 00       	call   36b0 <printf>
    exit();
    2070:	e8 06 15 00 00       	call   357b <exit>
    printf(1, "open dd rdwr succeeded!\n");
    2075:	50                   	push   %eax
    2076:	50                   	push   %eax
    2077:	68 ae 42 00 00       	push   $0x42ae
    207c:	6a 01                	push   $0x1
    207e:	e8 2d 16 00 00       	call   36b0 <printf>
    exit();
    2083:	e8 f3 14 00 00       	call   357b <exit>
    printf(1, "create dd succeeded!\n");
    2088:	50                   	push   %eax
    2089:	50                   	push   %eax
    208a:	68 98 42 00 00       	push   $0x4298
    208f:	6a 01                	push   $0x1
    2091:	e8 1a 16 00 00       	call   36b0 <printf>
    exit();
    2096:	e8 e0 14 00 00       	call   357b <exit>
    printf(1, "create dd/xx/ff succeeded!\n");
    209b:	52                   	push   %edx
    209c:	52                   	push   %edx
    209d:	68 7c 42 00 00       	push   $0x427c
    20a2:	6a 01                	push   $0x1
    20a4:	e8 07 16 00 00       	call   36b0 <printf>
    exit();
    20a9:	e8 cd 14 00 00       	call   357b <exit>
    printf(1, "chdir dd failed\n");
    20ae:	50                   	push   %eax
    20af:	50                   	push   %eax
    20b0:	68 bd 41 00 00       	push   $0x41bd
    20b5:	6a 01                	push   $0x1
    20b7:	e8 f4 15 00 00       	call   36b0 <printf>
    exit();
    20bc:	e8 ba 14 00 00       	call   357b <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    20c1:	52                   	push   %edx
    20c2:	52                   	push   %edx
    20c3:	68 20 4c 00 00       	push   $0x4c20
    20c8:	6a 01                	push   $0x1
    20ca:	e8 e1 15 00 00       	call   36b0 <printf>
    exit();
    20cf:	e8 a7 14 00 00       	call   357b <exit>
    printf(1, "subdir mkdir dd/dd failed\n");
    20d4:	53                   	push   %ebx
    20d5:	53                   	push   %ebx
    20d6:	68 1b 41 00 00       	push   $0x411b
    20db:	6a 01                	push   $0x1
    20dd:	e8 ce 15 00 00       	call   36b0 <printf>
    exit();
    20e2:	e8 94 14 00 00       	call   357b <exit>
    printf(1, "unlink dd (non-empty dir) succeeded!\n");
    20e7:	50                   	push   %eax
    20e8:	50                   	push   %eax
    20e9:	68 d4 4b 00 00       	push   $0x4bd4
    20ee:	6a 01                	push   $0x1
    20f0:	e8 bb 15 00 00       	call   36b0 <printf>
    exit();
    20f5:	e8 81 14 00 00       	call   357b <exit>
    printf(1, "create dd/ff failed\n");
    20fa:	50                   	push   %eax
    20fb:	50                   	push   %eax
    20fc:	68 ff 40 00 00       	push   $0x40ff
    2101:	6a 01                	push   $0x1
    2103:	e8 a8 15 00 00       	call   36b0 <printf>
    exit();
    2108:	e8 6e 14 00 00       	call   357b <exit>
    printf(1, "subdir mkdir dd failed\n");
    210d:	50                   	push   %eax
    210e:	50                   	push   %eax
    210f:	68 e7 40 00 00       	push   $0x40e7
    2114:	6a 01                	push   $0x1
    2116:	e8 95 15 00 00       	call   36b0 <printf>
    exit();
    211b:	e8 5b 14 00 00       	call   357b <exit>
    printf(1, "unlink dd failed\n");
    2120:	50                   	push   %eax
    2121:	50                   	push   %eax
    2122:	68 d0 43 00 00       	push   $0x43d0
    2127:	6a 01                	push   $0x1
    2129:	e8 82 15 00 00       	call   36b0 <printf>
    exit();
    212e:	e8 48 14 00 00       	call   357b <exit>
    printf(1, "unlink dd/dd failed\n");
    2133:	52                   	push   %edx
    2134:	52                   	push   %edx
    2135:	68 bb 43 00 00       	push   $0x43bb
    213a:	6a 01                	push   $0x1
    213c:	e8 6f 15 00 00       	call   36b0 <printf>
    exit();
    2141:	e8 35 14 00 00       	call   357b <exit>
    printf(1, "unlink non-empty dd succeeded!\n");
    2146:	51                   	push   %ecx
    2147:	51                   	push   %ecx
    2148:	68 d8 4c 00 00       	push   $0x4cd8
    214d:	6a 01                	push   $0x1
    214f:	e8 5c 15 00 00       	call   36b0 <printf>
    exit();
    2154:	e8 22 14 00 00       	call   357b <exit>
    printf(1, "unlink dd/ff failed\n");
    2159:	53                   	push   %ebx
    215a:	53                   	push   %ebx
    215b:	68 a6 43 00 00       	push   $0x43a6
    2160:	6a 01                	push   $0x1
    2162:	e8 49 15 00 00       	call   36b0 <printf>
    exit();
    2167:	e8 0f 14 00 00       	call   357b <exit>
    printf(1, "chdir dd/xx succeeded!\n");
    216c:	50                   	push   %eax
    216d:	50                   	push   %eax
    216e:	68 8e 43 00 00       	push   $0x438e
    2173:	6a 01                	push   $0x1
    2175:	e8 36 15 00 00       	call   36b0 <printf>
    exit();
    217a:	e8 fc 13 00 00       	call   357b <exit>
    printf(1, "chdir dd/ff succeeded!\n");
    217f:	50                   	push   %eax
    2180:	50                   	push   %eax
    2181:	68 76 43 00 00       	push   $0x4376
    2186:	6a 01                	push   $0x1
    2188:	e8 23 15 00 00       	call   36b0 <printf>
    exit();
    218d:	e8 e9 13 00 00       	call   357b <exit>
    printf(1, "unlink dd/ff/ff succeeded!\n");
    2192:	50                   	push   %eax
    2193:	50                   	push   %eax
    2194:	68 5a 43 00 00       	push   $0x435a
    2199:	6a 01                	push   $0x1
    219b:	e8 10 15 00 00       	call   36b0 <printf>
    exit();
    21a0:	e8 d6 13 00 00       	call   357b <exit>
    printf(1, "unlink dd/xx/ff succeeded!\n");
    21a5:	50                   	push   %eax
    21a6:	50                   	push   %eax
    21a7:	68 3e 43 00 00       	push   $0x433e
    21ac:	6a 01                	push   $0x1
    21ae:	e8 fd 14 00 00       	call   36b0 <printf>
    exit();
    21b3:	e8 c3 13 00 00       	call   357b <exit>
    printf(1, "mkdir dd/dd/ffff succeeded!\n");
    21b8:	50                   	push   %eax
    21b9:	50                   	push   %eax
    21ba:	68 21 43 00 00       	push   $0x4321
    21bf:	6a 01                	push   $0x1
    21c1:	e8 ea 14 00 00       	call   36b0 <printf>
    exit();
    21c6:	e8 b0 13 00 00       	call   357b <exit>
    printf(1, "mkdir dd/xx/ff succeeded!\n");
    21cb:	52                   	push   %edx
    21cc:	52                   	push   %edx
    21cd:	68 06 43 00 00       	push   $0x4306
    21d2:	6a 01                	push   $0x1
    21d4:	e8 d7 14 00 00       	call   36b0 <printf>
    exit();
    21d9:	e8 9d 13 00 00       	call   357b <exit>
    printf(1, "read dd/dd/ffff wrong len\n");
    21de:	51                   	push   %ecx
    21df:	51                   	push   %ecx
    21e0:	68 33 42 00 00       	push   $0x4233
    21e5:	6a 01                	push   $0x1
    21e7:	e8 c4 14 00 00       	call   36b0 <printf>
    exit();
    21ec:	e8 8a 13 00 00       	call   357b <exit>
    printf(1, "open dd/dd/ffff failed\n");
    21f1:	50                   	push   %eax
    21f2:	50                   	push   %eax
    21f3:	68 1b 42 00 00       	push   $0x421b
    21f8:	6a 01                	push   $0x1
    21fa:	e8 b1 14 00 00       	call   36b0 <printf>
    exit();
...
00002204 <bigwrite>:
{
  ...
  printf(1, "bigwrite test\n");
    ...
    220c:	68 ed 43 00 00       	push   $0x43ed
    2211:	6a 01                	push   $0x1
    2213:	e8 98 14 00 00       	call   36b0 <printf>
  unlink("bigwrite");
    2218:	c7 04 24 fc 43 00 00 	movl   $0x43fc,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    2234:	68 fc 43 00 00       	push   $0x43fc
    ...
    unlink("bigwrite");
    2278:	c7 04 24 fc 43 00 00 	movl   $0x43fc,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    ...
    2298:	68 2f 44 00 00       	push   $0x442f
    229d:	6a 01                	push   $0x1
    229f:	e8 0c 14 00 00       	call   36b0 <printf>
}
    ...
    22ae:	50                   	push   %eax
    22af:	53                   	push   %ebx
    22b0:	68 1d 44 00 00       	push   $0x441d
    22b5:	6a 01                	push   $0x1
    22b7:	e8 f4 13 00 00       	call   36b0 <printf>
        exit();
    22bc:	e8 ba 12 00 00       	call   357b <exit>
      printf(1, "cannot create bigwrite\n");
    22c1:	83 ec 08             	sub    $0x8,%esp
    22c4:	68 05 44 00 00       	push   $0x4405
    22c9:	6a 01                	push   $0x1
    22cb:	e8 e0 13 00 00       	call   36b0 <printf>
      exit();
...
000022d8 <bigfile>:
{
  ...
  printf(1, "bigfile test\n");
    22e1:	68 3c 44 00 00       	push   $0x443c
    22e6:	6a 01                	push   $0x1
    22e8:	e8 c3 13 00 00       	call   36b0 <printf>
  unlink("bigfile");
    22ed:	c7 04 24 58 44 00 00 	movl   $0x4458,(%esp)
    22f4:	e8 d2 12 00 00       	call   35cb <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    22f9:	5e                   	pop    %esi
    22fa:	5f                   	pop    %edi
    22fb:	68 02 02 00 00       	push   $0x202
    2300:	68 58 44 00 00       	push   $0x4458
  ...
  fd = open("bigfile", 0);
    ...
    235e:	5a                   	pop    %edx
    235f:	6a 00                	push   $0x0
    2361:	68 58 44 00 00       	push   $0x4458
  ...
  unlink("bigfile");
    ...
    23e1:	68 58 44 00 00       	push   $0x4458
    23e6:	e8 e0 11 00 00       	call   35cb <unlink>
  printf(1, "bigfile test ok\n");
    23eb:	58                   	pop    %eax
    23ec:	5a                   	pop    %edx
    23ed:	68 e7 44 00 00       	push   $0x44e7
    23f2:	6a 01                	push   $0x1
    23f4:	e8 b7 12 00 00       	call   36b0 <printf>
}
    ...
    2407:	68 b4 44 00 00       	push   $0x44b4
    240c:	6a 01                	push   $0x1
    240e:	e8 9d 12 00 00       	call   36b0 <printf>
      exit();
    2413:	e8 63 11 00 00       	call   357b <exit>
      printf(1, "short read bigfile\n");
    2418:	83 ec 08             	sub    $0x8,%esp
    241b:	68 a0 44 00 00       	push   $0x44a0
    2420:	6a 01                	push   $0x1
    2422:	e8 89 12 00 00       	call   36b0 <printf>
      exit();
    2427:	e8 4f 11 00 00       	call   357b <exit>
      printf(1, "read bigfile failed\n");
    242c:	83 ec 08             	sub    $0x8,%esp
    242f:	68 8b 44 00 00       	push   $0x448b
    2434:	6a 01                	push   $0x1
    2436:	e8 75 12 00 00       	call   36b0 <printf>
      exit();
    243b:	e8 3b 11 00 00       	call   357b <exit>
      printf(1, "write bigfile failed\n");
    2440:	83 ec 08             	sub    $0x8,%esp
    2443:	68 60 44 00 00       	push   $0x4460
    2448:	6a 01                	push   $0x1
    244a:	e8 61 12 00 00       	call   36b0 <printf>
      exit();
    244f:	e8 27 11 00 00       	call   357b <exit>
    printf(1, "cannot open bigfile\n");
    2454:	50                   	push   %eax
    2455:	50                   	push   %eax
    2456:	68 76 44 00 00       	push   $0x4476
    245b:	6a 01                	push   $0x1
    245d:	e8 4e 12 00 00       	call   36b0 <printf>
    exit();
    2462:	e8 14 11 00 00       	call   357b <exit>
    printf(1, "cannot create bigfile");
    2467:	53                   	push   %ebx
    2468:	53                   	push   %ebx
    2469:	68 4a 44 00 00       	push   $0x444a
    246e:	6a 01                	push   $0x1
    2470:	e8 3b 12 00 00       	call   36b0 <printf>
    exit();
    2475:	e8 01 11 00 00       	call   357b <exit>
    printf(1, "read bigfile wrong total\n");
    247a:	51                   	push   %ecx
    247b:	51                   	push   %ecx
    247c:	68 cd 44 00 00       	push   $0x44cd
    2481:	6a 01                	push   $0x1
    2483:	e8 28 12 00 00       	call   36b0 <printf>
    exit();
...
00002490 <fourteen>:
{
  ...
  printf(1, "fourteen test\n");
    2496:	68 f8 44 00 00       	push   $0x44f8
    249b:	6a 01                	push   $0x1
    249d:	e8 0e 12 00 00       	call   36b0 <printf>
  if(mkdir("12345678901234") != 0){
    24a2:	c7 04 24 33 45 00 00 	movl   $0x4533,(%esp)
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    24bc:	68 f8 4c 00 00       	push   $0x4cf8
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    24d9:	68 48 4d 00 00       	push   $0x4d48
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    24f8:	5a                   	pop    %edx
    24f9:	6a 00                	push   $0x0
    24fb:	68 b8 4d 00 00       	push   $0x4db8
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    2515:	c7 04 24 24 45 00 00 	movl   $0x4524,(%esp)
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    252b:	68 54 4e 00 00       	push   $0x4e54
  ...
  printf(1, "fourteen ok\n");
    ...
    253f:	68 42 45 00 00       	push   $0x4542
    2544:	6a 01                	push   $0x1
    2546:	e8 65 11 00 00       	call   36b0 <printf>
}
    ...
    2550:	50                   	push   %eax
    2551:	50                   	push   %eax
    2552:	68 07 45 00 00       	push   $0x4507
    2557:	6a 01                	push   $0x1
    2559:	e8 52 11 00 00       	call   36b0 <printf>
    exit();
    255e:	e8 18 10 00 00       	call   357b <exit>
    printf(1, "mkdir 12345678901234/123456789012345 succeeded!\n");
    2563:	50                   	push   %eax
    2564:	50                   	push   %eax
    2565:	68 74 4e 00 00       	push   $0x4e74
    256a:	6a 01                	push   $0x1
    256c:	e8 3f 11 00 00       	call   36b0 <printf>
    exit();
    2571:	e8 05 10 00 00       	call   357b <exit>
    printf(1, "mkdir 12345678901234/12345678901234 succeeded!\n");
    2576:	52                   	push   %edx
    2577:	52                   	push   %edx
    2578:	68 24 4e 00 00       	push   $0x4e24
    257d:	6a 01                	push   $0x1
    257f:	e8 2c 11 00 00       	call   36b0 <printf>
    exit();
    2584:	e8 f2 0f 00 00       	call   357b <exit>
    printf(1, "open 12345678901234/12345678901234/12345678901234 failed\n");
    2589:	51                   	push   %ecx
    258a:	51                   	push   %ecx
    258b:	68 e8 4d 00 00       	push   $0x4de8
    2590:	6a 01                	push   $0x1
    2592:	e8 19 11 00 00       	call   36b0 <printf>
    exit();
    2597:	e8 df 0f 00 00       	call   357b <exit>
    printf(1, "create 123456789012345/123456789012345/123456789012345 failed\n");
    259c:	51                   	push   %ecx
    259d:	51                   	push   %ecx
    259e:	68 78 4d 00 00       	push   $0x4d78
    25a3:	6a 01                	push   $0x1
    25a5:	e8 06 11 00 00       	call   36b0 <printf>
    exit();
    25aa:	e8 cc 0f 00 00       	call   357b <exit>
    printf(1, "mkdir 12345678901234/123456789012345 failed\n");
    25af:	50                   	push   %eax
    25b0:	50                   	push   %eax
    25b1:	68 18 4d 00 00       	push   $0x4d18
    25b6:	6a 01                	push   $0x1
    25b8:	e8 f3 10 00 00       	call   36b0 <printf>
    exit();
...
000025c4 <rmdot>:
{
  ...
  printf(1, "rmdot test\n");
    25ca:	68 4f 45 00 00       	push   $0x454f
    25cf:	6a 01                	push   $0x1
    25d1:	e8 da 10 00 00       	call   36b0 <printf>
  if(mkdir("dots") != 0){
    25d6:	c7 04 24 5b 45 00 00 	movl   $0x455b,(%esp)
  ...
  if(chdir("dots") != 0){
    ...
    25f0:	68 5b 45 00 00       	push   $0x455b
  ...
  if(unlink(".") == 0){
    ...
    2608:	68 06 42 00 00       	push   $0x4206
  ...
  if(unlink("..") == 0){
    ...
    2620:	68 05 42 00 00       	push   $0x4205
  ...
  if(chdir("/") != 0){
    ...
    2638:	68 d9 39 00 00       	push   $0x39d9
  ...
  if(unlink("dots/.") == 0){
    ...
    2650:	68 a3 45 00 00       	push   $0x45a3
  ...
  if(unlink("dots/..") == 0){
    ...
    2664:	68 c1 45 00 00       	push   $0x45c1
  ...
  if(unlink("dots") != 0){
    ...
    2678:	68 5b 45 00 00       	push   $0x455b
  ...
  printf(1, "rmdot ok\n");
    ...
    268c:	68 f6 45 00 00       	push   $0x45f6
    2691:	6a 01                	push   $0x1
    2693:	e8 18 10 00 00       	call   36b0 <printf>
}
    ...
    269d:	50                   	push   %eax
    269e:	50                   	push   %eax
    269f:	68 60 45 00 00       	push   $0x4560
    26a4:	6a 01                	push   $0x1
    26a6:	e8 05 10 00 00       	call   36b0 <printf>
    exit();
    26ab:	e8 cb 0e 00 00       	call   357b <exit>
    printf(1, "unlink dots failed!\n");
    26b0:	50                   	push   %eax
    26b1:	50                   	push   %eax
    26b2:	68 e1 45 00 00       	push   $0x45e1
    26b7:	6a 01                	push   $0x1
    26b9:	e8 f2 0f 00 00       	call   36b0 <printf>
    exit();
    26be:	e8 b8 0e 00 00       	call   357b <exit>
    printf(1, "unlink dots/.. worked!\n");
    26c3:	52                   	push   %edx
    26c4:	52                   	push   %edx
    26c5:	68 c9 45 00 00       	push   $0x45c9
    26ca:	6a 01                	push   $0x1
    26cc:	e8 df 0f 00 00       	call   36b0 <printf>
    exit();
    26d1:	e8 a5 0e 00 00       	call   357b <exit>
    printf(1, "unlink dots/. worked!\n");
    26d6:	51                   	push   %ecx
    26d7:	51                   	push   %ecx
    26d8:	68 aa 45 00 00       	push   $0x45aa
    26dd:	6a 01                	push   $0x1
    26df:	e8 cc 0f 00 00       	call   36b0 <printf>
    exit();
    26e4:	e8 92 0e 00 00       	call   357b <exit>
    printf(1, "chdir / failed\n");
    26e9:	50                   	push   %eax
    26ea:	50                   	push   %eax
    26eb:	68 db 39 00 00       	push   $0x39db
    26f0:	6a 01                	push   $0x1
    26f2:	e8 b9 0f 00 00       	call   36b0 <printf>
    exit();
    26f7:	e8 7f 0e 00 00       	call   357b <exit>
    printf(1, "rm .. worked!\n");
    26fc:	50                   	push   %eax
    26fd:	50                   	push   %eax
    26fe:	68 94 45 00 00       	push   $0x4594
    2703:	6a 01                	push   $0x1
    2705:	e8 a6 0f 00 00       	call   36b0 <printf>
    exit();
    270a:	e8 6c 0e 00 00       	call   357b <exit>
    printf(1, "rm . worked!\n");
    270f:	50                   	push   %eax
    2710:	50                   	push   %eax
    2711:	68 86 45 00 00       	push   $0x4586
    2716:	6a 01                	push   $0x1
    2718:	e8 93 0f 00 00       	call   36b0 <printf>
    exit();
    271d:	e8 59 0e 00 00       	call   357b <exit>
    printf(1, "chdir dots failed\n");
    2722:	50                   	push   %eax
    2723:	50                   	push   %eax
    2724:	68 73 45 00 00       	push   $0x4573
    2729:	6a 01                	push   $0x1
    272b:	e8 80 0f 00 00       	call   36b0 <printf>
    exit();
...
00002738 <dirfile>:
{
  ...
  printf(1, "dir vs file\n");
    273f:	68 00 46 00 00       	push   $0x4600
    2744:	6a 01                	push   $0x1
    2746:	e8 65 0f 00 00       	call   36b0 <printf>
  fd = open("dirfile", O_CREATE);
    274b:	5b                   	pop    %ebx
    274c:	58                   	pop    %eax
    274d:	68 00 02 00 00       	push   $0x200
    2752:	68 0d 46 00 00       	push   $0x460d
  ...
  if(chdir("dirfile") == 0){
    2770:	c7 04 24 0d 46 00 00 	movl   $0x460d,(%esp)
  ...
  fd = open("dirfile/xx", 0);
    ...
    278a:	6a 00                	push   $0x0
    278c:	68 46 46 00 00       	push   $0x4646
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    27a9:	68 46 46 00 00       	push   $0x4646
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    27c1:	68 46 46 00 00       	push   $0x4646
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    27d9:	68 46 46 00 00       	push   $0x4646
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    27f1:	68 46 46 00 00       	push   $0x4646
    27f6:	68 aa 46 00 00       	push   $0x46aa
  ...
  if(unlink("dirfile") != 0){
    ...
    280e:	68 0d 46 00 00       	push   $0x460d
  ...
  fd = open(".", O_RDWR);
    ...
    2826:	6a 02                	push   $0x2
    2828:	68 06 42 00 00       	push   $0x4206
  ...
  printf(1, "dir vs file OK\n");
    286e:	58                   	pop    %eax
    286f:	5a                   	pop    %edx
    2870:	68 dd 46 00 00       	push   $0x46dd
    2875:	6a 01                	push   $0x1
    2877:	e8 34 0e 00 00       	call   36b0 <printf>
}
    ...
    2884:	50                   	push   %eax
    2885:	50                   	push   %eax
    2886:	68 51 46 00 00       	push   $0x4651
    288b:	6a 01                	push   $0x1
    288d:	e8 1e 0e 00 00       	call   36b0 <printf>
    exit();
    2892:	e8 e4 0c 00 00       	call   357b <exit>
    printf(1, "chdir dirfile succeeded!\n");
    2897:	52                   	push   %edx
    2898:	52                   	push   %edx
    2899:	68 2c 46 00 00       	push   $0x462c
    289e:	6a 01                	push   $0x1
    28a0:	e8 0b 0e 00 00       	call   36b0 <printf>
    exit();
    28a5:	e8 d1 0c 00 00       	call   357b <exit>
    printf(1, "create dirfile failed\n");
    28aa:	51                   	push   %ecx
    28ab:	51                   	push   %ecx
    28ac:	68 15 46 00 00       	push   $0x4615
    28b1:	6a 01                	push   $0x1
    28b3:	e8 f8 0d 00 00       	call   36b0 <printf>
    exit();
    28b8:	e8 be 0c 00 00       	call   357b <exit>
    printf(1, "write . succeeded!\n");
    28bd:	51                   	push   %ecx
    28be:	51                   	push   %ecx
    28bf:	68 c9 46 00 00       	push   $0x46c9
    28c4:	6a 01                	push   $0x1
    28c6:	e8 e5 0d 00 00       	call   36b0 <printf>
    exit();
    28cb:	e8 ab 0c 00 00       	call   357b <exit>
    printf(1, "open . for writing succeeded!\n");
    28d0:	53                   	push   %ebx
    28d1:	53                   	push   %ebx
    28d2:	68 c8 4e 00 00       	push   $0x4ec8
    28d7:	6a 01                	push   $0x1
    28d9:	e8 d2 0d 00 00       	call   36b0 <printf>
    exit();
    28de:	e8 98 0c 00 00       	call   357b <exit>
    printf(1, "unlink dirfile failed!\n");
    28e3:	50                   	push   %eax
    28e4:	50                   	push   %eax
    28e5:	68 b1 46 00 00       	push   $0x46b1
    28ea:	6a 01                	push   $0x1
    28ec:	e8 bf 0d 00 00       	call   36b0 <printf>
    exit();
    28f1:	e8 85 0c 00 00       	call   357b <exit>
    printf(1, "link to dirfile/xx succeeded!\n");
    28f6:	50                   	push   %eax
    28f7:	50                   	push   %eax
    28f8:	68 a8 4e 00 00       	push   $0x4ea8
    28fd:	6a 01                	push   $0x1
    28ff:	e8 ac 0d 00 00       	call   36b0 <printf>
    exit();
    2904:	e8 72 0c 00 00       	call   357b <exit>
    printf(1, "unlink dirfile/xx succeeded!\n");
    2909:	50                   	push   %eax
    290a:	50                   	push   %eax
    290b:	68 8c 46 00 00       	push   $0x468c
    2910:	6a 01                	push   $0x1
    2912:	e8 99 0d 00 00       	call   36b0 <printf>
    exit();
    2917:	e8 5f 0c 00 00       	call   357b <exit>
    printf(1, "mkdir dirfile/xx succeeded!\n");
    291c:	50                   	push   %eax
    291d:	50                   	push   %eax
    291e:	68 6f 46 00 00       	push   $0x466f
    2923:	6a 01                	push   $0x1
    2925:	e8 86 0d 00 00       	call   36b0 <printf>
    exit();
...
00002930 <iref>:
{
  ...
  printf(1, "empty file name\n");
    2937:	68 ed 46 00 00       	push   $0x46ed
    293c:	6a 01                	push   $0x1
    293e:	e8 6d 0d 00 00       	call   36b0 <printf>
    2943:	83 c4 10             	add    $0x10,%esp
    2946:	bb 33 00 00 00       	mov    $0x33,%ebx
    294b:	90                   	nop
    if(mkdir("irefd") != 0){
    294c:	83 ec 0c             	sub    $0xc,%esp
    294f:	68 fe 46 00 00       	push   $0x46fe
    ...
    2967:	68 fe 46 00 00       	push   $0x46fe
    ...
    297f:	68 b3 3d 00 00       	push   $0x3db3
    2984:	e8 5a 0c 00 00       	call   35e3 <mkdir>
    link("README", "");
    2989:	59                   	pop    %ecx
    298a:	58                   	pop    %eax
    298b:	68 b3 3d 00 00       	push   $0x3db3
    2990:	68 aa 46 00 00       	push   $0x46aa
    2995:	e8 41 0c 00 00       	call   35db <link>
    fd = open("", O_CREATE);
    299a:	58                   	pop    %eax
    299b:	5a                   	pop    %edx
    299c:	68 00 02 00 00       	push   $0x200
    29a1:	68 b3 3d 00 00       	push   $0x3db3
    ...
    29c6:	68 e8 42 00 00       	push   $0x42e8
    ...
    29e6:	68 e8 42 00 00       	push   $0x42e8
  ...
  chdir("/");
    ...
    29fd:	68 d9 39 00 00       	push   $0x39d9
    2a02:	e8 e4 0b 00 00       	call   35eb <chdir>
  printf(1, "empty file name OK\n");
    2a07:	58                   	pop    %eax
    2a08:	5a                   	pop    %edx
    2a09:	68 2c 47 00 00       	push   $0x472c
    2a0e:	6a 01                	push   $0x1
    2a10:	e8 9b 0c 00 00       	call   36b0 <printf>
}
    ...
    2a20:	68 04 47 00 00       	push   $0x4704
    2a25:	6a 01                	push   $0x1
    2a27:	e8 84 0c 00 00       	call   36b0 <printf>
      exit();
    2a2c:	e8 4a 0b 00 00       	call   357b <exit>
      printf(1, "chdir irefd failed\n");
    2a31:	83 ec 08             	sub    $0x8,%esp
    2a34:	68 18 47 00 00       	push   $0x4718
    2a39:	6a 01                	push   $0x1
    2a3b:	e8 70 0c 00 00       	call   36b0 <printf>
      exit();
...
00002a48 <forktest>:
{
  ...
  printf(1, "fork test\n");
    2a4f:	68 40 47 00 00       	push   $0x4740
    2a54:	6a 01                	push   $0x1
    2a56:	e8 55 0c 00 00       	call   36b0 <printf>
  ...
  printf(1, "fork test OK\n");
    ...
    2a93:	68 72 47 00 00       	push   $0x4772
    2a98:	6a 01                	push   $0x1
    2a9a:	e8 11 0c 00 00       	call   36b0 <printf>
}
    ...
    2aac:	68 4b 47 00 00       	push   $0x474b
    2ab1:	6a 01                	push   $0x1
    2ab3:	e8 f8 0b 00 00       	call   36b0 <printf>
      exit();
    2ab8:	e8 be 0a 00 00       	call   357b <exit>
    printf(1, "wait got too many\n");
    2abd:	52                   	push   %edx
    2abe:	52                   	push   %edx
    2abf:	68 5f 47 00 00       	push   $0x475f
    2ac4:	6a 01                	push   $0x1
    2ac6:	e8 e5 0b 00 00       	call   36b0 <printf>
    exit();
    2acb:	e8 ab 0a 00 00       	call   357b <exit>
    printf(1, "fork claimed to work 1000 times!\n");
    2ad0:	50                   	push   %eax
    2ad1:	50                   	push   %eax
    2ad2:	68 e8 4e 00 00       	push   $0x4ee8
    2ad7:	6a 01                	push   $0x1
    2ad9:	e8 d2 0b 00 00       	call   36b0 <printf>
    exit();
...
00002ae4 <sbrktest>:
{
  ...
  printf(stdout, "sbrk test\n");
    2aed:	68 80 47 00 00       	push   $0x4780
    2af2:	ff 35 b0 51 00 00    	push   0x51b0
    2af8:	e8 b3 0b 00 00       	call   36b0 <printf>
  oldbrk = sbrk(0);
  ...
  *lastaddr = 99;
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    2d42:	68 28 48 00 00       	push   $0x4828
    2d47:	ff 35 b0 51 00 00    	push   0x51b0
    2d4d:	e8 5e 09 00 00       	call   36b0 <printf>
}
    ...
    2d7b:	6a 01                	push   $0x1
    2d7d:	68 e9 42 00 00       	push   $0x42e9
    ...
    2dc7:	53                   	push   %ebx
    2dc8:	56                   	push   %esi
    2dc9:	68 8b 47 00 00       	push   $0x478b
    2dce:	ff 35 b0 51 00 00    	push   0x51b0
    2dd4:	e8 d7 08 00 00       	call   36b0 <printf>
      exit();
    2dd9:	83 c4 20             	add    $0x20,%esp
    2ddc:	e8 9a 07 00 00       	call   357b <exit>
      printf(stdout, "fork failed\n");
    2de1:	83 ec 08             	sub    $0x8,%esp
    2de4:	68 d1 48 00 00       	push   $0x48d1
    2de9:	ff 35 b0 51 00 00    	push   0x51b0
    2def:	e8 bc 08 00 00       	call   36b0 <printf>
      exit();
    ...
    2dfc:	50                   	push   %eax
    2dfd:	53                   	push   %ebx
    2dfe:	68 f4 47 00 00       	push   $0x47f4
    2e03:	ff 35 b0 51 00 00    	push   0x51b0
    2e09:	e8 a2 08 00 00       	call   36b0 <printf>
      kill(ppid);
    ...
    2e1b:	50                   	push   %eax
    2e1c:	53                   	push   %ebx
    2e1d:	68 dc 4f 00 00       	push   $0x4fdc
    2e22:	ff 35 b0 51 00 00    	push   0x51b0
    2e28:	e8 83 08 00 00       	call   36b0 <printf>
    exit();
    2e2d:	e8 49 07 00 00       	call   357b <exit>
    printf(stdout, "sbrk test failed to grow big address space; enough phys mem?\n");
    2e32:	57                   	push   %edi
    2e33:	57                   	push   %edi
    2e34:	68 0c 4f 00 00       	push   $0x4f0c
    2e39:	ff 35 b0 51 00 00    	push   0x51b0
    2e3f:	e8 6c 08 00 00       	call   36b0 <printf>
    exit();
    2e44:	e8 32 07 00 00       	call   357b <exit>
    printf(stdout, "sbrk test fork failed\n");
    2e49:	50                   	push   %eax
    2e4a:	50                   	push   %eax
    2e4b:	68 a6 47 00 00       	push   $0x47a6
    2e50:	ff 35 b0 51 00 00    	push   0x51b0
    2e56:	e8 55 08 00 00       	call   36b0 <printf>
    exit();
    2e5b:	e8 1b 07 00 00       	call   357b <exit>
    printf(stdout, "sbrk de-allocation didn't really deallocate\n");
    2e60:	53                   	push   %ebx
    2e61:	53                   	push   %ebx
    2e62:	68 ac 4f 00 00       	push   $0x4fac
    2e67:	ff 35 b0 51 00 00    	push   0x51b0
    2e6d:	e8 3e 08 00 00       	call   36b0 <printf>
    exit();
    2e72:	e8 04 07 00 00       	call   357b <exit>
    printf(stdout, "failed sbrk leaked memory\n");
    2e77:	50                   	push   %eax
    2e78:	50                   	push   %eax
    2e79:	68 0d 48 00 00       	push   $0x480d
    2e7e:	ff 35 b0 51 00 00    	push   0x51b0
    2e84:	e8 27 08 00 00       	call   36b0 <printf>
    exit();
    2e89:	e8 ed 06 00 00       	call   357b <exit>
    printf(1, "pipe() failed\n");
    2e8e:	51                   	push   %ecx
    2e8f:	51                   	push   %ecx
    2e90:	68 c9 3c 00 00       	push   $0x3cc9
    2e95:	6a 01                	push   $0x1
    2e97:	e8 14 08 00 00       	call   36b0 <printf>
    exit();
    ...
    2ea6:	50                   	push   %eax
    2ea7:	50                   	push   %eax
    2ea8:	68 bd 47 00 00       	push   $0x47bd
    2ead:	ff 35 b0 51 00 00    	push   0x51b0
    2eb3:	e8 f8 07 00 00       	call   36b0 <printf>
    exit();
    2eb8:	e8 be 06 00 00       	call   357b <exit>
    printf(stdout, "sbrk re-allocation failed, a %x c %x\n", a, c);
    2ebd:	56                   	push   %esi
    2ebe:	53                   	push   %ebx
    2ebf:	68 84 4f 00 00       	push   $0x4f84
    2ec4:	ff 35 b0 51 00 00    	push   0x51b0
    2eca:	e8 e1 07 00 00       	call   36b0 <printf>
    exit();
    2ecf:	e8 a7 06 00 00       	call   357b <exit>
    printf(stdout, "sbrk deallocation produced wrong address, a %x c %x\n", a, c);
    2ed4:	50                   	push   %eax
    2ed5:	53                   	push   %ebx
    2ed6:	68 4c 4f 00 00       	push   $0x4f4c
    2edb:	ff 35 b0 51 00 00    	push   0x51b0
    2ee1:	e8 ca 07 00 00       	call   36b0 <printf>
    exit();
    2ee6:	e8 90 06 00 00       	call   357b <exit>
    printf(stdout, "sbrk could not deallocate\n");
    2eeb:	56                   	push   %esi
    2eec:	56                   	push   %esi
    2eed:	68 d9 47 00 00       	push   $0x47d9
    2ef2:	ff 35 b0 51 00 00    	push   0x51b0
    2ef8:	e8 b3 07 00 00       	call   36b0 <printf>
    exit();
...
00002f08 <validatetest>:
{
  ...
  printf(stdout, "validate test\n");
    ...
    2f10:	68 36 48 00 00       	push   $0x4836
    2f15:	ff 35 b0 51 00 00    	push   0x51b0
    2f1b:	e8 90 07 00 00       	call   36b0 <printf>
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    2f57:	5a                   	pop    %edx
    2f58:	56                   	push   %esi
    2f59:	68 45 48 00 00       	push   $0x4845
  ...
  printf(stdout, "validate ok\n");
    ...
    2f7a:	68 69 48 00 00       	push   $0x4869
    2f7f:	ff 35 b0 51 00 00    	push   0x51b0
    2f85:	e8 26 07 00 00       	call   36b0 <printf>
}
    ...
    2f9c:	68 50 48 00 00       	push   $0x4850
    2fa1:	ff 35 b0 51 00 00    	push   0x51b0
    2fa7:	e8 04 07 00 00       	call   36b0 <printf>
      exit();
...
00002fb4 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    2fba:	68 76 48 00 00       	push   $0x4876
    2fbf:	ff 35 b0 51 00 00    	push   0x51b0
    2fc5:	e8 e6 06 00 00       	call   36b0 <printf>
  ...
  printf(stdout, "bss test ok\n");
    ...
    2fe4:	68 91 48 00 00       	push   $0x4891
    2fe9:	ff 35 b0 51 00 00    	push   0x51b0
    2fef:	e8 bc 06 00 00       	call   36b0 <printf>
}
    ...
    2ffc:	68 80 48 00 00       	push   $0x4880
    3001:	ff 35 b0 51 00 00    	push   0x51b0
    3007:	e8 a4 06 00 00       	call   36b0 <printf>
      exit();
...
00003014 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    301a:	68 9e 48 00 00       	push   $0x489e
  ...
  fd = open("bigarg-ok", 0);
    ...
    303e:	6a 00                	push   $0x0
    3040:	68 9e 48 00 00       	push   $0x489e
  ...
  unlink("bigarg-ok");
    305e:	c7 04 24 9e 48 00 00 	movl   $0x489e,(%esp)
    ...
    306f:	c7 04 85 00 99 00 00 	movl   $0x5000,0x9900(,%eax,4)
    3076:	00 50 00 00 
    for(i = 0; i < MAXARG-1; i++)
    307a:	b8 01 00 00 00       	mov    $0x1,%eax
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    307f:	c7 04 85 00 99 00 00 	movl   $0x5000,0x9900(,%eax,4)
    3086:	00 50 00 00 
    308a:	c7 04 85 04 99 00 00 	movl   $0x5000,0x9904(,%eax,4)
    3091:	00 50 00 00 
    for(i = 0; i < MAXARG-1; i++)
    ...
    30a5:	50                   	push   %eax
    30a6:	50                   	push   %eax
    30a7:	68 a8 48 00 00       	push   $0x48a8
    30ac:	ff 35 b0 51 00 00    	push   0x51b0
    30b2:	e8 f9 05 00 00       	call   36b0 <printf>
    exec("echo", args);
    30b7:	58                   	pop    %eax
    30b8:	5a                   	pop    %edx
    30b9:	68 00 99 00 00       	push   $0x9900
    30be:	68 75 3a 00 00       	push   $0x3a75
    30c3:	e8 eb 04 00 00       	call   35b3 <exec>
    printf(stdout, "bigarg test ok\n");
    30c8:	59                   	pop    %ecx
    30c9:	58                   	pop    %eax
    30ca:	68 b5 48 00 00       	push   $0x48b5
    30cf:	ff 35 b0 51 00 00    	push   0x51b0
    30d5:	e8 d6 05 00 00       	call   36b0 <printf>
    fd = open("bigarg-ok", O_CREATE);
    30da:	58                   	pop    %eax
    30db:	5a                   	pop    %edx
    30dc:	68 00 02 00 00       	push   $0x200
    30e1:	68 9e 48 00 00       	push   $0x489e
    ...
    30f8:	50                   	push   %eax
    30f9:	50                   	push   %eax
    30fa:	68 de 48 00 00       	push   $0x48de
    30ff:	ff 35 b0 51 00 00    	push   0x51b0
    3105:	e8 a6 05 00 00       	call   36b0 <printf>
    exit();
    310a:	e8 6c 04 00 00       	call   357b <exit>
    printf(stdout, "bigargtest: fork failed\n");
    310f:	52                   	push   %edx
    3110:	52                   	push   %edx
    3111:	68 c5 48 00 00       	push   $0x48c5
    3116:	ff 35 b0 51 00 00    	push   0x51b0
    311c:	e8 8f 05 00 00       	call   36b0 <printf>
    exit();
...
00003128 <fsfull>:
{
  ...
  printf(1, "fsfull test\n");
    3131:	68 f3 48 00 00       	push   $0x48f3
    3136:	6a 01                	push   $0x1
    3138:	e8 73 05 00 00       	call   36b0 <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    31ae:	6a 01                	push   $0x1
    31b0:	e8 fb 04 00 00       	call   36b0 <printf>
    ...
    31d2:	51                   	push   %ecx
    31d3:	57                   	push   %edi
    31d4:	68 0c 49 00 00       	push   $0x490c
    31d9:	6a 01                	push   $0x1
    31db:	e8 d0 04 00 00       	call   36b0 <printf>
      break;
  ...
  printf(1, "fsfull test finished\n");
    ...
    3254:	68 2c 49 00 00       	push   $0x492c
    3259:	6a 01                	push   $0x1
    325b:	e8 50 04 00 00       	call   36b0 <printf>
}
    ...
    328d:	50                   	push   %eax
    328e:	56                   	push   %esi
    328f:	68 1c 49 00 00       	push   $0x491c
    3294:	6a 01                	push   $0x1
    3296:	e8 15 04 00 00       	call   36b0 <printf>
    close(fd);
...
000032bc <uio>:
{
  ...
  printf(1, "uio test\n");
    32c2:	68 42 49 00 00       	push   $0x4942
    32c7:	6a 01                	push   $0x1
    32c9:	e8 e2 03 00 00       	call   36b0 <printf>
  pid = fork();
  ...
  printf(1, "uio test done\n");
    ...
    32e4:	68 4c 49 00 00       	push   $0x494c
    32e9:	6a 01                	push   $0x1
    32eb:	e8 c0 03 00 00       	call   36b0 <printf>
}
    ...
    3303:	52                   	push   %edx
    3304:	52                   	push   %edx
    3305:	68 e0 50 00 00       	push   $0x50e0
    330a:	6a 01                	push   $0x1
    330c:	e8 9f 03 00 00       	call   36b0 <printf>
    exit();
    3311:	e8 65 02 00 00       	call   357b <exit>
    printf (1, "fork failed\n");
    3316:	50                   	push   %eax
    3317:	50                   	push   %eax
    3318:	68 d1 48 00 00       	push   $0x48d1
    331d:	6a 01                	push   $0x1
    331f:	e8 8c 03 00 00       	call   36b0 <printf>
    exit();
...
0000332c <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    3333:	6a 00                	push   $0x0
    3335:	68 5b 49 00 00       	push   $0x495b
  ...
  printf(1, "arg test passed\n");
    3367:	58                   	pop    %eax
    3368:	5a                   	pop    %edx
    3369:	68 6d 49 00 00       	push   $0x496d
    336e:	6a 01                	push   $0x1
    3370:	e8 3b 03 00 00       	call   36b0 <printf>
}
    ...
    337d:	51                   	push   %ecx
    337e:	51                   	push   %ecx
    337f:	68 60 49 00 00       	push   $0x4960
    3384:	6a 02                	push   $0x2
    3386:	e8 25 03 00 00       	call   36b0 <printf>
    exit();
    338b:	e8 eb 01 00 00       	call   357b <exit>

00003390 <rand>:
  randstate = randstate * 1664525 + 1013904223;
    3390:	a1 ac 51 00 00       	mov    0x51ac,%eax
    ...
    33b2:	a3 ac 51 00 00       	mov    %eax,0x51ac
}
    33b7:	c3                   	ret
...
printint(int fd, int xx, int base, int sgn)
{
    ...
    3628:	56                   	push   %esi
    3629:	53                   	push   %ebx
    362a:	83 ec 3c             	sub    $0x3c,%esp
    362d:	89 45 c0             	mov    %eax,-0x40(%ebp)
    3630:	89 cb                	mov    %ecx,%ebx
  char buf[16];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
    3632:	8b 4d 08             	mov    0x8(%ebp),%ecx
    3635:	85 c9                	test   %ecx,%ecx
    3637:	74 04                	je     363d <printint+0x19>
    3639:	85 d2                	test   %edx,%edx
    363b:	78 6b                	js     36a8 <printint+0x84>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
    363d:	89 55 c4             	mov    %edx,-0x3c(%ebp)
  neg = 0;
    3640:	c7 45 08 00 00 00 00 	movl   $0x0,0x8(%ebp)
  }

  i = 0;
    3647:	31 c9                	xor    %ecx,%ecx
    3649:	8d 75 d7             	lea    -0x29(%ebp),%esi
  do{
    buf[i++] = digits[x % base];
    364c:	8b 45 c4             	mov    -0x3c(%ebp),%eax
    364f:	31 d2                	xor    %edx,%edx
    3651:	f7 f3                	div    %ebx
    3653:	89 cf                	mov    %ecx,%edi
    3655:	8d 49 01             	lea    0x1(%ecx),%ecx
    3658:	8a 92 98 51 00 00    	mov    0x5198(%edx),%dl
    365e:	88 54 3e 01          	mov    %dl,0x1(%esi,%edi,1)
  }while((x /= base) != 0);
    3662:	8b 55 c4             	mov    -0x3c(%ebp),%edx
    3665:	89 45 c4             	mov    %eax,-0x3c(%ebp)
    3668:	39 da                	cmp    %ebx,%edx
    366a:	73 e0                	jae    364c <printint+0x28>
  if(neg)
    366c:	8b 55 08             	mov    0x8(%ebp),%edx
    366f:	85 d2                	test   %edx,%edx
    3671:	74 07                	je     367a <printint+0x56>
    buf[i++] = '-';
    3673:	c6 44 0d d8 2d       	movb   $0x2d,-0x28(%ebp,%ecx,1)
    3678:	89 cf                	mov    %ecx,%edi

  while(--i >= 0)
    367a:	8d 5d d8             	lea    -0x28(%ebp),%ebx
    367d:	8d 7c 3d d8          	lea    -0x28(%ebp,%edi,1),%edi
    3681:	8d 76 00             	lea    0x0(%esi),%esi
    putc(fd, buf[i]);
    3684:	8a 07                	mov    (%edi),%al
    3686:	88 45 d7             	mov    %al,-0x29(%ebp)
  write(fd, &c, 1);
    3689:	50                   	push   %eax
    368a:	6a 01                	push   $0x1
    368c:	56                   	push   %esi
    368d:	ff 75 c0             	push   -0x40(%ebp)
    3690:	e8 06 ff ff ff       	call   359b <write>
  while(--i >= 0)
    3695:	89 f8                	mov    %edi,%eax
    3697:	4f                   	dec    %edi
    3698:	83 c4 10             	add    $0x10,%esp
    369b:	39 d8                	cmp    %ebx,%eax
    369d:	75 e5                	jne    3684 <printint+0x60>
}
    369f:	8d 65 f4             	lea    -0xc(%ebp),%esp
    36a2:	5b                   	pop    %ebx
    36a3:	5e                   	pop    %esi
    36a4:	5f                   	pop    %edi
    36a5:	5d                   	pop    %ebp
    ...
    x = -xx;
    36a8:	f7 da                	neg    %edx
    36aa:	89 55 c4             	mov    %edx,-0x3c(%ebp)
    36ad:	eb 98                	jmp    3647 <printint+0x23>
    36af:	90                   	nop
...
printf(int fd, const char *fmt, ...)
{
    ...
    36b4:	56                   	push   %esi
    36b5:	53                   	push   %ebx
    36b6:	83 ec 2c             	sub    $0x2c,%esp
    36b9:	8b 75 08             	mov    0x8(%ebp),%esi
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    36bc:	8b 5d 0c             	mov    0xc(%ebp),%ebx
    36bf:	8a 03                	mov    (%ebx),%al
    36c1:	84 c0                	test   %al,%al
    36c3:	74 2a                	je     36ef <printf+0x3f>
    36c5:	43                   	inc    %ebx
  ap = (uint*)(void*)&fmt + 1;
    36c6:	8d 4d 10             	lea    0x10(%ebp),%ecx
    36c9:	89 4d d4             	mov    %ecx,-0x2c(%ebp)
    c = fmt[i] & 0xff;
    36cc:	0f b6 d0             	movzbl %al,%edx
    if(state == 0){
      if(c == '%'){
    36cf:	83 fa 25             	cmp    $0x25,%edx
    36d2:	74 24                	je     36f8 <printf+0x48>
        state = '%';
      } else {
        putc(fd, c);
    36d4:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
    36d7:	50                   	push   %eax
    36d8:	6a 01                	push   $0x1
    36da:	8d 45 e7             	lea    -0x19(%ebp),%eax
    36dd:	50                   	push   %eax
    36de:	56                   	push   %esi
    36df:	e8 b7 fe ff ff       	call   359b <write>
  for(i = 0; fmt[i]; i++){
    36e4:	43                   	inc    %ebx
    36e5:	8a 43 ff             	mov    -0x1(%ebx),%al
    36e8:	83 c4 10             	add    $0x10,%esp
    36eb:	84 c0                	test   %al,%al
    36ed:	75 dd                	jne    36cc <printf+0x1c>
        putc(fd, c);
      }
      state = 0;
    }
    ...
    36f7:	90                   	nop
  for(i = 0; fmt[i]; i++){
    36f8:	8a 13                	mov    (%ebx),%dl
    36fa:	84 d2                	test   %dl,%dl
    36fc:	74 f1                	je     36ef <printf+0x3f>
    c = fmt[i] & 0xff;
    36fe:	0f b6 c2             	movzbl %dl,%eax
      if(c == 'd'){
    3701:	80 fa 25             	cmp    $0x25,%dl
    3704:	0f 84 fe 00 00 00    	je     3808 <printf+0x158>
    370a:	83 e8 63             	sub    $0x63,%eax
    370d:	83 f8 15             	cmp    $0x15,%eax
    3710:	77 0a                	ja     371c <printf+0x6c>
    3712:	ff 24 85 40 51 00 00 	jmp    *0x5140(,%eax,4)
    3719:	8d 76 00             	lea    0x0(%esi),%esi
    371c:	88 55 d0             	mov    %dl,-0x30(%ebp)
        putc(fd, '%');
    371f:	c6 45 e7 25          	movb   $0x25,-0x19(%ebp)
  write(fd, &c, 1);
    3723:	50                   	push   %eax
    3724:	6a 01                	push   $0x1
    3726:	8d 7d e7             	lea    -0x19(%ebp),%edi
    3729:	57                   	push   %edi
    372a:	56                   	push   %esi
    372b:	e8 6b fe ff ff       	call   359b <write>
        putc(fd, c);
    3730:	8a 55 d0             	mov    -0x30(%ebp),%dl
    3733:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
    3736:	83 c4 0c             	add    $0xc,%esp
    3739:	6a 01                	push   $0x1
    373b:	57                   	push   %edi
    373c:	56                   	push   %esi
    373d:	e8 59 fe ff ff       	call   359b <write>
  for(i = 0; fmt[i]; i++){
    3742:	83 c3 02             	add    $0x2,%ebx
    3745:	8a 43 ff             	mov    -0x1(%ebx),%al
    3748:	83 c4 10             	add    $0x10,%esp
    374b:	84 c0                	test   %al,%al
    374d:	0f 85 79 ff ff ff    	jne    36cc <printf+0x1c>
}
    3753:	8d 65 f4             	lea    -0xc(%ebp),%esp
    3756:	5b                   	pop    %ebx
    3757:	5e                   	pop    %esi
    3758:	5f                   	pop    %edi
    3759:	5d                   	pop    %ebp
    ...
    375b:	90                   	nop
        printint(fd, *ap, 16, 0);
    375c:	8b 7d d4             	mov    -0x2c(%ebp),%edi
    375f:	8b 17                	mov    (%edi),%edx
    3761:	83 ec 0c             	sub    $0xc,%esp
    3764:	6a 00                	push   $0x0
    3766:	b9 10 00 00 00       	mov    $0x10,%ecx
    376b:	89 f0                	mov    %esi,%eax
    376d:	e8 b2 fe ff ff       	call   3624 <printint>
        ap++;
    3772:	83 c7 04             	add    $0x4,%edi
    3775:	89 7d d4             	mov    %edi,-0x2c(%ebp)
  for(i = 0; fmt[i]; i++){
    3778:	eb c8                	jmp    3742 <printf+0x92>
    377a:	66 90                	xchg   %ax,%ax
        s = (char*)*ap;
    377c:	8b 4d d4             	mov    -0x2c(%ebp),%ecx
    377f:	8b 01                	mov    (%ecx),%eax
        ap++;
    3781:	83 c1 04             	add    $0x4,%ecx
    3784:	89 4d d4             	mov    %ecx,-0x2c(%ebp)
        if(s == 0)
    3787:	85 c0                	test   %eax,%eax
    3789:	0f 84 89 00 00 00    	je     3818 <printf+0x168>
        while(*s != 0){
    378f:	8a 10                	mov    (%eax),%dl
    3791:	84 d2                	test   %dl,%dl
    3793:	74 29                	je     37be <printf+0x10e>
    3795:	89 c7                	mov    %eax,%edi
    3797:	88 d0                	mov    %dl,%al
    3799:	8d 4d e7             	lea    -0x19(%ebp),%ecx
    379c:	89 5d d0             	mov    %ebx,-0x30(%ebp)
    379f:	89 fb                	mov    %edi,%ebx
    37a1:	89 cf                	mov    %ecx,%edi
    37a3:	90                   	nop
          putc(fd, *s);
    37a4:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
    37a7:	50                   	push   %eax
    37a8:	6a 01                	push   $0x1
    37aa:	57                   	push   %edi
    37ab:	56                   	push   %esi
    37ac:	e8 ea fd ff ff       	call   359b <write>
          s++;
    37b1:	43                   	inc    %ebx
        while(*s != 0){
    37b2:	8a 03                	mov    (%ebx),%al
    37b4:	83 c4 10             	add    $0x10,%esp
    37b7:	84 c0                	test   %al,%al
    37b9:	75 e9                	jne    37a4 <printf+0xf4>
    37bb:	8b 5d d0             	mov    -0x30(%ebp),%ebx
  for(i = 0; fmt[i]; i++){
    37be:	83 c3 02             	add    $0x2,%ebx
    37c1:	8a 43 ff             	mov    -0x1(%ebx),%al
    37c4:	84 c0                	test   %al,%al
    37c6:	0f 85 00 ff ff ff    	jne    36cc <printf+0x1c>
    37cc:	e9 1e ff ff ff       	jmp    36ef <printf+0x3f>
    37d1:	8d 76 00             	lea    0x0(%esi),%esi
        printint(fd, *ap, 10, 1);
    37d4:	8b 7d d4             	mov    -0x2c(%ebp),%edi
    37d7:	8b 17                	mov    (%edi),%edx
    37d9:	83 ec 0c             	sub    $0xc,%esp
    37dc:	6a 01                	push   $0x1
    37de:	b9 0a 00 00 00       	mov    $0xa,%ecx
    37e3:	eb 86                	jmp    376b <printf+0xbb>
    37e5:	8d 76 00             	lea    0x0(%esi),%esi
        putc(fd, *ap);
    37e8:	8b 45 d4             	mov    -0x2c(%ebp),%eax
    37eb:	8b 00                	mov    (%eax),%eax
    37ed:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
    37f0:	51                   	push   %ecx
    37f1:	6a 01                	push   $0x1
    37f3:	8d 7d e7             	lea    -0x19(%ebp),%edi
    37f6:	57                   	push   %edi
    37f7:	56                   	push   %esi
    37f8:	e8 9e fd ff ff       	call   359b <write>
        ap++;
    37fd:	83 45 d4 04          	addl   $0x4,-0x2c(%ebp)
    3801:	e9 3c ff ff ff       	jmp    3742 <printf+0x92>
    3806:	66 90                	xchg   %ax,%ax
        putc(fd, c);
    3808:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
    380b:	52                   	push   %edx
    380c:	6a 01                	push   $0x1
    380e:	8d 7d e7             	lea    -0x19(%ebp),%edi
    3811:	e9 25 ff ff ff       	jmp    373b <printf+0x8b>
    3816:	66 90                	xchg   %ax,%ax
          s = "(null)";
    3818:	bf b1 49 00 00       	mov    $0x49b1,%edi
    381d:	b0 28                	mov    $0x28,%al
    381f:	e9 75 ff ff ff       	jmp    3799 <printf+0xe9>
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    3902:	56                   	push   %esi
    3903:	e8 fb fc ff ff       	call   3603 <sbrk>
  if(p == (char*)-1)
