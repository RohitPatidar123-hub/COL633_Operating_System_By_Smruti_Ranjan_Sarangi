...
main(int argc, char *argv[])
{
  ...
  5a:	52                   	push   %edx
  5b:	52                   	push   %edx
  5c:	68 48 06 00 00       	push   $0x648
  61:	6a 02                	push   $0x2
  63:	e8 00 03 00 00       	call   368 <printf>
    exit();
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 2ed:	85 c9                	test   %ecx,%ecx
 2ef:	74 04                	je     2f5 <printint+0x19>
 2f1:	85 d2                	test   %edx,%edx
 2f3:	78 6b                	js     360 <printint+0x84>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
 2f5:	89 55 c4             	mov    %edx,-0x3c(%ebp)
  neg = 0;
 ...
 301:	8d 75 d7             	lea    -0x29(%ebp),%esi
  do{
    buf[i++] = digits[x % base];
 304:	8b 45 c4             	mov    -0x3c(%ebp),%eax
 307:	31 d2                	xor    %edx,%edx
 309:	f7 f3                	div    %ebx
 30b:	89 cf                	mov    %ecx,%edi
 30d:	8d 49 01             	lea    0x1(%ecx),%ecx
 310:	8a 92 d4 06 00 00    	mov    0x6d4(%edx),%dl
 316:	88 54 3e 01          	mov    %dl,0x1(%esi,%edi,1)
  }while((x /= base) != 0);
 31a:	8b 55 c4             	mov    -0x3c(%ebp),%edx
 31d:	89 45 c4             	mov    %eax,-0x3c(%ebp)
 320:	39 da                	cmp    %ebx,%edx
 322:	73 e0                	jae    304 <printint+0x28>
  if(neg)
 324:	8b 55 08             	mov    0x8(%ebp),%edx
 327:	85 d2                	test   %edx,%edx
 329:	74 07                	je     332 <printint+0x56>
    buf[i++] = '-';
 32b:	c6 44 0d d8 2d       	movb   $0x2d,-0x28(%ebp,%ecx,1)
 330:	89 cf                	mov    %ecx,%edi

  while(--i >= 0)
 332:	8d 5d d8             	lea    -0x28(%ebp),%ebx
 335:	8d 7c 3d d8          	lea    -0x28(%ebp,%edi,1),%edi
 339:	8d 76 00             	lea    0x0(%esi),%esi
    putc(fd, buf[i]);
 33c:	8a 07                	mov    (%edi),%al
 33e:	88 45 d7             	mov    %al,-0x29(%ebp)
  write(fd, &c, 1);
 341:	50                   	push   %eax
 342:	6a 01                	push   $0x1
 344:	56                   	push   %esi
 345:	ff 75 c0             	push   -0x40(%ebp)
 348:	e8 06 ff ff ff       	call   253 <write>
  while(--i >= 0)
 34d:	89 f8                	mov    %edi,%eax
 34f:	4f                   	dec    %edi
 350:	83 c4 10             	add    $0x10,%esp
 353:	39 d8                	cmp    %ebx,%eax
 355:	75 e5                	jne    33c <printint+0x60>
}
 ...
 35f:	90                   	nop
    x = -xx;
 360:	f7 da                	neg    %edx
 362:	89 55 c4             	mov    %edx,-0x3c(%ebp)
 365:	eb 98                	jmp    2ff <printint+0x23>
 367:	90                   	nop
...
printf(int fd, const char *fmt, ...)
{
 ...
 37b:	74 2a                	je     3a7 <printf+0x3f>
 37d:	43                   	inc    %ebx
  ap = (uint*)(void*)&fmt + 1;
 37e:	8d 4d 10             	lea    0x10(%ebp),%ecx
 381:	89 4d d4             	mov    %ecx,-0x2c(%ebp)
    c = fmt[i] & 0xff;
 384:	0f b6 d0             	movzbl %al,%edx
    if(state == 0){
      if(c == '%'){
 387:	83 fa 25             	cmp    $0x25,%edx
 38a:	74 24                	je     3b0 <printf+0x48>
        state = '%';
      } else {
        putc(fd, c);
 ...
 395:	50                   	push   %eax
 396:	56                   	push   %esi
 397:	e8 b7 fe ff ff       	call   253 <write>
  for(i = 0; fmt[i]; i++){
 39c:	43                   	inc    %ebx
 39d:	8a 43 ff             	mov    -0x1(%ebx),%al
 3a0:	83 c4 10             	add    $0x10,%esp
 3a3:	84 c0                	test   %al,%al
 3a5:	75 dd                	jne    384 <printf+0x1c>
        putc(fd, c);
      }
      state = 0;
    }
 ...
 3b2:	84 d2                	test   %dl,%dl
 3b4:	74 f1                	je     3a7 <printf+0x3f>
    c = fmt[i] & 0xff;
 3b6:	0f b6 c2             	movzbl %dl,%eax
      if(c == 'd'){
 3b9:	80 fa 25             	cmp    $0x25,%dl
 3bc:	0f 84 fe 00 00 00    	je     4c0 <printf+0x158>
 3c2:	83 e8 63             	sub    $0x63,%eax
 3c5:	83 f8 15             	cmp    $0x15,%eax
 3c8:	77 0a                	ja     3d4 <printf+0x6c>
 3ca:	ff 24 85 7c 06 00 00 	jmp    *0x67c(,%eax,4)
 3d1:	8d 76 00             	lea    0x0(%esi),%esi
 3d4:	88 55 d0             	mov    %dl,-0x30(%ebp)
        putc(fd, '%');
 3d7:	c6 45 e7 25          	movb   $0x25,-0x19(%ebp)
  write(fd, &c, 1);
 3db:	50                   	push   %eax
 3dc:	6a 01                	push   $0x1
 3de:	8d 7d e7             	lea    -0x19(%ebp),%edi
 3e1:	57                   	push   %edi
 3e2:	56                   	push   %esi
 3e3:	e8 6b fe ff ff       	call   253 <write>
        putc(fd, c);
 3e8:	8a 55 d0             	mov    -0x30(%ebp),%dl
 3eb:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
 3ee:	83 c4 0c             	add    $0xc,%esp
 3f1:	6a 01                	push   $0x1
 3f3:	57                   	push   %edi
 3f4:	56                   	push   %esi
 3f5:	e8 59 fe ff ff       	call   253 <write>
  for(i = 0; fmt[i]; i++){
 3fa:	83 c3 02             	add    $0x2,%ebx
 3fd:	8a 43 ff             	mov    -0x1(%ebx),%al
 400:	83 c4 10             	add    $0x10,%esp
 403:	84 c0                	test   %al,%al
 405:	0f 85 79 ff ff ff    	jne    384 <printf+0x1c>
}
 ...
 42d:	89 7d d4             	mov    %edi,-0x2c(%ebp)
  for(i = 0; fmt[i]; i++){
 430:	eb c8                	jmp    3fa <printf+0x92>
 432:	66 90                	xchg   %ax,%ax
        s = (char*)*ap;
 434:	8b 4d d4             	mov    -0x2c(%ebp),%ecx
 437:	8b 01                	mov    (%ecx),%eax
        ap++;
 439:	83 c1 04             	add    $0x4,%ecx
 43c:	89 4d d4             	mov    %ecx,-0x2c(%ebp)
        if(s == 0)
 43f:	85 c0                	test   %eax,%eax
 441:	0f 84 89 00 00 00    	je     4d0 <printf+0x168>
        while(*s != 0){
 447:	8a 10                	mov    (%eax),%dl
 449:	84 d2                	test   %dl,%dl
 44b:	74 29                	je     476 <printf+0x10e>
 44d:	89 c7                	mov    %eax,%edi
 44f:	88 d0                	mov    %dl,%al
 451:	8d 4d e7             	lea    -0x19(%ebp),%ecx
 454:	89 5d d0             	mov    %ebx,-0x30(%ebp)
 457:	89 fb                	mov    %edi,%ebx
 459:	89 cf                	mov    %ecx,%edi
 45b:	90                   	nop
          putc(fd, *s);
 ...
 462:	57                   	push   %edi
 463:	56                   	push   %esi
 464:	e8 ea fd ff ff       	call   253 <write>
          s++;
 469:	43                   	inc    %ebx
        while(*s != 0){
 ...
 471:	75 e9                	jne    45c <printf+0xf4>
 473:	8b 5d d0             	mov    -0x30(%ebp),%ebx
  for(i = 0; fmt[i]; i++){
 476:	83 c3 02             	add    $0x2,%ebx
 479:	8a 43 ff             	mov    -0x1(%ebx),%al
 47c:	84 c0                	test   %al,%al
 47e:	0f 85 00 ff ff ff    	jne    384 <printf+0x1c>
 484:	e9 1e ff ff ff       	jmp    3a7 <printf+0x3f>
 ...
 4ae:	57                   	push   %edi
 4af:	56                   	push   %esi
 4b0:	e8 9e fd ff ff       	call   253 <write>
        ap++;
 4b5:	83 45 d4 04          	addl   $0x4,-0x2c(%ebp)
 4b9:	e9 3c ff ff ff       	jmp    3fa <printf+0x92>
 ...
 4c3:	52                   	push   %edx
 4c4:	6a 01                	push   $0x1
 4c6:	8d 7d e7             	lea    -0x19(%ebp),%edi
 4c9:	e9 25 ff ff ff       	jmp    3f3 <printf+0x8b>
 4ce:	66 90                	xchg   %ax,%ax
          s = "(null)";
 4d0:	bf 75 06 00 00       	mov    $0x675,%edi
 4d5:	b0 28                	mov    $0x28,%al
 4d7:	e9 75 ff ff ff       	jmp    451 <printf+0xe9>
...
free(void *ap)
{
 ...
 4e8:	a1 e8 06 00 00       	mov    0x6e8,%eax
 ...
 517:	89 0a                	mov    %ecx,(%edx)
    ...
    p->s.ptr = bp;
  freep = p;
 519:	89 15 e8 06 00 00    	mov    %edx,0x6e8
}
 51f:	5b                   	pop    %ebx
 520:	5e                   	pop    %esi
 521:	5f                   	pop    %edi
 ...
 556:	89 0a                	mov    %ecx,(%edx)
  freep = p;
 558:	89 15 e8 06 00 00    	mov    %edx,0x6e8
}
 55e:	5b                   	pop    %ebx
 55f:	5e                   	pop    %esi
 560:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 576:	47                   	inc    %edi
  if((prevp = freep) == 0){
 577:	8b 15 e8 06 00 00    	mov    0x6e8,%edx
 ...
 5ad:	73 41                	jae    5f0 <malloc+0x8c>
    ...
    if(p == freep)
 5af:	39 05 e8 06 00 00    	cmp    %eax,0x6e8
 5b5:	75 ed                	jne    5a4 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
 5b7:	83 ec 0c             	sub    $0xc,%esp
 5ba:	56                   	push   %esi
 5bb:	e8 fb fc ff ff       	call   2bb <sbrk>
  if(p == (char*)-1)
 ...
 5d2:	e8 05 ff ff ff       	call   4dc <free>
  return freep;
 5d7:	8b 15 e8 06 00 00    	mov    0x6e8,%edx
 ...
 5fc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 5ff:	89 15 e8 06 00 00    	mov    %edx,0x6e8
      return (void*)(p + 1);
 ...
 617:	90                   	nop
    base.s.ptr = freep = prevp = &base;
 618:	c7 05 e8 06 00 00 ec 	movl   $0x6ec,0x6e8
 61f:	06 00 00 
 622:	c7 05 ec 06 00 00 ec 	movl   $0x6ec,0x6ec
 629:	06 00 00 
    base.s.size = 0;
 62c:	c7 05 f0 06 00 00 00 	movl   $0x0,0x6f0
 633:	00 00 00 
 636:	b8 ec 06 00 00       	mov    $0x6ec,%eax
