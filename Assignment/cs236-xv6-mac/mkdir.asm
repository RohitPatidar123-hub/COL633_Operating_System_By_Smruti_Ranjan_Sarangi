...
printint(int fd, int xx, int base, int sgn)
{
 ...
 308:	8a 92 d4 06 00 00    	mov    0x6d4(%edx),%dl
...
printf(int fd, const char *fmt, ...)
{
 ...
 3c2:	ff 24 85 7c 06 00 00 	jmp    *0x67c(,%eax,4)
 ...
 4c6:	66 90                	xchg   %ax,%ax
          s = "(null)";
 4c8:	bf 73 06 00 00       	mov    $0x673,%edi
...
free(void *ap)
{
 ...
 4e0:	a1 e8 06 00 00       	mov    0x6e8,%eax
 ...
 50f:	89 0a                	mov    %ecx,(%edx)
    ...
    p->s.ptr = bp;
  freep = p;
 511:	89 15 e8 06 00 00    	mov    %edx,0x6e8
}
 517:	5b                   	pop    %ebx
 518:	5e                   	pop    %esi
 519:	5f                   	pop    %edi
 ...
 54e:	89 0a                	mov    %ecx,(%edx)
  freep = p;
 550:	89 15 e8 06 00 00    	mov    %edx,0x6e8
}
 556:	5b                   	pop    %ebx
 557:	5e                   	pop    %esi
 558:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 56e:	47                   	inc    %edi
  if((prevp = freep) == 0){
 56f:	8b 15 e8 06 00 00    	mov    0x6e8,%edx
 ...
 5a5:	73 41                	jae    5e8 <malloc+0x8c>
    ...
    if(p == freep)
 5a7:	39 05 e8 06 00 00    	cmp    %eax,0x6e8
 ...
 5ca:	e8 05 ff ff ff       	call   4d4 <free>
  return freep;
 5cf:	8b 15 e8 06 00 00    	mov    0x6e8,%edx
 ...
 5f4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 5f7:	89 15 e8 06 00 00    	mov    %edx,0x6e8
      return (void*)(p + 1);
 ...
 60f:	90                   	nop
    base.s.ptr = freep = prevp = &base;
 610:	c7 05 e8 06 00 00 ec 	movl   $0x6ec,0x6e8
 617:	06 00 00 
 61a:	c7 05 ec 06 00 00 ec 	movl   $0x6ec,0x6ec
 621:	06 00 00 
    base.s.size = 0;
 624:	c7 05 f0 06 00 00 00 	movl   $0x0,0x6f0
 62b:	00 00 00 
 62e:	b8 ec 06 00 00       	mov    $0x6ec,%eax
