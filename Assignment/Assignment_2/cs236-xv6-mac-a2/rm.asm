...
printint(int fd, int xx, int base, int sgn)
{
 ...
 320:	8a 92 e4 06 00 00    	mov    0x6e4(%edx),%dl
...
printf(int fd, const char *fmt, ...)
{
 ...
 3da:	ff 24 85 8c 06 00 00 	jmp    *0x68c(,%eax,4)
 ...
 4de:	66 90                	xchg   %ax,%ax
          s = "(null)";
 4e0:	bf 85 06 00 00       	mov    $0x685,%edi
...
free(void *ap)
{
 ...
 4f8:	a1 f8 06 00 00       	mov    0x6f8,%eax
 ...
 527:	89 0a                	mov    %ecx,(%edx)
    ...
    p->s.ptr = bp;
  freep = p;
 529:	89 15 f8 06 00 00    	mov    %edx,0x6f8
}
 52f:	5b                   	pop    %ebx
 530:	5e                   	pop    %esi
 531:	5f                   	pop    %edi
 ...
 566:	89 0a                	mov    %ecx,(%edx)
  freep = p;
 568:	89 15 f8 06 00 00    	mov    %edx,0x6f8
}
 56e:	5b                   	pop    %ebx
 56f:	5e                   	pop    %esi
 570:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 586:	47                   	inc    %edi
  if((prevp = freep) == 0){
 587:	8b 15 f8 06 00 00    	mov    0x6f8,%edx
 ...
 5bd:	73 41                	jae    600 <malloc+0x8c>
    ...
    if(p == freep)
 5bf:	39 05 f8 06 00 00    	cmp    %eax,0x6f8
 ...
 5e2:	e8 05 ff ff ff       	call   4ec <free>
  return freep;
 5e7:	8b 15 f8 06 00 00    	mov    0x6f8,%edx
 ...
 60c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 60f:	89 15 f8 06 00 00    	mov    %edx,0x6f8
      return (void*)(p + 1);
 ...
 627:	90                   	nop
    base.s.ptr = freep = prevp = &base;
 628:	c7 05 f8 06 00 00 fc 	movl   $0x6fc,0x6f8
 62f:	06 00 00 
 632:	c7 05 fc 06 00 00 fc 	movl   $0x6fc,0x6fc
 639:	06 00 00 
    base.s.size = 0;
 63c:	c7 05 00 07 00 00 00 	movl   $0x0,0x700
 643:	00 00 00 
 646:	b8 fc 06 00 00       	mov    $0x6fc,%eax
