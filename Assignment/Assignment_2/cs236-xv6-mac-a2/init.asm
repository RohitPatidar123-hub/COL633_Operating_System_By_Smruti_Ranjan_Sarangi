...
main(void)
{
  ...
  12:	6a 02                	push   $0x2
  14:	68 b8 06 00 00       	push   $0x6b8
  19:	e8 b5 02 00 00       	call   2d3 <open>
  1e:	83 c4 10             	add    $0x10,%esp
  21:	85 c0                	test   %eax,%eax
  23:	0f 88 81 00 00 00    	js     aa <main+0xaa>
    mknod("console", 1, 1);
    open("console", O_RDWR);
  }
  dup(0);  // stdout
  ...
  2c:	6a 00                	push   $0x0
  2e:	e8 d8 02 00 00       	call   30b <dup>
  dup(0);  // stderr
  33:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  3a:	e8 cc 02 00 00       	call   30b <dup>
  ...
  47:	68 c0 06 00 00       	push   $0x6c0
  4c:	6a 01                	push   $0x1
  4e:	e8 85 03 00 00       	call   3d8 <printf>
    pid = fork();
  53:	e8 33 02 00 00       	call   28b <fork>
  58:	89 c3                	mov    %eax,%ebx
    if(pid < 0){
  5a:	83 c4 10             	add    $0x10,%esp
  5d:	85 c0                	test   %eax,%eax
  5f:	78 12                	js     73 <main+0x73>
      printf(1, "init: fork failed\n");
      exit();
    }
    if(pid == 0){
  61:	74 23                	je     86 <main+0x86>
  63:	90                   	nop
      exec("sh", argv);
  ...
  64:	e8 32 02 00 00       	call   29b <wait>
  69:	85 c0                	test   %eax,%eax
  6b:	78 d7                	js     44 <main+0x44>
  6d:	39 c3                	cmp    %eax,%ebx
  6f:	75 f3                	jne    64 <main+0x64>
  71:	eb d1                	jmp    44 <main+0x44>
      printf(1, "init: fork failed\n");
  73:	53                   	push   %ebx
  74:	53                   	push   %ebx
  75:	68 d3 06 00 00       	push   $0x6d3
  7a:	6a 01                	push   $0x1
  7c:	e8 57 03 00 00       	call   3d8 <printf>
      exit();
  81:	e8 0d 02 00 00       	call   293 <exit>
      exec("sh", argv);
  86:	50                   	push   %eax
  87:	50                   	push   %eax
  88:	68 74 07 00 00       	push   $0x774
  8d:	68 e6 06 00 00       	push   $0x6e6
  92:	e8 34 02 00 00       	call   2cb <exec>
      printf(1, "init: exec sh failed\n");
  97:	5a                   	pop    %edx
  98:	59                   	pop    %ecx
  99:	68 e9 06 00 00       	push   $0x6e9
  9e:	6a 01                	push   $0x1
  a0:	e8 33 03 00 00       	call   3d8 <printf>
      exit();
  a5:	e8 e9 01 00 00       	call   293 <exit>
    mknod("console", 1, 1);
  aa:	50                   	push   %eax
  ab:	6a 01                	push   $0x1
  ad:	6a 01                	push   $0x1
  af:	68 b8 06 00 00       	push   $0x6b8
  b4:	e8 22 02 00 00       	call   2db <mknod>
    open("console", O_RDWR);
  b9:	58                   	pop    %eax
  ba:	5a                   	pop    %edx
  bb:	6a 02                	push   $0x2
  bd:	68 b8 06 00 00       	push   $0x6b8
  c2:	e8 0c 02 00 00       	call   2d3 <open>
  c7:	83 c4 10             	add    $0x10,%esp
  ca:	e9 5a ff ff ff       	jmp    29 <main+0x29>
  cf:	90                   	nop
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 380:	8a 92 60 07 00 00    	mov    0x760(%edx),%dl
...
printf(int fd, const char *fmt, ...)
{
 ...
 43a:	ff 24 85 08 07 00 00 	jmp    *0x708(,%eax,4)
 ...
 53e:	66 90                	xchg   %ax,%ax
          s = "(null)";
 540:	bf ff 06 00 00       	mov    $0x6ff,%edi
...
free(void *ap)
{
 ...
 558:	a1 7c 07 00 00       	mov    0x77c,%eax
 ...
 587:	89 0a                	mov    %ecx,(%edx)
    ...
    p->s.ptr = bp;
  freep = p;
 589:	89 15 7c 07 00 00    	mov    %edx,0x77c
}
 58f:	5b                   	pop    %ebx
 590:	5e                   	pop    %esi
 591:	5f                   	pop    %edi
 ...
 5c6:	89 0a                	mov    %ecx,(%edx)
  freep = p;
 5c8:	89 15 7c 07 00 00    	mov    %edx,0x77c
}
 5ce:	5b                   	pop    %ebx
 5cf:	5e                   	pop    %esi
 5d0:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 5e6:	47                   	inc    %edi
  if((prevp = freep) == 0){
 5e7:	8b 15 7c 07 00 00    	mov    0x77c,%edx
 ...
 61d:	73 41                	jae    660 <malloc+0x8c>
    ...
    if(p == freep)
 61f:	39 05 7c 07 00 00    	cmp    %eax,0x77c
 ...
 642:	e8 05 ff ff ff       	call   54c <free>
  return freep;
 647:	8b 15 7c 07 00 00    	mov    0x77c,%edx
 ...
 66c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 66f:	89 15 7c 07 00 00    	mov    %edx,0x77c
      return (void*)(p + 1);
 ...
 687:	90                   	nop
    base.s.ptr = freep = prevp = &base;
 688:	c7 05 7c 07 00 00 80 	movl   $0x780,0x77c
 68f:	07 00 00 
 692:	c7 05 80 07 00 00 80 	movl   $0x780,0x780
 699:	07 00 00 
    base.s.size = 0;
 69c:	c7 05 84 07 00 00 00 	movl   $0x0,0x784
 6a3:	00 00 00 
 6a6:	b8 80 07 00 00       	mov    $0x780,%eax
