...
00000038 <forktest>:
{
  ...
  8f:	68 ae 03 00 00       	push   $0x3ae
  94:	e8 cb 00 00 00       	call   164 <strlen>
  99:	83 c4 0c             	add    $0xc,%esp
  9c:	50                   	push   %eax
  9d:	68 ae 03 00 00       	push   $0x3ae
  a2:	6a 01                	push   $0x1
  ...
  b6:	68 87 03 00 00       	push   $0x387
  bb:	e8 a4 00 00 00       	call   164 <strlen>
  c0:	83 c4 0c             	add    $0xc,%esp
  c3:	50                   	push   %eax
  c4:	68 87 03 00 00       	push   $0x387
  c9:	6a 01                	push   $0x1
...
0000036b <custom_fork>:
SYSCALL(custom_fork)
 36b:	b8 17 00 00 00       	mov    $0x17,%eax
 370:	cd 40                	int    $0x40
 372:	c3                   	ret

00000373 <scheduler_start>:
