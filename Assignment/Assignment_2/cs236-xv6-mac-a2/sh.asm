...
fork1(void)
{
  ...
  printf(2, "$ ");
      ...
      67:	6a 02                	push   $0x2
      69:	e8 7e 0d 00 00       	call   dec <printf>
  memset(buf, 0, nbuf);
  ...
  exit();
     ...
     106:	6a 02                	push   $0x2
     108:	e8 df 0c 00 00       	call   dec <printf>
...
00000124 <getcmd>:
{
  ...
  printf(2, "$ ");
     ...
     137:	6a 02                	push   $0x2
     139:	e8 ae 0c 00 00       	call   dec <printf>
  memset(buf, 0, nbuf);
...
00000164 <panic>:
{
  ...
  printf(2, "%s\n", s);
     ...
     172:	6a 02                	push   $0x2
     174:	e8 73 0c 00 00       	call   dec <printf>
  exit();
...
000001a0 <runcmd>:
{
  ...
  switch(cmd->type){
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     1de:	6a 02                	push   $0x2
     1e0:	e8 07 0c 00 00       	call   dec <printf>
    break;
    ...
    panic("runcmd");
     ...
     2b3:	6a 02                	push   $0x2
     2b5:	e8 32 0b 00 00       	call   dec <printf>
      exit();
...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4a7:	50                   	push   %eax
     4a8:	68 30 12 00 00       	push   $0x1230
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     593:	50                   	push   %eax
     594:	68 30 12 00 00       	push   $0x1230
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     5e7:	90                   	nop
     5e8:	50                   	push   %eax
     5e9:	68 1d 11 00 00       	push   $0x111d
     5ee:	53                   	push   %ebx
     5ef:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     646:	6a 18                	push   $0x18
     648:	e8 9b 09 00 00       	call   fe8 <malloc>
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     69f:	6a 18                	push   $0x18
     6a1:	e8 42 09 00 00       	call   fe8 <malloc>
  ...
  return cmd;
     ...
     6f6:	68 00 11 00 00       	push   $0x1100
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     70f:	68 20 11 00 00       	push   $0x1120
     714:	56                   	push   %esi
     715:	53                   	push   %ebx
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     72b:	6a 54                	push   $0x54
     72d:	e8 b6 08 00 00       	call   fe8 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  while(!peek(ps, es, "|)&;")){
     771:	50                   	push   %eax
     772:	68 37 11 00 00       	push   $0x1137
     777:	56                   	push   %esi
     778:	53                   	push   %ebx
    ...
    if(argc >= MAXARGS)
     ...
     7ba:	68 29 11 00 00       	push   $0x1129
  ...
  cmd->eargv[argc] = 0;
     ...
     7f9:	68 22 11 00 00       	push   $0x1122
...
00000804 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     81f:	68 3c 11 00 00       	push   $0x113c
     824:	57                   	push   %edi
     825:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     859:	e8 8a 07 00 00       	call   fe8 <malloc>
...
00000888 <parseline>:
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     8ba:	e8 29 07 00 00       	call   fe8 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  while(peek(ps, es, "&")){
     8e0:	50                   	push   %eax
     8e1:	68 3e 11 00 00       	push   $0x113e
     8e6:	57                   	push   %edi
     8e7:	56                   	push   %esi
  ...
  if(peek(ps, es, ";")){
     8f4:	51                   	push   %ecx
     8f5:	68 3a 11 00 00       	push   $0x113a
     8fa:	57                   	push   %edi
     8fb:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     931:	e8 b2 06 00 00       	call   fe8 <malloc>
...
00000960 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     96f:	68 20 11 00 00       	push   $0x1120
     974:	56                   	push   %esi
     975:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     ...
     99b:	68 5c 11 00 00       	push   $0x115c
     9a0:	56                   	push   %esi
     9a1:	53                   	push   %ebx
...
00000a7c <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     aa1:	68 ea 10 00 00       	push   $0x10ea
     aa6:	53                   	push   %ebx
     aa7:	57                   	push   %edi
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     aca:	52                   	push   %edx
     acb:	50                   	push   %eax
     acc:	68 5e 11 00 00       	push   $0x115e
     ad1:	6a 02                	push   $0x2
     ad3:	e8 14 03 00 00       	call   dec <printf>
    panic("syntax");
     ad8:	c7 04 24 22 11 00 00 	movl   $0x1122,(%esp)
...
00000d4f <custom_fork>:
SYSCALL(custom_fork)
     d4f:	b8 17 00 00 00       	mov    $0x17,%eax
     d54:	cd 40                	int    $0x40
     d56:	c3                   	ret

00000d57 <scheduler_start>:
     d57:	b8 18 00 00 00       	mov    $0x18,%eax
     d5c:	cd 40                	int    $0x40
     d5e:	c3                   	ret
     d5f:	90                   	nop
...
printint(int fd, int xx, int base, int sgn)
{
     ...
     d69:	89 45 c0             	mov    %eax,-0x40(%ebp)
     d6c:	89 cb                	mov    %ecx,%ebx
  char buf[16];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
     d6e:	8b 4d 08             	mov    0x8(%ebp),%ecx
     d71:	85 c9                	test   %ecx,%ecx
     d73:	74 04                	je     d79 <printint+0x19>
     d75:	85 d2                	test   %edx,%edx
     d77:	78 6b                	js     de4 <printint+0x84>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
     d79:	89 55 c4             	mov    %edx,-0x3c(%ebp)
  neg = 0;
  ...
  do{
    buf[i++] = digits[x % base];
     d88:	8b 45 c4             	mov    -0x3c(%ebp),%eax
     d8b:	31 d2                	xor    %edx,%edx
     d8d:	f7 f3                	div    %ebx
     d8f:	89 cf                	mov    %ecx,%edi
     d91:	8d 49 01             	lea    0x1(%ecx),%ecx
     d94:	8a 92 14 12 00 00    	mov    0x1214(%edx),%dl
     d9a:	88 54 3e 01          	mov    %dl,0x1(%esi,%edi,1)
  }while((x /= base) != 0);
     d9e:	8b 55 c4             	mov    -0x3c(%ebp),%edx
     da1:	89 45 c4             	mov    %eax,-0x3c(%ebp)
     da4:	39 da                	cmp    %ebx,%edx
     da6:	73 e0                	jae    d88 <printint+0x28>
  if(neg)
     da8:	8b 55 08             	mov    0x8(%ebp),%edx
     dab:	85 d2                	test   %edx,%edx
     dad:	74 07                	je     db6 <printint+0x56>
    buf[i++] = '-';
     daf:	c6 44 0d d8 2d       	movb   $0x2d,-0x28(%ebp,%ecx,1)
     db4:	89 cf                	mov    %ecx,%edi

  while(--i >= 0)
     db6:	8d 5d d8             	lea    -0x28(%ebp),%ebx
     db9:	8d 7c 3d d8          	lea    -0x28(%ebp,%edi,1),%edi
     dbd:	8d 76 00             	lea    0x0(%esi),%esi
    putc(fd, buf[i]);
     dc0:	8a 07                	mov    (%edi),%al
     dc2:	88 45 d7             	mov    %al,-0x29(%ebp)
  write(fd, &c, 1);
     dc5:	50                   	push   %eax
     dc6:	6a 01                	push   $0x1
     dc8:	56                   	push   %esi
     dc9:	ff 75 c0             	push   -0x40(%ebp)
     dcc:	e8 f6 fe ff ff       	call   cc7 <write>
  while(--i >= 0)
     dd1:	89 f8                	mov    %edi,%eax
     dd3:	4f                   	dec    %edi
     dd4:	83 c4 10             	add    $0x10,%esp
     dd7:	39 d8                	cmp    %ebx,%eax
     dd9:	75 e5                	jne    dc0 <printint+0x60>
}
    ...
    x = -xx;
     de4:	f7 da                	neg    %edx
     de6:	89 55 c4             	mov    %edx,-0x3c(%ebp)
     de9:	eb 98                	jmp    d83 <printint+0x23>
     deb:	90                   	nop
...
printf(int fd, const char *fmt, ...)
{
     ...
     df0:	56                   	push   %esi
     df1:	53                   	push   %ebx
     df2:	83 ec 2c             	sub    $0x2c,%esp
     df5:	8b 75 08             	mov    0x8(%ebp),%esi
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
     df8:	8b 5d 0c             	mov    0xc(%ebp),%ebx
     dfb:	8a 03                	mov    (%ebx),%al
     dfd:	84 c0                	test   %al,%al
     dff:	74 2a                	je     e2b <printf+0x3f>
     e01:	43                   	inc    %ebx
  ap = (uint*)(void*)&fmt + 1;
     e02:	8d 4d 10             	lea    0x10(%ebp),%ecx
     e05:	89 4d d4             	mov    %ecx,-0x2c(%ebp)
    c = fmt[i] & 0xff;
     e08:	0f b6 d0             	movzbl %al,%edx
    if(state == 0){
      if(c == '%'){
     e0b:	83 fa 25             	cmp    $0x25,%edx
     e0e:	74 24                	je     e34 <printf+0x48>
        state = '%';
      } else {
        putc(fd, c);
     e10:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
     e13:	50                   	push   %eax
     e14:	6a 01                	push   $0x1
     e16:	8d 45 e7             	lea    -0x19(%ebp),%eax
     e19:	50                   	push   %eax
     e1a:	56                   	push   %esi
     e1b:	e8 a7 fe ff ff       	call   cc7 <write>
  for(i = 0; fmt[i]; i++){
     e20:	43                   	inc    %ebx
     e21:	8a 43 ff             	mov    -0x1(%ebx),%al
     e24:	83 c4 10             	add    $0x10,%esp
     e27:	84 c0                	test   %al,%al
     e29:	75 dd                	jne    e08 <printf+0x1c>
        putc(fd, c);
      }
      state = 0;
    }
     ...
     e33:	90                   	nop
  for(i = 0; fmt[i]; i++){
     e34:	8a 13                	mov    (%ebx),%dl
     e36:	84 d2                	test   %dl,%dl
     e38:	74 f1                	je     e2b <printf+0x3f>
    c = fmt[i] & 0xff;
     e3a:	0f b6 c2             	movzbl %dl,%eax
      if(c == 'd'){
     e3d:	80 fa 25             	cmp    $0x25,%dl
     e40:	0f 84 fe 00 00 00    	je     f44 <printf+0x158>
     e46:	83 e8 63             	sub    $0x63,%eax
     e49:	83 f8 15             	cmp    $0x15,%eax
     e4c:	77 0a                	ja     e58 <printf+0x6c>
     e4e:	ff 24 85 bc 11 00 00 	jmp    *0x11bc(,%eax,4)
  ...
  for(i = 0; fmt[i]; i++){
     e7e:	83 c3 02             	add    $0x2,%ebx
     e81:	8a 43 ff             	mov    -0x1(%ebx),%al
     e84:	83 c4 10             	add    $0x10,%esp
     e87:	84 c0                	test   %al,%al
     e89:	0f 85 79 ff ff ff    	jne    e08 <printf+0x1c>
}
     e8f:	8d 65 f4             	lea    -0xc(%ebp),%esp
     e92:	5b                   	pop    %ebx
     e93:	5e                   	pop    %esi
     e94:	5f                   	pop    %edi
     e95:	5d                   	pop    %ebp
     ...
     e97:	90                   	nop
        printint(fd, *ap, 16, 0);
     e98:	8b 7d d4             	mov    -0x2c(%ebp),%edi
     e9b:	8b 17                	mov    (%edi),%edx
     e9d:	83 ec 0c             	sub    $0xc,%esp
     ea0:	6a 00                	push   $0x0
     ea2:	b9 10 00 00 00       	mov    $0x10,%ecx
     ea7:	89 f0                	mov    %esi,%eax
     ea9:	e8 b2 fe ff ff       	call   d60 <printint>
        ap++;
     eae:	83 c7 04             	add    $0x4,%edi
     eb1:	89 7d d4             	mov    %edi,-0x2c(%ebp)
  for(i = 0; fmt[i]; i++){
     eb4:	eb c8                	jmp    e7e <printf+0x92>
     eb6:	66 90                	xchg   %ax,%ax
        s = (char*)*ap;
     eb8:	8b 4d d4             	mov    -0x2c(%ebp),%ecx
     ebb:	8b 01                	mov    (%ecx),%eax
        ap++;
     ebd:	83 c1 04             	add    $0x4,%ecx
     ec0:	89 4d d4             	mov    %ecx,-0x2c(%ebp)
        if(s == 0)
     ec3:	85 c0                	test   %eax,%eax
     ec5:	0f 84 89 00 00 00    	je     f54 <printf+0x168>
        while(*s != 0){
     ecb:	8a 10                	mov    (%eax),%dl
     ecd:	84 d2                	test   %dl,%dl
     ecf:	74 29                	je     efa <printf+0x10e>
     ed1:	89 c7                	mov    %eax,%edi
     ed3:	88 d0                	mov    %dl,%al
     ed5:	8d 4d e7             	lea    -0x19(%ebp),%ecx
     ed8:	89 5d d0             	mov    %ebx,-0x30(%ebp)
     edb:	89 fb                	mov    %edi,%ebx
     edd:	89 cf                	mov    %ecx,%edi
     edf:	90                   	nop
          putc(fd, *s);
  ...
  write(fd, &c, 1);
     ...
     ee6:	57                   	push   %edi
     ee7:	56                   	push   %esi
     ee8:	e8 da fd ff ff       	call   cc7 <write>
          s++;
     eed:	43                   	inc    %ebx
        while(*s != 0){
     ...
     ef5:	75 e9                	jne    ee0 <printf+0xf4>
     ef7:	8b 5d d0             	mov    -0x30(%ebp),%ebx
  for(i = 0; fmt[i]; i++){
     efa:	83 c3 02             	add    $0x2,%ebx
     efd:	8a 43 ff             	mov    -0x1(%ebx),%al
     f00:	84 c0                	test   %al,%al
     f02:	0f 85 00 ff ff ff    	jne    e08 <printf+0x1c>
     f08:	e9 1e ff ff ff       	jmp    e2b <printf+0x3f>
     ...
     f18:	6a 01                	push   $0x1
     f1a:	b9 0a 00 00 00       	mov    $0xa,%ecx
     f1f:	eb 86                	jmp    ea7 <printf+0xbb>
     f21:	8d 76 00             	lea    0x0(%esi),%esi
        putc(fd, *ap);
     f24:	8b 45 d4             	mov    -0x2c(%ebp),%eax
     f27:	8b 00                	mov    (%eax),%eax
     f29:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
     f2c:	51                   	push   %ecx
     f2d:	6a 01                	push   $0x1
     f2f:	8d 7d e7             	lea    -0x19(%ebp),%edi
     f32:	57                   	push   %edi
     f33:	56                   	push   %esi
     f34:	e8 8e fd ff ff       	call   cc7 <write>
        ap++;
     f39:	83 45 d4 04          	addl   $0x4,-0x2c(%ebp)
     f3d:	e9 3c ff ff ff       	jmp    e7e <printf+0x92>
     f42:	66 90                	xchg   %ax,%ax
        putc(fd, c);
     f44:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
     f47:	52                   	push   %edx
     f48:	6a 01                	push   $0x1
     f4a:	8d 7d e7             	lea    -0x19(%ebp),%edi
     f4d:	e9 25 ff ff ff       	jmp    e77 <printf+0x8b>
     f52:	66 90                	xchg   %ax,%ax
          s = "(null)";
     f54:	bf 83 11 00 00       	mov    $0x1183,%edi
     f59:	b0 28                	mov    $0x28,%al
     f5b:	e9 75 ff ff ff       	jmp    ed5 <printf+0xe9>
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    103e:	56                   	push   %esi
    103f:	e8 eb fc ff ff       	call   d2f <sbrk>
  if(p == (char*)-1)
