...
int main() {
  ...
  17:	6a 32                	push   $0x32
  19:	6a 01                	push   $0x1
  1b:	e8 1b 03 00 00       	call   33b <custom_fork>
                   if (pid < 0) {
  ...
  37:	6a 01                	push   $0x1
  39:	e8 9a 03 00 00       	call   3d8 <printf>
                      sleep(400);
  ...
  51:	6a 01                	push   $0x1
  53:	e8 80 03 00 00       	call   3d8 <printf>
              scheduler_start();
  58:	e8 e6 02 00 00       	call   343 <scheduler_start>
            for (int i = 0; i < NUM_PROCS; i++) {
                         wait();
  ...
  6c:	59                   	pop    %ecx
  6d:	5b                   	pop    %ebx
  6e:	68 7c 07 00 00       	push   $0x77c
  73:	6a 01                	push   $0x1
  75:	e8 5e 03 00 00       	call   3d8 <printf>
            exit();
  7a:	e8 14 02 00 00       	call   293 <exit>
                           printf(1, "Failed to fork process %d\n", i);
  7f:	50                   	push   %eax
  80:	53                   	push   %ebx
  81:	68 b8 06 00 00       	push   $0x6b8
  86:	6a 01                	push   $0x1
  88:	e8 4b 03 00 00       	call   3d8 <printf>
                           exit();
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 380:	8a 92 f4 07 00 00    	mov    0x7f4(%edx),%dl
...
printf(int fd, const char *fmt, ...)
{
 ...
 43a:	ff 24 85 9c 07 00 00 	jmp    *0x79c(,%eax,4)
 ...
 53e:	66 90                	xchg   %ax,%ax
          s = "(null)";
 540:	bf d3 06 00 00       	mov    $0x6d3,%edi
...
free(void *ap)
{
 ...
 558:	a1 08 08 00 00       	mov    0x808,%eax
 ...
 587:	89 0a                	mov    %ecx,(%edx)
    ...
    p->s.ptr = bp;
  freep = p;
 589:	89 15 08 08 00 00    	mov    %edx,0x808
}
 58f:	5b                   	pop    %ebx
 590:	5e                   	pop    %esi
 591:	5f                   	pop    %edi
 ...
 5c6:	89 0a                	mov    %ecx,(%edx)
  freep = p;
 5c8:	89 15 08 08 00 00    	mov    %edx,0x808
}
 5ce:	5b                   	pop    %ebx
 5cf:	5e                   	pop    %esi
 5d0:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 5e6:	47                   	inc    %edi
  if((prevp = freep) == 0){
 5e7:	8b 15 08 08 00 00    	mov    0x808,%edx
 ...
 61d:	73 41                	jae    660 <malloc+0x8c>
    ...
    if(p == freep)
 61f:	39 05 08 08 00 00    	cmp    %eax,0x808
 ...
 642:	e8 05 ff ff ff       	call   54c <free>
  return freep;
 647:	8b 15 08 08 00 00    	mov    0x808,%edx
 ...
 66c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 66f:	89 15 08 08 00 00    	mov    %edx,0x808
      return (void*)(p + 1);
 ...
 687:	90                   	nop
    base.s.ptr = freep = prevp = &base;
 688:	c7 05 08 08 00 00 0c 	movl   $0x80c,0x808
 68f:	08 00 00 
 692:	c7 05 0c 08 00 00 0c 	movl   $0x80c,0x80c
 699:	08 00 00 
    base.s.size = 0;
 69c:	c7 05 10 08 00 00 00 	movl   $0x0,0x810
 6a3:	00 00 00 
 6a6:	b8 0c 08 00 00       	mov    $0x80c,%eax
