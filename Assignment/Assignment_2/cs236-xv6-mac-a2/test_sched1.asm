...
int main() {
  ...
  2a:	ff 74 da 04          	push   0x4(%edx,%ebx,8)
  2e:	ff 34 da             	push   (%edx,%ebx,8)
  31:	e8 11 03 00 00       	call   347 <custom_fork>
                   if (pid < 0) {
  36:	83 c4 10             	add    $0x10,%esp
  39:	85 c0                	test   %eax,%eax
  3b:	8d 55 c8             	lea    -0x38(%ebp),%edx
  3e:	78 5d                	js     9d <main+0x9d>
  ...
  4b:	68 38 07 00 00       	push   $0x738
  50:	6a 01                	push   $0x1
  52:	e8 8d 03 00 00       	call   3e4 <printf>
                       sleep(400);
  57:	c7 04 24 90 01 00 00 	movl   $0x190,(%esp)
  5e:	e8 cc 02 00 00       	call   32f <sleep>
            printf(1, "Calling sys_scheduler_start() to allow execution.\n");
  63:	58                   	pop    %eax
  64:	5a                   	pop    %edx
  65:	68 70 07 00 00       	push   $0x770
  6a:	6a 01                	push   $0x1
  6c:	e8 73 03 00 00       	call   3e4 <printf>
              scheduler_start();
  71:	e8 d9 02 00 00       	call   34f <scheduler_start>
            for (int i = 0; i < NUM_PROCS; i++) {
                         wait();
  76:	e8 2c 02 00 00       	call   2a7 <wait>
  7b:	e8 27 02 00 00       	call   2a7 <wait>
  80:	e8 22 02 00 00       	call   2a7 <wait>
  85:	e8 1d 02 00 00       	call   2a7 <wait>
            }
            printf(1, "All child processes completed.\n");
  8a:	59                   	pop    %ecx
  8b:	5b                   	pop    %ebx
  8c:	68 a4 07 00 00       	push   $0x7a4
  91:	6a 01                	push   $0x1
  93:	e8 4c 03 00 00       	call   3e4 <printf>
            exit();
  98:	e8 02 02 00 00       	call   29f <exit>
                           printf(1, "Failed to fork process %d\n", i);
  9d:	57                   	push   %edi
  9e:	53                   	push   %ebx
  9f:	68 e0 06 00 00       	push   $0x6e0
  a4:	6a 01                	push   $0x1
  a6:	e8 39 03 00 00       	call   3e4 <printf>
                           exit();
  ab:	e8 ef 01 00 00       	call   29f <exit>
                            printf(1, "Child %d (PID: %d) started but should not run yet.\n", i, getpid());
  b0:	e8 6a 02 00 00       	call   31f <getpid>
  b5:	50                   	push   %eax
  b6:	53                   	push   %ebx
  b7:	68 04 07 00 00       	push   $0x704
  bc:	6a 01                	push   $0x1
  be:	e8 21 03 00 00       	call   3e4 <printf>
                            for (volatile int j = 0; j < 100000000; );
  c3:	31 f6                	xor    %esi,%esi
  c5:	89 75 c4             	mov    %esi,-0x3c(%ebp)
  c8:	83 c4 10             	add    $0x10,%esp
  cb:	90                   	nop
  cc:	8b 45 c4             	mov    -0x3c(%ebp),%eax
  cf:	3d ff e0 f5 05       	cmp    $0x5f5e0ff,%eax
  d4:	7e f6                	jle    cc <main+0xcc>
                            exit();
  d6:	e8 c4 01 00 00       	call   29f <exit>
  db:	90                   	nop
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 38c:	8a 92 58 08 00 00    	mov    0x858(%edx),%dl
...
printf(int fd, const char *fmt, ...)
{
 ...
 446:	ff 24 85 00 08 00 00 	jmp    *0x800(,%eax,4)
...
free(void *ap)
{
 ...
 564:	a1 6c 08 00 00       	mov    0x86c,%eax
 ...
 593:	89 0a                	mov    %ecx,(%edx)
    ...
    p->s.ptr = bp;
  freep = p;
 595:	89 15 6c 08 00 00    	mov    %edx,0x86c
}
 59b:	5b                   	pop    %ebx
 59c:	5e                   	pop    %esi
 59d:	5f                   	pop    %edi
 ...
 5d2:	89 0a                	mov    %ecx,(%edx)
  freep = p;
 5d4:	89 15 6c 08 00 00    	mov    %edx,0x86c
}
 5da:	5b                   	pop    %ebx
 5db:	5e                   	pop    %esi
 5dc:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 5f2:	47                   	inc    %edi
  if((prevp = freep) == 0){
 5f3:	8b 15 6c 08 00 00    	mov    0x86c,%edx
 ...
 629:	73 41                	jae    66c <malloc+0x8c>
    ...
    if(p == freep)
 62b:	39 05 6c 08 00 00    	cmp    %eax,0x86c
 ...
 64e:	e8 05 ff ff ff       	call   558 <free>
  return freep;
 653:	8b 15 6c 08 00 00    	mov    0x86c,%edx
 ...
 678:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 67b:	89 15 6c 08 00 00    	mov    %edx,0x86c
      return (void*)(p + 1);
 ...
 693:	90                   	nop
    base.s.ptr = freep = prevp = &base;
 694:	c7 05 6c 08 00 00 70 	movl   $0x870,0x86c
 69b:	08 00 00 
 69e:	c7 05 70 08 00 00 70 	movl   $0x870,0x870
 6a5:	08 00 00 
    base.s.size = 0;
 6a8:	c7 05 74 08 00 00 00 	movl   $0x0,0x874
 6af:	00 00 00 
 6b2:	b8 70 08 00 00       	mov    $0x870,%eax
