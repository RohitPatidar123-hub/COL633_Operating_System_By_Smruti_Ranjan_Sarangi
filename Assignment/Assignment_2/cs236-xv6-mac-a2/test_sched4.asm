...
_test_sched4:     file format elf32-i386
...
int main() {
  ...
  11:	6a 1e                	push   $0x1e
  13:	6a 01                	push   $0x1
  15:	e8 f9 02 00 00       	call   313 <custom_fork>
    if (pid < 0) {
  1a:	83 c4 10             	add    $0x10,%esp
  1d:	85 c0                	test   %eax,%eax
  1f:	78 74                	js     95 <main+0x95>
        printf(1, "Fork failed\n");
        exit();
    } else if (pid == 0) {
  21:	75 3b                	jne    5e <main+0x5e>
        printf(1, "[Child] Running with 30-tick budget (PID: %d)\n", getpid());
  23:	e8 c3 02 00 00       	call   2eb <getpid>
  28:	52                   	push   %edx
  29:	50                   	push   %eax
  2a:	68 a4 06 00 00       	push   $0x6a4
  2f:	6a 01                	push   $0x1
  31:	e8 7a 03 00 00       	call   3b0 <printf>
        // Simulate work; child should be auto-killed once 30 ticks are consumed.
        for (volatile int j = 0; j < 100000000; j++);
  36:	31 c9                	xor    %ecx,%ecx
  38:	89 4d f4             	mov    %ecx,-0xc(%ebp)
  3b:	8b 45 f4             	mov    -0xc(%ebp),%eax
  3e:	83 c4 10             	add    $0x10,%esp
  41:	3d ff e0 f5 05       	cmp    $0x5f5e0ff,%eax
  46:	7f 11                	jg     59 <main+0x59>
  48:	8b 45 f4             	mov    -0xc(%ebp),%eax
  4b:	40                   	inc    %eax
  4c:	89 45 f4             	mov    %eax,-0xc(%ebp)
  4f:	8b 45 f4             	mov    -0xc(%ebp),%eax
  52:	3d ff e0 f5 05       	cmp    $0x5f5e0ff,%eax
  57:	7e ef                	jle    48 <main+0x48>
        exit();
  59:	e8 0d 02 00 00       	call   26b <exit>
    } else {
        printf(1, "[Parent] Created child PID %d with 30 ticks budget\n", pid);
  5e:	52                   	push   %edx
  5f:	50                   	push   %eax
  60:	68 d4 06 00 00       	push   $0x6d4
  65:	6a 01                	push   $0x1
  67:	e8 44 03 00 00       	call   3b0 <printf>
        sleep(200);
  6c:	c7 04 24 c8 00 00 00 	movl   $0xc8,(%esp)
  73:	e8 83 02 00 00       	call   2fb <sleep>
        scheduler_start();
  78:	e8 9e 02 00 00       	call   31b <scheduler_start>
        wait();
  7d:	e8 f1 01 00 00       	call   273 <wait>
        printf(1, "[Parent] Child should have been auto-killed after 30 ticks\n");
  82:	59                   	pop    %ecx
  83:	58                   	pop    %eax
  84:	68 08 07 00 00       	push   $0x708
  89:	6a 01                	push   $0x1
  8b:	e8 20 03 00 00       	call   3b0 <printf>
    }
    exit();
  90:	e8 d6 01 00 00       	call   26b <exit>
        printf(1, "Fork failed\n");
  95:	50                   	push   %eax
  96:	50                   	push   %eax
  97:	68 90 06 00 00       	push   $0x690
  9c:	6a 01                	push   $0x1
  9e:	e8 0d 03 00 00       	call   3b0 <printf>
        exit();
  a3:	e8 c3 01 00 00       	call   26b <exit>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 358:	8a 92 9c 07 00 00    	mov    0x79c(%edx),%dl
...
printf(int fd, const char *fmt, ...)
{
 ...
 412:	ff 24 85 44 07 00 00 	jmp    *0x744(,%eax,4)
 ...
 516:	66 90                	xchg   %ax,%ax
          s = "(null)";
 518:	bf 9d 06 00 00       	mov    $0x69d,%edi
...
free(void *ap)
{
 ...
 530:	a1 b0 07 00 00       	mov    0x7b0,%eax
 ...
 55f:	89 0a                	mov    %ecx,(%edx)
    ...
    p->s.ptr = bp;
  freep = p;
 561:	89 15 b0 07 00 00    	mov    %edx,0x7b0
}
 567:	5b                   	pop    %ebx
 568:	5e                   	pop    %esi
 569:	5f                   	pop    %edi
 ...
 59e:	89 0a                	mov    %ecx,(%edx)
  freep = p;
 5a0:	89 15 b0 07 00 00    	mov    %edx,0x7b0
}
 5a6:	5b                   	pop    %ebx
 5a7:	5e                   	pop    %esi
 5a8:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 5be:	47                   	inc    %edi
  if((prevp = freep) == 0){
 5bf:	8b 15 b0 07 00 00    	mov    0x7b0,%edx
 ...
 5f5:	73 41                	jae    638 <malloc+0x8c>
    ...
    if(p == freep)
 5f7:	39 05 b0 07 00 00    	cmp    %eax,0x7b0
 ...
 61a:	e8 05 ff ff ff       	call   524 <free>
  return freep;
 61f:	8b 15 b0 07 00 00    	mov    0x7b0,%edx
 ...
 644:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 647:	89 15 b0 07 00 00    	mov    %edx,0x7b0
      return (void*)(p + 1);
 ...
 65f:	90                   	nop
    base.s.ptr = freep = prevp = &base;
 660:	c7 05 b0 07 00 00 b4 	movl   $0x7b4,0x7b0
 667:	07 00 00 
 66a:	c7 05 b4 07 00 00 b4 	movl   $0x7b4,0x7b4
 671:	07 00 00 
    base.s.size = 0;
 674:	c7 05 b8 07 00 00 00 	movl   $0x0,0x7b8
 67b:	00 00 00 
 67e:	b8 b4 07 00 00       	mov    $0x7b4,%eax
