...
main(int argc, char *argv[])
{
  ...
  6c:	50                   	push   %eax
  6d:	ff 33                	push   (%ebx)
  6f:	68 f4 08 00 00       	push   $0x8f4
  74:	6a 01                	push   $0x1
  76:	e8 79 05 00 00       	call   5f4 <printf>
      exit();
  7b:	e8 37 04 00 00       	call   4b7 <exit>
    printf(2, "usage: grep pattern [file ...]\n");
  80:	51                   	push   %ecx
  81:	51                   	push   %ecx
  82:	68 d4 08 00 00       	push   $0x8d4
  87:	6a 02                	push   $0x2
  89:	e8 66 05 00 00       	call   5f4 <printf>
    exit();
...
00000557 <custom_fork>:
SYSCALL(custom_fork)
 557:	b8 17 00 00 00       	mov    $0x17,%eax
 55c:	cd 40                	int    $0x40
 55e:	c3                   	ret

0000055f <scheduler_start>:
SYSCALL(scheduler_start)
 55f:	b8 18 00 00 00       	mov    $0x18,%eax
 564:	cd 40                	int    $0x40
 566:	c3                   	ret
 567:	90                   	nop
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 56c:	56                   	push   %esi
 56d:	53                   	push   %ebx
 56e:	83 ec 3c             	sub    $0x3c,%esp
 571:	89 45 c0             	mov    %eax,-0x40(%ebp)
 574:	89 cb                	mov    %ecx,%ebx
  char buf[16];
  int i, neg;
  uint x;
 ...
 57b:	74 04                	je     581 <printint+0x19>
 57d:	85 d2                	test   %edx,%edx
 57f:	78 6b                	js     5ec <printint+0x84>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
 581:	89 55 c4             	mov    %edx,-0x3c(%ebp)
  neg = 0;
 584:	c7 45 08 00 00 00 00 	movl   $0x0,0x8(%ebp)
  }

  i = 0;
 58b:	31 c9                	xor    %ecx,%ecx
 58d:	8d 75 d7             	lea    -0x29(%ebp),%esi
  do{
    buf[i++] = digits[x % base];
 590:	8b 45 c4             	mov    -0x3c(%ebp),%eax
 593:	31 d2                	xor    %edx,%edx
 595:	f7 f3                	div    %ebx
 597:	89 cf                	mov    %ecx,%edi
 599:	8d 49 01             	lea    0x1(%ecx),%ecx
 59c:	8a 92 6c 09 00 00    	mov    0x96c(%edx),%dl
 5a2:	88 54 3e 01          	mov    %dl,0x1(%esi,%edi,1)
  }while((x /= base) != 0);
 5a6:	8b 55 c4             	mov    -0x3c(%ebp),%edx
 5a9:	89 45 c4             	mov    %eax,-0x3c(%ebp)
 5ac:	39 da                	cmp    %ebx,%edx
 5ae:	73 e0                	jae    590 <printint+0x28>
  if(neg)
 5b0:	8b 55 08             	mov    0x8(%ebp),%edx
 5b3:	85 d2                	test   %edx,%edx
 5b5:	74 07                	je     5be <printint+0x56>
    buf[i++] = '-';
 5b7:	c6 44 0d d8 2d       	movb   $0x2d,-0x28(%ebp,%ecx,1)
 5bc:	89 cf                	mov    %ecx,%edi

  while(--i >= 0)
 5be:	8d 5d d8             	lea    -0x28(%ebp),%ebx
 5c1:	8d 7c 3d d8          	lea    -0x28(%ebp,%edi,1),%edi
 5c5:	8d 76 00             	lea    0x0(%esi),%esi
    putc(fd, buf[i]);
 5c8:	8a 07                	mov    (%edi),%al
 5ca:	88 45 d7             	mov    %al,-0x29(%ebp)
  write(fd, &c, 1);
 5cd:	50                   	push   %eax
 5ce:	6a 01                	push   $0x1
 5d0:	56                   	push   %esi
 5d1:	ff 75 c0             	push   -0x40(%ebp)
 5d4:	e8 fe fe ff ff       	call   4d7 <write>
  while(--i >= 0)
 5d9:	89 f8                	mov    %edi,%eax
 5db:	4f                   	dec    %edi
 5dc:	83 c4 10             	add    $0x10,%esp
 5df:	39 d8                	cmp    %ebx,%eax
 5e1:	75 e5                	jne    5c8 <printint+0x60>
}
 ...
 5eb:	90                   	nop
    x = -xx;
 5ec:	f7 da                	neg    %edx
 5ee:	89 55 c4             	mov    %edx,-0x3c(%ebp)
 5f1:	eb 98                	jmp    58b <printint+0x23>
 5f3:	90                   	nop
...
printf(int fd, const char *fmt, ...)
{
 ...
 607:	74 2a                	je     633 <printf+0x3f>
 609:	43                   	inc    %ebx
  ap = (uint*)(void*)&fmt + 1;
 60a:	8d 4d 10             	lea    0x10(%ebp),%ecx
 60d:	89 4d d4             	mov    %ecx,-0x2c(%ebp)
    c = fmt[i] & 0xff;
 610:	0f b6 d0             	movzbl %al,%edx
    if(state == 0){
      if(c == '%'){
 613:	83 fa 25             	cmp    $0x25,%edx
 616:	74 24                	je     63c <printf+0x48>
        state = '%';
      } else {
        putc(fd, c);
 ...
 621:	50                   	push   %eax
 622:	56                   	push   %esi
 623:	e8 af fe ff ff       	call   4d7 <write>
  for(i = 0; fmt[i]; i++){
 628:	43                   	inc    %ebx
 629:	8a 43 ff             	mov    -0x1(%ebx),%al
 62c:	83 c4 10             	add    $0x10,%esp
 62f:	84 c0                	test   %al,%al
 631:	75 dd                	jne    610 <printf+0x1c>
        putc(fd, c);
      }
      state = 0;
    }
 ...
 63b:	90                   	nop
  for(i = 0; fmt[i]; i++){
 63c:	8a 13                	mov    (%ebx),%dl
 63e:	84 d2                	test   %dl,%dl
 640:	74 f1                	je     633 <printf+0x3f>
    c = fmt[i] & 0xff;
 642:	0f b6 c2             	movzbl %dl,%eax
      if(c == 'd'){
 645:	80 fa 25             	cmp    $0x25,%dl
 648:	0f 84 fe 00 00 00    	je     74c <printf+0x158>
 64e:	83 e8 63             	sub    $0x63,%eax
 651:	83 f8 15             	cmp    $0x15,%eax
 654:	77 0a                	ja     660 <printf+0x6c>
 656:	ff 24 85 14 09 00 00 	jmp    *0x914(,%eax,4)
 65d:	8d 76 00             	lea    0x0(%esi),%esi
 660:	88 55 d0             	mov    %dl,-0x30(%ebp)
        putc(fd, '%');
 663:	c6 45 e7 25          	movb   $0x25,-0x19(%ebp)
  write(fd, &c, 1);
 667:	50                   	push   %eax
 668:	6a 01                	push   $0x1
 66a:	8d 7d e7             	lea    -0x19(%ebp),%edi
 66d:	57                   	push   %edi
 66e:	56                   	push   %esi
 66f:	e8 63 fe ff ff       	call   4d7 <write>
        putc(fd, c);
 674:	8a 55 d0             	mov    -0x30(%ebp),%dl
 677:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
 67a:	83 c4 0c             	add    $0xc,%esp
 67d:	6a 01                	push   $0x1
 67f:	57                   	push   %edi
 680:	56                   	push   %esi
 681:	e8 51 fe ff ff       	call   4d7 <write>
  for(i = 0; fmt[i]; i++){
 686:	83 c3 02             	add    $0x2,%ebx
 689:	8a 43 ff             	mov    -0x1(%ebx),%al
 68c:	83 c4 10             	add    $0x10,%esp
 68f:	84 c0                	test   %al,%al
 691:	0f 85 79 ff ff ff    	jne    610 <printf+0x1c>
}
 ...
 6a8:	6a 00                	push   $0x0
 6aa:	b9 10 00 00 00       	mov    $0x10,%ecx
 6af:	89 f0                	mov    %esi,%eax
 6b1:	e8 b2 fe ff ff       	call   568 <printint>
        ap++;
 6b6:	83 c7 04             	add    $0x4,%edi
 6b9:	89 7d d4             	mov    %edi,-0x2c(%ebp)
  for(i = 0; fmt[i]; i++){
 6bc:	eb c8                	jmp    686 <printf+0x92>
 6be:	66 90                	xchg   %ax,%ax
        s = (char*)*ap;
 6c0:	8b 4d d4             	mov    -0x2c(%ebp),%ecx
 6c3:	8b 01                	mov    (%ecx),%eax
        ap++;
 6c5:	83 c1 04             	add    $0x4,%ecx
 6c8:	89 4d d4             	mov    %ecx,-0x2c(%ebp)
        if(s == 0)
 6cb:	85 c0                	test   %eax,%eax
 6cd:	0f 84 89 00 00 00    	je     75c <printf+0x168>
        while(*s != 0){
 6d3:	8a 10                	mov    (%eax),%dl
 6d5:	84 d2                	test   %dl,%dl
 6d7:	74 29                	je     702 <printf+0x10e>
 6d9:	89 c7                	mov    %eax,%edi
 6db:	88 d0                	mov    %dl,%al
 6dd:	8d 4d e7             	lea    -0x19(%ebp),%ecx
 6e0:	89 5d d0             	mov    %ebx,-0x30(%ebp)
 6e3:	89 fb                	mov    %edi,%ebx
 6e5:	89 cf                	mov    %ecx,%edi
 6e7:	90                   	nop
          putc(fd, *s);
 ...
 6fd:	75 e9                	jne    6e8 <printf+0xf4>
 6ff:	8b 5d d0             	mov    -0x30(%ebp),%ebx
  for(i = 0; fmt[i]; i++){
 702:	83 c3 02             	add    $0x2,%ebx
 705:	8a 43 ff             	mov    -0x1(%ebx),%al
 708:	84 c0                	test   %al,%al
 70a:	0f 85 00 ff ff ff    	jne    610 <printf+0x1c>
 710:	e9 1e ff ff ff       	jmp    633 <printf+0x3f>
 715:	8d 76 00             	lea    0x0(%esi),%esi
        printint(fd, *ap, 10, 1);
 718:	8b 7d d4             	mov    -0x2c(%ebp),%edi
 71b:	8b 17                	mov    (%edi),%edx
 71d:	83 ec 0c             	sub    $0xc,%esp
 720:	6a 01                	push   $0x1
 722:	b9 0a 00 00 00       	mov    $0xa,%ecx
 727:	eb 86                	jmp    6af <printf+0xbb>
 ...
 734:	51                   	push   %ecx
 735:	6a 01                	push   $0x1
 737:	8d 7d e7             	lea    -0x19(%ebp),%edi
 73a:	57                   	push   %edi
 73b:	56                   	push   %esi
 73c:	e8 96 fd ff ff       	call   4d7 <write>
        ap++;
 741:	83 45 d4 04          	addl   $0x4,-0x2c(%ebp)
 745:	e9 3c ff ff ff       	jmp    686 <printf+0x92>
 ...
 755:	e9 25 ff ff ff       	jmp    67f <printf+0x8b>
 75a:	66 90                	xchg   %ax,%ax
          s = "(null)";
 75c:	bf 0a 09 00 00       	mov    $0x90a,%edi
 761:	b0 28                	mov    $0x28,%al
 763:	e9 75 ff ff ff       	jmp    6dd <printf+0xe9>
...
free(void *ap)
{
 ...
 774:	a1 80 0d 00 00       	mov    0xd80,%eax
 ...
 7a3:	89 0a                	mov    %ecx,(%edx)
    ...
    p->s.ptr = bp;
  freep = p;
 7a5:	89 15 80 0d 00 00    	mov    %edx,0xd80
}
 7ab:	5b                   	pop    %ebx
 7ac:	5e                   	pop    %esi
 7ad:	5f                   	pop    %edi
 ...
 7e2:	89 0a                	mov    %ecx,(%edx)
  freep = p;
 7e4:	89 15 80 0d 00 00    	mov    %edx,0xd80
}
 7ea:	5b                   	pop    %ebx
 7eb:	5e                   	pop    %esi
 7ec:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 7fc:	8d 78 07             	lea    0x7(%eax),%edi
 7ff:	c1 ef 03             	shr    $0x3,%edi
 802:	47                   	inc    %edi
  if((prevp = freep) == 0){
 803:	8b 15 80 0d 00 00    	mov    0xd80,%edx
 809:	85 d2                	test   %edx,%edx
 80b:	0f 84 93 00 00 00    	je     8a4 <malloc+0xb4>
 ...
 818:	73 62                	jae    87c <malloc+0x8c>
  if(nu < 4096)
 81a:	89 fb                	mov    %edi,%ebx
 81c:	81 ff 00 10 00 00    	cmp    $0x1000,%edi
 822:	72 78                	jb     89c <malloc+0xac>
 ...
 830:	89 c2                	mov    %eax,%edx
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 832:	8b 02                	mov    (%edx),%eax
    if(p->s.size >= nunits){
 834:	8b 48 04             	mov    0x4(%eax),%ecx
 837:	39 f9                	cmp    %edi,%ecx
 839:	73 41                	jae    87c <malloc+0x8c>
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
 83b:	39 05 80 0d 00 00    	cmp    %eax,0xd80
 841:	75 ed                	jne    830 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
 843:	83 ec 0c             	sub    $0xc,%esp
 846:	56                   	push   %esi
 847:	e8 f3 fc ff ff       	call   53f <sbrk>
  if(p == (char*)-1)
 ...
 85d:	50                   	push   %eax
 85e:	e8 05 ff ff ff       	call   768 <free>
  return freep;
 863:	8b 15 80 0d 00 00    	mov    0xd80,%edx
      if((p = morecore(nunits)) == 0)
 869:	83 c4 10             	add    $0x10,%esp
 86c:	85 d2                	test   %edx,%edx
 86e:	75 c2                	jne    832 <malloc+0x42>
        return 0;
 ...
 87a:	66 90                	xchg   %ax,%ax
      if(p->s.size == nunits)
 87c:	39 cf                	cmp    %ecx,%edi
 87e:	74 4c                	je     8cc <malloc+0xdc>
        p->s.size -= nunits;
 880:	29 f9                	sub    %edi,%ecx
 882:	89 48 04             	mov    %ecx,0x4(%eax)
        p += p->s.size;
 885:	8d 04 c8             	lea    (%eax,%ecx,8),%eax
        p->s.size = nunits;
 888:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 88b:	89 15 80 0d 00 00    	mov    %edx,0xd80
      return (void*)(p + 1);
 ...
 8a1:	eb 81                	jmp    824 <malloc+0x34>
 8a3:	90                   	nop
    base.s.ptr = freep = prevp = &base;
 8a4:	c7 05 80 0d 00 00 84 	movl   $0xd84,0xd80
 8ab:	0d 00 00 
 8ae:	c7 05 84 0d 00 00 84 	movl   $0xd84,0xd84
 8b5:	0d 00 00 
    base.s.size = 0;
 8b8:	c7 05 88 0d 00 00 00 	movl   $0x0,0xd88
 8bf:	00 00 00 
 8c2:	b8 84 0d 00 00       	mov    $0xd84,%eax
 8c7:	e9 4e ff ff ff       	jmp    81a <malloc+0x2a>
        prevp->s.ptr = p->s.ptr;
 8cc:	8b 08                	mov    (%eax),%ecx
 8ce:	89 0a                	mov    %ecx,(%edx)
 8d0:	eb b9                	jmp    88b <malloc+0x9b>
