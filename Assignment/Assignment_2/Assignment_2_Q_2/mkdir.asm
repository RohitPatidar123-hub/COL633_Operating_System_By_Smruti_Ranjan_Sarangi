...
printint(int fd, int xx, int base, int sgn)
{
 ...
 318:	8a 92 e4 06 00 00    	mov    0x6e4(%edx),%dl
...
printf(int fd, const char *fmt, ...)
{
 ...
 3d2:	ff 24 85 8c 06 00 00 	jmp    *0x68c(,%eax,4)
 ...
 4d6:	66 90                	xchg   %ax,%ax
          s = "(null)";
 4d8:	bf 83 06 00 00       	mov    $0x683,%edi
...
free(void *ap)
{
 ...
 4f0:	a1 f8 06 00 00       	mov    0x6f8,%eax
 ...
 51f:	89 0a                	mov    %ecx,(%edx)
    ...
    p->s.ptr = bp;
  freep = p;
 521:	89 15 f8 06 00 00    	mov    %edx,0x6f8
}
 527:	5b                   	pop    %ebx
 528:	5e                   	pop    %esi
 529:	5f                   	pop    %edi
 ...
 55e:	89 0a                	mov    %ecx,(%edx)
  freep = p;
 560:	89 15 f8 06 00 00    	mov    %edx,0x6f8
}
 566:	5b                   	pop    %ebx
 567:	5e                   	pop    %esi
 568:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 57e:	47                   	inc    %edi
  if((prevp = freep) == 0){
 57f:	8b 15 f8 06 00 00    	mov    0x6f8,%edx
 ...
 5b5:	73 41                	jae    5f8 <malloc+0x8c>
    ...
    if(p == freep)
 5b7:	39 05 f8 06 00 00    	cmp    %eax,0x6f8
 ...
 5da:	e8 05 ff ff ff       	call   4e4 <free>
  return freep;
 5df:	8b 15 f8 06 00 00    	mov    0x6f8,%edx
 ...
 604:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 607:	89 15 f8 06 00 00    	mov    %edx,0x6f8
      return (void*)(p + 1);
 ...
 61f:	90                   	nop
    base.s.ptr = freep = prevp = &base;
 620:	c7 05 f8 06 00 00 fc 	movl   $0x6fc,0x6f8
 627:	06 00 00 
 62a:	c7 05 fc 06 00 00 fc 	movl   $0x6fc,0x6fc
 631:	06 00 00 
    base.s.size = 0;
 634:	c7 05 00 07 00 00 00 	movl   $0x0,0x700
 63b:	00 00 00 
 63e:	b8 fc 06 00 00       	mov    $0x6fc,%eax
