...
int main() {
  ...
  11:	6a 1e                	push   $0x1e
  13:	6a 01                	push   $0x1
  15:	e8 f1 02 00 00       	call   30b <custom_fork>
    if (pid < 0) {
  ...
  2f:	6a 01                	push   $0x1
  31:	e8 72 03 00 00       	call   3a8 <printf>
  ...
  95:	50                   	push   %eax
  96:	50                   	push   %eax
  97:	68 88 06 00 00       	push   $0x688
  9c:	6a 01                	push   $0x1
  9e:	e8 05 03 00 00       	call   3a8 <printf>
        exit();
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 350:	8a 92 94 07 00 00    	mov    0x794(%edx),%dl
...
printf(int fd, const char *fmt, ...)
{
 ...
 40a:	ff 24 85 3c 07 00 00 	jmp    *0x73c(,%eax,4)
 ...
 50e:	66 90                	xchg   %ax,%ax
          s = "(null)";
 510:	bf 95 06 00 00       	mov    $0x695,%edi
...
free(void *ap)
{
 ...
 528:	a1 a8 07 00 00       	mov    0x7a8,%eax
 ...
 557:	89 0a                	mov    %ecx,(%edx)
    ...
    p->s.ptr = bp;
  freep = p;
 559:	89 15 a8 07 00 00    	mov    %edx,0x7a8
}
 55f:	5b                   	pop    %ebx
 560:	5e                   	pop    %esi
 561:	5f                   	pop    %edi
 ...
 596:	89 0a                	mov    %ecx,(%edx)
  freep = p;
 598:	89 15 a8 07 00 00    	mov    %edx,0x7a8
}
 59e:	5b                   	pop    %ebx
 59f:	5e                   	pop    %esi
 5a0:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 5b6:	47                   	inc    %edi
  if((prevp = freep) == 0){
 5b7:	8b 15 a8 07 00 00    	mov    0x7a8,%edx
 ...
 5ed:	73 41                	jae    630 <malloc+0x8c>
    ...
    if(p == freep)
 5ef:	39 05 a8 07 00 00    	cmp    %eax,0x7a8
 ...
 612:	e8 05 ff ff ff       	call   51c <free>
  return freep;
 617:	8b 15 a8 07 00 00    	mov    0x7a8,%edx
 ...
 63c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 63f:	89 15 a8 07 00 00    	mov    %edx,0x7a8
      return (void*)(p + 1);
 ...
 657:	90                   	nop
    base.s.ptr = freep = prevp = &base;
 658:	c7 05 a8 07 00 00 ac 	movl   $0x7ac,0x7a8
 65f:	07 00 00 
 662:	c7 05 ac 07 00 00 ac 	movl   $0x7ac,0x7ac
 669:	07 00 00 
    base.s.size = 0;
 66c:	c7 05 b0 07 00 00 00 	movl   $0x0,0x7b0
 673:	00 00 00 
 676:	b8 ac 07 00 00       	mov    $0x7ac,%eax
