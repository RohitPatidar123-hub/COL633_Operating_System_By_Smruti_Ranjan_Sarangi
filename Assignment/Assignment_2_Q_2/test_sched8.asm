...
int main(void) {
  ...
  12:	6a 1e                	push   $0x1e
  14:	6a 01                	push   $0x1
  16:	e8 18 03 00 00       	call   333 <custom_fork>
    if(pid1 < 0) {
  ...
  28:	6a 46                	push   $0x46
  2a:	6a 01                	push   $0x1
  2c:	e8 02 03 00 00       	call   333 <custom_fork>
    if(pid2 < 0) {
  ...
  5b:	52                   	push   %edx
  5c:	50                   	push   %eax
  5d:	68 c9 06 00 00       	push   $0x6c9
  62:	6a 01                	push   $0x1
  64:	e8 67 03 00 00       	call   3d0 <printf>
        exit();
  69:	e8 25 02 00 00       	call   293 <exit>
        printf(1, "Fork failed for child 1\n");
  6e:	51                   	push   %ecx
  6f:	51                   	push   %ecx
  70:	68 b0 06 00 00       	push   $0x6b0
  75:	6a 01                	push   $0x1
  77:	e8 54 03 00 00       	call   3d0 <printf>
        exit();
  ...
  81:	50                   	push   %eax
  82:	53                   	push   %ebx
  83:	68 24 07 00 00       	push   $0x724
  88:	6a 01                	push   $0x1
  8a:	e8 41 03 00 00       	call   3d0 <printf>
    sleep(300);
  8f:	c7 04 24 2c 01 00 00 	movl   $0x12c,(%esp)
  96:	e8 88 02 00 00       	call   323 <sleep>
    scheduler_start();
  9b:	e8 9b 02 00 00       	call   33b <scheduler_start>
    wait();
  ...
  aa:	58                   	pop    %eax
  ab:	5a                   	pop    %edx
  ac:	68 6c 07 00 00       	push   $0x76c
  b1:	6a 01                	push   $0x1
  b3:	e8 18 03 00 00       	call   3d0 <printf>
    exit();
  b8:	e8 d6 01 00 00       	call   293 <exit>
        printf(1, "Fork failed for child 2\n");
  bd:	53                   	push   %ebx
  be:	53                   	push   %ebx
  bf:	68 e6 06 00 00       	push   $0x6e6
  c4:	6a 01                	push   $0x1
  c6:	e8 05 03 00 00       	call   3d0 <printf>
        exit();
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 378:	8a 92 f0 07 00 00    	mov    0x7f0(%edx),%dl
...
printf(int fd, const char *fmt, ...)
{
 ...
 432:	ff 24 85 98 07 00 00 	jmp    *0x798(,%eax,4)
 ...
 536:	66 90                	xchg   %ax,%ax
          s = "(null)";
 538:	bf 1c 07 00 00       	mov    $0x71c,%edi
...
free(void *ap)
{
 ...
 550:	a1 04 08 00 00       	mov    0x804,%eax
 ...
 57f:	89 0a                	mov    %ecx,(%edx)
    ...
    p->s.ptr = bp;
  freep = p;
 581:	89 15 04 08 00 00    	mov    %edx,0x804
}
 587:	5b                   	pop    %ebx
 588:	5e                   	pop    %esi
 589:	5f                   	pop    %edi
 ...
 5be:	89 0a                	mov    %ecx,(%edx)
  freep = p;
 5c0:	89 15 04 08 00 00    	mov    %edx,0x804
}
 5c6:	5b                   	pop    %ebx
 5c7:	5e                   	pop    %esi
 5c8:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 5de:	47                   	inc    %edi
  if((prevp = freep) == 0){
 5df:	8b 15 04 08 00 00    	mov    0x804,%edx
 ...
 615:	73 41                	jae    658 <malloc+0x8c>
    ...
    if(p == freep)
 617:	39 05 04 08 00 00    	cmp    %eax,0x804
 ...
 63a:	e8 05 ff ff ff       	call   544 <free>
  return freep;
 63f:	8b 15 04 08 00 00    	mov    0x804,%edx
 ...
 664:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 667:	89 15 04 08 00 00    	mov    %edx,0x804
      return (void*)(p + 1);
 ...
 67f:	90                   	nop
    base.s.ptr = freep = prevp = &base;
 680:	c7 05 04 08 00 00 08 	movl   $0x808,0x804
 687:	08 00 00 
 68a:	c7 05 08 08 00 00 08 	movl   $0x808,0x808
 691:	08 00 00 
    base.s.size = 0;
 694:	c7 05 0c 08 00 00 00 	movl   $0x0,0x80c
 69b:	00 00 00 
 69e:	b8 08 08 00 00       	mov    $0x808,%eax
